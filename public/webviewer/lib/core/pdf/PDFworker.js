...
*****************************************************************************/
  ...
  $jscomp.makeIterator = function (c) {
    var l = 'undefined' != typeof Symbol && Symbol.iterator && c[Symbol.iterator];
    ...
    function (c) {
      function l() {
        ...
        try {
          ...
          if (2 != m.get(b) || 3 != m.get(a)) return !1;
          m.delete(b);
          m.set(a, 4);
          return !m.has(b) && 4 == m.get(a);
        } catch (u) {
          return !1;
        }
      }
      ...
      function f(a) {
        if (!$jscomp.owns(a, q)) {
          var b = new h();
          $jscomp.defineProperty(a, q, { value: b });
        }
      }
      function n(a) {
        var b = Object[a];
      ...
      a.prototype.set = function (a, g) {
        f(a);
        if (!$jscomp.owns(a, q)) throw Error('WeakMap key fail: ' + a);
        a[q][this.id_] = g;
        return this;
      };
      a.prototype.get = function (a) {
        return $jscomp.owns(a, q) ? a[q][this.id_] : void 0;
      };
      a.prototype.has = function (a) {
        return $jscomp.owns(a, q) && $jscomp.owns(a[q], this.id_);
      };
      a.prototype.delete = function (a) {
        return $jscomp.owns(a, q) && $jscomp.owns(a[q], this.id_) ? delete a[q][this.id_] : !1;
      };
      return a;
    },
    'es6',
  ...
  $jscomp.polyfill(
    ...
    function (c) {
      function l() {
        if ($jscomp.ASSUME_NO_NATIVE_MAP || !c || 'function' != typeof c || !c.prototype.entries || 'function' != typeof Object.seal) return !1;
        try {
          var a = Object.seal({ x: 4 }),
            g = new c($jscomp.makeIterator([[a, 's']]));
          if ('s' != g.get(a) || 1 != g.size || g.get({ x: 4 }) || g.set({ x: 4 }, 't') != g || 2 != g.size) return !1;
          var m = g.entries(),
            d = m.next();
      ...
      f.prototype.forEach = function (a, g) {
        for (var b = this.entries(), d; !(d = b.next()).done; ) (d = d.value), a.call(g, d[1], d[0], this);
      };
      f.prototype[Symbol.iterator] = f.prototype.entries;
      var n = function (b, g) {
          var m = g && typeof g;
          'object' == m || 'function' == m ? (h.has(g) ? (m = h.get(g)) : ((m = '' + ++a), h.set(g, m))) : (m = 'p_' + g);
          var d = b.data_[m];
          if (d && $jscomp.owns(b.data_, m))
            for (b = 0; b < d.length; b++) {
              var p = d[b];
              if ((g !== g && p.key !== p.key) || g === p.key) return { id: m, list: d, index: b, entry: p };
            }
          return { id: m, list: d, index: -1, entry: void 0 };
        },
        q = function (a, g) {
          var b = a.head_;
          return $jscomp.iteratorPrototype(function () {
            if (b) {
              ...
              for (; b.next != b.head; ) return (b = b.next), { done: !1, value: g(b) };
              b = null;
            }
  ...
  $jscomp.polyfill(
    ...
    function (c) {
      ...
      n.prototype.resolveTo_ = function (d) {
        if (d === this) this.reject_(new TypeError('A Promise cannot resolve to itself'));
        else if (d instanceof n) this.settleSameAsPromise_(d);
        else {
          a: switch (typeof d) {
            case 'object':
              var a = null != d;
      ...
      n.prototype.resolveToNonPromiseObj_ = function (d) {
        var a = void 0;
        try {
          a = d.then;
        } catch (b) {
      ...
      n.prototype.reject_ = function (d) {
        this.settle_(2, d);
      };
      n.prototype.fulfill_ = function (d) {
        this.settle_(1, d);
      };
      n.prototype.settle_ = function (d, a) {
        if (0 != this.state_) throw Error('Cannot settle(' + d + ', ' + a + '): Promise already settled in state' + this.state_);
        this.state_ = d;
        this.result_ = a;
      ...
      n.prototype.executeOnSettledCallbacks_ = function () {
        if (null != this.onSettledCallbacks_) {
          for (var d = 0; d < this.onSettledCallbacks_.length; ++d) q.asyncExecute(this.onSettledCallbacks_[d]);
          this.onSettledCallbacks_ = null;
        }
      };
      var q = new l();
      n.prototype.settleSameAsPromise_ = function (d) {
        var a = this.createResolveAndReject_();
        d.callWhenSettled_(a.resolve, a.reject);
      };
      n.prototype.settleSameAsThenable_ = function (d, a) {
        var b = this.createResolveAndReject_();
        try {
          d.call(a, b.resolve, b.reject);
        } catch (g) {
          b.reject(g);
        }
      };
      n.prototype.then = function (d, a) {
        function b(a, b) {
        ...
        this.callWhenSettled_(b(d, g), b(a, m));
        return f;
      };
      n.prototype.catch = function (d) {
        return this.then(void 0, d);
      };
      n.prototype.callWhenSettled_ = function (d, a) {
        function b() {
          switch (g.state_) {
            case 1:
              d(g.result_);
        ...
        var g = this;
        null == this.onSettledCallbacks_ ? q.asyncExecute(b) : this.onSettledCallbacks_.push(b);
      };
      n.resolve = h;
      n.reject = function (d) {
      ...
      n.race = function (d) {
        return new n(function (a, b) {
          for (var g = $jscomp.makeIterator(d), m = g.next(); !m.done; m = g.next()) h(m.value).callWhenSettled_(a, b);
        });
      };
      n.all = function (d) {
        var a = $jscomp.makeIterator(d),
          b = a.next();
        return b.done
          ? h([])
          : new n(function (g, d) {
              ...
              var p = [],
                f = 0;
              do p.push(void 0), f++, h(b.value).callWhenSettled_(m(p.length - 1), d), (b = a.next());
              while (!b.done);
            });
      };
      return n;
  ...
  $jscomp.checkStringArgs = function (c, l, h) {
    if (null == c) throw new TypeError("The 'this' value for String.prototype." + h + ' must not be null or undefined');
    if (l instanceof RegExp) throw new TypeError('First argument to String.prototype.' + h + ' must not be a regular expression');
    return c + '';
  };
  $jscomp.polyfill(
    ...
    function (c) {
      return c
        ...
        : function (c, h) {
            ...
            for (var n = c.length; 0 < n && 0 < h; ) if (f[--h] != c[--n]) return !1;
            return 0 >= n;
          };
    },
    'es6',
  ...
  $jscomp.findInternal = function (c, l, h) {
    ...
    for (var f = c.length, n = 0; n < f; n++) {
      var q = c[n];
      if (l.call(h, q, n, c)) return { i: n, v: q };
    }
    return { i: -1, v: void 0 };
  };
  $jscomp.polyfill(
  ...
  $jscomp.polyfill(
    ...
    function (c) {
      function l() {
        if ($jscomp.ASSUME_NO_NATIVE_SET || !c || 'function' != typeof c || !c.prototype.entries || 'function' != typeof Object.seal) return !1;
        try {
          var f = Object.seal({ x: 4 }),
            n = new c($jscomp.makeIterator([f]));
          if (!n.has(f) || 1 != n.size || n.add(f) != n || 1 != n.size || n.add({ x: 4 }) != n || 2 != n.size) return !1;
          var h = n.entries(),
            d = h.next();
          if (d.done || d.value[0] != f || d.value[1] != f) return !1;
          d = h.next();
          return d.done || d.value[0] == f || 4 != d.value[0].x || d.value[1] != d.value[0] ? !1 : h.next().done;
        } catch (a) {
          return !1;
        }
      }
      ...
      var h = function (f) {
        ...
        if (f) {
          ...
          for (var c; !(c = f.next()).done; ) this.add(c.value);
        }
      ...
      h.prototype.forEach = function (f, c) {
        var n = this;
        this.map_.forEach(function (d) {
          return f.call(c, d, d, n);
        });
      };
      return h;
    },
  ...
  (function (c) {
    ...
    l.c = h;
    l.d = function (f, c, h) {
      l.o(f, c) || Object.defineProperty(f, c, { enumerable: !0, get: h });
    };
    l.r = function (f) {
    ...
    l.t = function (f, c) {
      c & 1 && (f = l(f));
      if (c & 8 || (c & 4 && 'object' === typeof f && f && f.__esModule)) return f;
      var h = Object.create(null);
      l.r(h);
      Object.defineProperty(h, 'default', { enumerable: !0, value: f });
      if (c & 2 && 'string' != typeof f)
        for (var d in f)
          l.d(
            h,
            d,
    ...
    function (c, l, h) {
      ...
      var f = h(2),
        ...
        q = function (a, b, g, d) {
          void 0 === d && (d = !1);
          var m = g.pop();
          g = g.length ? g.join(', ') + ' and ' + m : m;
          d
            ? n("'" + b + "' will be deprecated in version " + a + '. Please use ' + g + ' instead.')
            : n("'" + b + "' is deprecated since version " + a + '. Please use ' + g + ' instead.');
        },
        d = function (a, b) {
      ...
      var f = h(14),
        ...
        a = function (a) {
          ...
          a
            ...
            : ((console.log = n), (console.warn = q), (console.error = d));
        },
        b = function () {
          var b = Object(f.a)(location.search);
          a('1' === b.disableLogs);
        },
        g = function (b) {
    ...
    function (c, l, h) {
      ...
      var f = h(11),
        ...
        g = !1,
        m = function (e, k) {
          g || (b(a.basePath + 'decode.min.js'), (g = !0));
          e = self.BrotliDecode(Object(d.b)(e));
          return k ? e : Object(d.a)(e);
        },
        u = function (e, k) {
          return Object(f.a)(void 0, void 0, Promise, function () {
            var a;
            return Object(f.b)(this, function (t) {
              switch (t.label) {
                case 0:
                  return g ? [3, 2] : [4, Object(q.a)(self.Core.getWorkerPath() + 'external/decode.min.js', 'Failed to download decode.min.js', window)];
                case 1:
                  t.sent(), (g = !0), (t.label = 2);
                case 2:
                  return (a = self.BrotliDecode(Object(d.b)(e))), [2, k ? a : Object(d.a)(a)];
              }
            });
          });
        };
      ...
      var p = !1,
        ...
        r = function (e) {
          ...
          var t = k && a.overrideMimeType;
          a.responseType = t ? 'text' : 'arraybuffer';
          t && a.overrideMimeType('text/plain; charset=x-user-defined');
          a.send();
          var g = function () {
            var D = Date.now();
            var g = t ? a.responseText : new Uint8Array(a.response);
            Object(n.a)('worker', 'Result length is ' + g.length);
            g.length < e.compressedMaximum
              ? ((g = e.decompressFunction(g, e.shouldOutputArray)),
                Object(n.f)(
                ...
                b && Object(n.a)('worker', 'Decompressed length is ' + g.length))
              : k && (g = Object(d.a)(g));
            b && Object(n.a)('worker', e.url + ' Decompression took ' + (Date.now() - D));
            return g;
          };
          if (e.isAsync)
            var m = new Promise(function (k, b) {
              a.onload = function () {
                200 === this.status || 0 === this.status ? k(g()) : b('Download Failed ' + e.url);
              };
              a.onerror = function () {
                b('Network error occurred ' + e.url);
              };
            });
          else {
            if (200 === a.status || 0 === a.status) return g();
        ...
        x = function (e) {
          ...
          b || (a.endsWith('.js.mem') ? (a = a.replace('.js.mem', '.mem')) : a.endsWith('.js') && (a = a.concat('.mem')));
          return e.slice(0, k) + a;
        },
        y = function (e, k) {
          var a = e.lastIndexOf('/');
          -1 === a && (a = 0);
          var b = e.slice(a).replace('.', '.gz.');
          k.url = e.slice(0, a) + b;
        ...
        F = function (e, k, a) {
          ...
          if (a.isAsync) {
            var t = k[0](e, a);
            for (b = 1; b < k.length; ++b) t = E(t, e, a, k[b]);
            return t;
          }
    ...
    function (c, l, h) {
      ...
      var f = function (f) {
          if ('string' === typeof f) {
            for (var d = new Uint8Array(f.length), a = f.length, b = 0; b < a; b++) d[b] = f.charCodeAt(b);
            return d;
          }
          return f;
        },
        n = function (f) {
          if ('string' !== typeof f) {
            for (var d = '', a = 0, b = f.length, g; a < b; ) (g = f.subarray(a, a + 1024)), (a += 1024), (d += String.fromCharCode.apply(null, g));
            return d;
          }
          return f;
        };
    ...
    function (c, l, h) {
      ...
      var n = (function () {
        var a = f.navigator.userAgent.match(/OPR/),
          ...
          g = f.navigator.userAgent.match(/Edge/);
        return f.navigator.userAgent.match(/Chrome\/(.*?) /) && !a && !b && !g;
      })();
      (function () {
        if (!n) return null;
      ...
      var q = !!navigator.userAgent.match(/Edge/i) || (navigator.userAgent.match(/Edg\/(.*?)/) && f.navigator.userAgent.match(/Chrome\/(.*?) /));
      (function () {
        if (!q) return null;
      ...
      l =
        ...
        /iPad|iPhone|iPod/.test(f.navigator.userAgent);
      var d = (function () {
        ...
        b = f.navigator.userAgent.match(/Firefox/);
      (function () {
        if (!b) return null;
      ...
      var g = /Mac OS X 10_13_6.*\(KHTML, like Gecko\)$/.test(f.navigator.userAgent),
        m = f.navigator.userAgent.match(/(iPad|iPhone).+\sOS\s((\d+)(_\d)*)/i)
          ? 14 <= parseInt(f.navigator.userAgent.match(/(iPad|iPhone).+\sOS\s((\d+)(_\d)*)/i)[3], 10)
          : !1,
        u = !(!self.WebAssembly || !self.WebAssembly.validate),
        p = -1 < f.navigator.userAgent.indexOf('Edge/16') || -1 < f.navigator.userAgent.indexOf('MSAppHost'),
        z = function () {
          return u && !p && !(!m && ((a && 14 > d) || g));
        };
    },
    function (c, l, h) {
      function f(a) {
      ...
      !(function (a) {
        'object' === f(l) && 'undefined' !== typeof c
          ? (c.exports = a())
          : !((q = []), (n = a), (d = 'function' === typeof n ? n.apply(l, q) : n), void 0 !== d && (c.exports = d));
      })(function () {
        return (function u(b, g, d) {
          function m(p, c) {
            if (!g[p]) {
              if (!b[p]) {
                if (f) return f(p, !0);
                c = Error("Cannot find module '".concat(p, "'"));
          ...
          for (var f = !1, c = 0; c < d.length; c++) m(d[c]);
          return m;
        })(
          {
            1: [
              function (b, g, d) {
                var f = {}.hasOwnProperty,
                  m = function (b, g) {
                    ...
                    for (var m in g) f.call(g, m) && (b[m] = g[m]);
                ...
                d = (function (b) {
                  function g(b) {
                    ...
                    b.comparator ||
                      (b.comparator = function (b, g) {
                        return (b || 0) - (g || 0);
                      });
                    g.__super__.constructor.call(this, b);
                  }
                  m(g, b);
                  return g;
                })(d);
            ...
            2: [
              function (b, g, d) {
                g.exports = (function () {
                  function b(b) {
                    if (null == (null != b ? b.strategy : void 0)) throw 'Must pass options.strategy, a strategy';
                    if (null == (null != b ? b.comparator : void 0)) throw 'Must pass options.comparator, a comparator';
                  ...
                  b.prototype.removeAllMatching = function (b, g) {
                    b = this.priv.removeAllMatching(b, g);
                    this.length -= b;
                  };
                  return b;
                })();
              ...
              function (b, g, d) {
                ...
                g.exports = (function () {
                  function b(b) {
                    ...
                    this.data = (null != (g = this.options.initialValues) ? g.slice(0) : void 0) || [];
                    this.data.sort(this.comparator).reverse();
                  }
                  b.prototype.queue = function (b) {
                    var g = f(this.data, b, this.comparator);
                  ...
                  b.prototype.find = function (b) {
                    var g = f(this.data, b, this.comparator) - 1;
                  ...
                  b.prototype.removeAllMatching = function (b, g) {
                    for (var d = 0, f = this.data.length - 1; 0 <= f; --f)
                      if (b(this.data[f])) {
                        var m = this.data.splice(f, 1)[0];
                        g && g(m);
                        ++d;
                      }
                    return d;
    ...
    function (c, l, h) {
      (function (f) {
        ...
        var q = ('undefined' !== typeof f && f) || ('undefined' !== typeof self && self) || window,
          d = Function.prototype.apply;
        l.setTimeout = function () {
          return new c(d.call(setTimeout, q, arguments), clearTimeout);
        };
        l.setInterval = function () {
          return new c(d.call(setInterval, q, arguments), clearInterval);
        };
        ...
        l.clearImmediate =
          ('undefined' !== typeof self && self.clearImmediate) || ('undefined' !== typeof f && f.clearImmediate) || (this && this.clearImmediate);
      }).call(this, h(10));
    },
    function (c, l, h) {
      function f(f, d, a) {
          ...
          return m
            ? (Object(n.a)('load', 'Try instantiateStreaming'),
              fetch(Object(q.a)(a))
                ...
                .catch(function (b) {
                  Object(n.a)('load', 'instantiateStreaming Failed ' + a + ' message ' + b.message);
                  return d(!1);
                }))
            : Object(q.b)(a, g, !0, !0).then(function (a) {
                f = Date.now();
                Object(n.a)('load', 'Request took ' + (f - c) + ' ms');
                return WebAssembly.instantiate(a, b);
              });
        }
        var f, c;
        return d(!!WebAssembly.instantiateStreaming).then(function (a) {
          Object(n.a)('load', 'WASM compilation took ' + (Date.now() - (f || c)) + ' ms');
          return a;
        });
      }
      h.d(l, 'a', function () {
    ...
    function (c, l, h) {
      function f(f, d, a, b) {
        ...
        return new (a || (a = Promise))(function (a, c) {
          ...
          function u(b) {
            b.done ? a(b.value) : g(b.value).then(m, h);
          }
          u((b = b.apply(f, d || [])).next());
        });
      }
      function n(f, d) {
        function a(a) {
        ...
        function b(a) {
          ...
          for (; g; )
            try {
              if (
                ((m = 1), c && (p = a[0] & 2 ? c['return'] : a[0] ? c['throw'] || ((p = c['return']) && p.call(c), 0) : c.next) && !(p = p.call(c, a[1])).done)
              )
                return p;
              if (((c = 0), p)) a = [a[0] & 2, p.value];
              switch (a[0]) {
                case 0:
                case 1:
                  p = a;
                ...
                case 7:
                  ...
                  continue;
                default:
                  if (!((p = g.trys), (p = 0 < p.length && p[p.length - 1])) && (6 === a[0] || 2 === a[0])) {
                    g = 0;
                    continue;
                  }
                  if (3 === a[0] && (!p || (a[1] > p[0] && a[1] < p[3]))) g.label = a[1];
                  else if (6 === a[0] && g.label < p[1]) (g.label = p[1]), (p = a);
                  else if (p && g.label < p[2]) (g.label = p[2]), g.ops.push(a);
                  else {
                    p[2] && g.ops.pop();
                    g.trys.pop();
                    continue;
    ...
    function (c, l) {
      ...
      function n(a) {
        ...
        if ((m === h || !m) && setTimeout) return (m = setTimeout), setTimeout(a, 0);
        try {
          return m(a, 0);
        } catch (y) {
          try {
      ...
      function q(a) {
        ...
        if ((u === f || !u) && clearTimeout) return (u = clearTimeout), clearTimeout(a);
        try {
          return u(a);
        } catch (y) {
          try {
      ...
      function d() {
        z && v && ((z = !1), v.length ? (p = v.concat(p)) : (r = -1), p.length && a());
      }
      function a() {
        if (!z) {
          var a = n(d);
    ...
    function (c, l, h) {
      (function (f) {
        function c(a) {
          ...
          for (var b = Array(arguments.length - 1), g = 0; g < b.length; g++) b[g] = arguments[g + 1];
          v[z] = { callback: a, args: b };
          y(z);
          return z++;
        }
        function h(a) {
        ...
        function g() {
          var a = 'setImmediate$' + Math.random() + '$',
            b = function (b) {
              (b.source !== p && b.source !== p.parent) || 'string' !== typeof b.data || 0 !== b.data.indexOf(a) || d(+b.data.slice(a.length));
            };
        ...
        var p = 'undefined' === typeof window ? self : window,
          ...
          x = p.document,
          y,
          B = Object.getPrototypeOf && Object.getPrototypeOf(p);
        B = B && B.setTimeout ? B : p;
        '[object process]' === {}.toString.call(p.process) ? a() : b() ? g() : x && 'onreadystatechange' in x.createElement('script') ? m() : u();
        B.setImmediate = c;
        B.clearImmediate = h;
        l.a = { setImmediate: c, clearImmediate: h };
      }).call(this, h(12));
    },
    function (c, l, h) {
      var f = h(0),
      ...
      c = (function () {
        function c(d, a) {
          ...
          a.addEventListener('message', this.msgHandler);
        }
        c.prototype.on = function (d, a, b) {
          var g = this.actionHandler;
          g[d] && Object(f.d)('There is already an actionName called "' + d + '"');
          g[d] = [a, b];
        };
        ...
        c.prototype.replace = function (d, a, b) {
          this.actionHandler[d] = [a, b];
        };
        c.prototype.onAsync = function (d, a, b) {
          var g = this.actionHandlerAsync;
          g[d] && Object(f.d)('There is already an actionName called "' + d + '"');
          g[d] = [a, b];
        };
        c.prototype.replaceAsync = function (d, a, b) {
          var g = this.actionHandlerAsync,
            c = this.actionHandler;
          c[d] && delete c[d];
          g[d] = [a, b];
        };
        c.prototype.onNextAsync = function (d) {
          this.nextAsync = d;
        };
        c.prototype.send = function (d, a) {
          this.postMessage({ action: d, data: a });
        };
        c.prototype.getNextId = function () {
          return this.callbackIndex++;
        };
        c.prototype.sendWithPromise = function (d, a, b) {
          var g = this.getNextId();
          d = { action: d, data: a, callbackId: g, priority: b };
          a = window.createPromiseCapability();
          this.callbacksCapabilities[g] = a;
          try {
            this.postMessage(d);
          } catch (m) {
            a.reject(m);
        ...
        c.prototype.sendWithPromiseReturnId = function (d, a, b) {
          var g = this.getNextId();
          d = { action: d, data: a, callbackId: g, priority: b };
          a = window.createPromiseCapability();
          this.callbacksCapabilities[g] = a;
          ...
          return { promise: a.promise, callbackId: g };
        };
        c.prototype.sendWithPromiseWithId = function (d, a, b) {
          a > this.callbackIndex && Object(f.d)("Can't reuse callbackId " + a + ' lesser than callbackIndex ' + this.callbackIndex);
          a in this.callbacksCapabilities && Object(f.d)("Can't reuse callbackId " + a + '. There is a capability waiting to be resolved. ');
          d = { action: d, data: b, callbackId: a };
          b = window.createPromiseCapability();
          this.callbacksCapabilities[a] = b;
          try {
            this.postMessage(d);
          } catch (g) {
            b.reject(g);
        ...
        c.prototype.sendError = function (d, a) {
          if (d.message || d.errorData) {
            d.message && d.message.message && (d.message = d.message.message);
            var b = d.errorData;
            d = {
              type: d.type ? d.type : 'JavascriptError',
              message: d.message,
            };
            b &&
          ...
          this.postMessage({ isReply: !0, callbackId: a, error: d });
        };
        c.prototype.getPromise = function (d) {
          if (d in this.callbacksCapabilities) return this.callbacksCapabilities[d];
          Object(f.d)('Cannot get promise for callback ' + d);
        };
        c.prototype.cancelPromise = function (d) {
          if (d in this.callbacksCapabilities) {
            var a = this.callbacksCapabilities[d];
            delete this.callbacksCapabilities[d];
            this.pdfnetActiveCommands.has(d) && this.pdfnetActiveCommands.delete(d);
            a.reject({
              type: 'Cancelled',
        ...
        c.prototype.postMessage = function (d) {
          Object(n.a)('enableWorkerLogs') && Object(f.e)('PDFWorker', 'Sent ' + JSON.stringify(d));
          if (this.postMessageTransfers) {
            var a = this.getTransfersArray(d);
            this.comObj.postMessage(d, a);
          } else this.comObj.postMessage(d);
        };
        c.prototype.getObjectTransfers = function (d, a) {
          var b = this;
          null !== d &&
            'object' === typeof d &&
            (d instanceof Uint8Array
              ...
              : Object.keys(d).forEach(function (g) {
                  d.hasOwnProperty(g) && b.getObjectTransfers(d[g], a);
                }));
        };
        c.prototype.getTransfersArray = function (d) {
          var a = [];
          this.getObjectTransfers(d, a);
          return 0 === a.length ? void 0 : a;
        };
        c.prototype.handleMessage = function (d) {
          var a = this,
            b = d.data;
          Object(n.a)('enableWorkerLogs') && Object(f.e)('PDFWorker', 'Received ' + JSON.stringify(b));
          var g = this.actionHandler,
            c = this.actionHandlerAsync;
          d = this.callbacksCapabilities;
          var h = this.pdfnetActiveCommands;
          if (b.isReply)
            (g = b.callbackId),
              g in d
                ? ((c = d[g]), delete d[g], h.has(g) && h.delete(g), 'error' in b ? c.reject(b.error) : c.resolve(b.data))
                : Object(f.a)('Cannot resolve callback ' + g);
          else if (b.action in g) {
            var p = g[b.action];
            b.callbackId
              ? Promise.resolve()
                  .then(function () {
                    return p[0].call(p[1], b.data);
                  })
                  .then(
                    function (g) {
                      a.postMessage({
            ...
            b.action in c
              ...
              : Object(f.d)('Unknown action from worker: ' + b.action);
        };
        return c;
      })();
      l.a = c;
    ...
    function (c, l, h) {
      ...
      var f = h(3),
        ...
        a = function (a, g, c) {
          if (Object(q.a)() && !c) {
            self.Module.instantiateWasm = function (b, c) {
              return Object(n.a)(a + 'Wasm.wasm', b, g['Wasm.wasm']).then(function (a) {
                c(a.instance);
              });
            };
            if (g.disableObjectURLBlobs) {
              importScripts(a + 'Wasm.js');
              return;
            }
            c = Object(f.b)(a + 'Wasm.js.mem', g['Wasm.js.mem'], !1, !1);
          } else {
            if (g.disableObjectURLBlobs) {
              importScripts((self.Module.asmjsPrefix ? self.Module.asmjsPrefix : '') + a + '.js');
              return;
            }
            c = Object(f.b)((self.Module.asmjsPrefix ? self.Module.asmjsPrefix : '') + a + '.js.mem', g['.js.mem'], !1);
            var b = Object(f.c)((self.Module.memoryInitializerPrefixURL ? self.Module.memoryInitializerPrefixURL : '') + a + '.mem', g['.mem'], !0, !0);
            self.Module.memoryInitializerRequest = new d(b);
          }
        ...
        'undefined' === typeof c.crypto &&
          (c.crypto = {
            getRandomValues: function (c) {
              for (var f = 0; f < c.length; f++) c[f] = 256 * Math.random();
            },
          });
    ...
    function (c, l, h) {
      (function (c, l) {
        ...
        (function (c) {
          function a() {
            for (var a = 0; a < A.length; a++) A[a][0](A[a][1]);
            A = [];
            I = !1;
          }
          function b(e, k) {
          ...
          function n(a, k) {
            a.state_ === F && ((a.state_ = e), (a.data_ = k), b(x, a));
          }
          function v(a, k) {
            a.state_ === F && ((a.state_ = e), (a.data_ = k), b(y, a));
          }
          function r(a) {
            var e = a.then_;
            a.then_ = void 0;
            for (a = 0; a < e.length; a++) d(e[a]);
          }
          function x(a) {
            a.state_ = k;
            r(a);
          ...
          'undefined' !== typeof exports && exports
            ? ((exports.Promise = E ? C : q), (exports.Polyfill = q))
            : 'function' === typeof define && h(24)
            ? define(function () {
                return E ? C : q;
              })
            : E || (c.Promise = q);
          var F = 'pending',
            ...
            t = 'rejected',
            w = function () {},
            D = 'undefined' !== typeof l ? l : setTimeout,
            A = [],
            I;
          q.prototype = {
            constructor: q,
            ...
            then: function (a, e) {
              ...
              this.state_ === k || this.state_ === t ? b(d, a) : this.then_.push(a);
              return a.then;
            },
            catch: function (a) {
          ...
          q.all = function (a) {
            ...
            return new this(function (e, k) {
              ...
              for (var t = [], g = 0, c = 0, d; c < a.length; c++) (d = a[c]) && 'function' === typeof d.then ? d.then(b(c), k) : (t[c] = d);
              g || e(t);
            });
          };
          q.race = function (a) {
            ...
            return new this(function (e, k) {
              for (var b = 0, t; b < a.length; b++) (t = a[b]) && 'function' === typeof t.then ? t.then(e, k) : e(t);
            });
          };
          q.resolve = function (a) {
            return a && 'object' === f(a) && a.constructor === this
              ? a
              : new this(function (e) {
                  e(a);
                });
      ...
      (function (c, h) {
        (function (c, d) {
          ...
          function u() {
            var a = 'setImmediate$' + Math.random() + '$',
              e = function (e) {
                e.source === c && 'string' === typeof e.data && 0 === e.data.indexOf(a) && b(+e.data.slice(a.length));
              };
            c.addEventListener ? c.addEventListener('message', e, !1) : c.attachEvent('onmessage', e);
            C = function (e) {
              c.postMessage(a + e, '*');
            };
          }
          ...
          if (!c.setImmediate) {
            var r = 1,
              ...
              q = c.document,
              C,
              E = Object.getPrototypeOf && Object.getPrototypeOf(c);
            E = E && E.setTimeout ? E : c;
            ...
            E.setImmediate = function (a) {
              'function' !== typeof a && (a = new Function('' + a));
              for (var e = Array(arguments.length - 1), k = 0; k < e.length; k++) e[k] = arguments[k + 1];
              x[r] = { callback: a, args: e };
              C(r);
              return r++;
            };
            E.clearImmediate = a;
    ...
    function (c, l, h) {
      (function (c) {
        ...
        c.CancellablePromise = function (c, d) {
          var a = !1,
            b,
        ...
        c.CancellablePromise.all = function (c) {
          var d = Promise.all(c);
          return f(d, function () {
      ...
      (function (c, l) {
        ...
        (function (d) {
          d.Module = {
            ...
            postProgressiveRenderingStartEvent: function (a, b) {
              Module.postEvent(a, 'progressiveRenderingStart', { pageNum: b });
            },
            postPagesUpdatedEvent: function (a, b, g, c) {
              a = { pageDimensions: Module.GetPageDimensions(a) };
              if (g)
                for (var d = 0; d < g.length; ++d)
                  g[d] in a.pageDimensions
                    ? ((a.pageDimensions[g[d]].contentChanged = !0), c && (a.pageDimensions[g[d]].annotationsUnchanged = !0))
                    : console.warn('Invalid Page Number '.concat(g[d]));
            ...
            postPagesRenamedEvent: function (a, b) {
              ...
              for (var c = 1; Module.IteratorHasNext(a); ++c) {
                var d = Module.stackSave(),
                  f = Module.IteratorCurrent(a);
                g[c] = Module.PageGetId(f);
                Module.IteratorNext(a);
                Module.stackRestore(d);
              }
              Module.postEvent(b, 'pagesRenamed', { pageNumToId: g });
            },
            GetIndividualPageDimensions: function (a, b, g) {
              a = Module.PageGetPageInfo(g);
              a.id = Module.PageGetId(g);
              return a;
            },
            GetPageDimensionsRange: function (a, b, g) {
              for (var c = {}, d = Module.PDFDocGetPageIterator(a, b); b < g && Module.IteratorHasNext(d); ++b) {
                var f = Module.stackSave(),
                  h = Module.IteratorCurrent(d);
                c[b] = this.GetIndividualPageDimensions(a, b, h);
            ...
            GetPageDimensionsContentChangedList: function (a, b) {
              ...
              for (var c = {}, d = b[0], f = b[b.length - 1], h = 0, l = Module.PDFDocGetPageIterator(a, d); d <= f && Module.IteratorHasNext(l); ++d) {
                if (b[h] == d) {
                  ++h;
                  var n = Module.stackSave(),
                    r = Module.IteratorCurrent(l);
                  r = this.GetIndividualPageDimensions(a, d, r);
                  r.contentChanged = !0;
                  c[d] = r;
            ...
            loadCanvas: function (a, b, c, d, f, h, l, n) {
              return new Promise(function (g, m) {
                var p = Module.GetDoc(a),
                  r = b + 1,
                  u = function () {
                    g(Module.RasterizePage(p, r, c, d, h, f, l, n, a));
                  },
                  v = Module.docs[a].chunkStorage;
                if (v) {
                  var x = Module.GetDownloadData(p).downloader,
                    e = v.getRequiredChunkOffsetArrays(x, r);
                  v.keepChunks(e.have);
                  x = function () {
                    var a = v.getChunks(e.missing);
                    Module.loadPromise = a
                      ...
                      ['catch'](function (a) {
                        'cancelled' !== a ? m(a) : (Module.loadPromise = null);
                      });
                  };
                  Module.loadPromise ? Module.loadPromise.then(x, x) : x();
                } else u();
              });
            },
            loadResources: function (a, b) {
              Module.Initialize(b);
              Object(f.b)('worker', 'PDFNet initialized!');
            ...
            onRuntimeInitialized: function () {
              ...
              (function (a) {
                a.PDFDocExportXFDF = function (a, c) {
                  ...
                  var b = Module.stackSave();
                  try {
                    var g = c ? Module.PDFDocFDFExtract(a, c) : Module.PDFDocFDFExtract(a);
                    var d = Module.FDFDocSaveAsXFDF(g);
                    Module.stackRestore(b);
                  } catch (z) {
                    throw (Module.stackRestore(b), z);
                  }
                  return d;
                };
                ...
                a.XFDFMerge = function (a, c, d) {
                  if (c) {
                    var b = Module.GetDoc(a),
                      g = [];
                    try {
                      Object(f.b)('worker', 'Merge XFDF of length '.concat(c.length));
                      var h = Module.GetUStringFromJSString(c, !0);
                      g.push(function () {
                        Module.UStringDestroy(h);
                      });
                      var m = Module.allocate(4, 'i8', Module.ALLOC_STACK);
                      REX(Module._TRN_FDFDocCreateFromXFDF(h, m));
                      var l = Module.getValue(m, 'i8*');
                      g.push(function () {
                        Module.FDFDocDestroy(l);
                      });
                      var n = Module.PDFDocFDFUpdate(b, l, d);
                      n &&
                        n.length &&
                        Module.postEvent(a, 'apRefChanged', {
                          apRefChanges: n,
                        });
                    } finally {
                ...
                a.SaveDoc = function (a, c, f, h, p, l, n, r, x) {
                  return new Promise(function (b, g) {
                    var m = [];
                    try {
                      ...
                      Module.XFDFMerge(a, c, n);
                      var e = Module.allocate(8, 'i8', Module.ALLOC_STACK),
                        k = Module.allocate(Module.intArrayFromString('{"UseNonStandardRotation": true}'), 'i8', Module.ALLOC_STACK);
                      Module.setValue(e, k, 'i8*');
                      Module.setValue(e + 4, 0, 'i32');
                      Module._TRN_PDFDocRefreshAnnotAppearances(v, e);
                      if (l) {
                        e = function (a) {
                          a = new Uint8Array(a);
                          d.FS.writeFile('watermarkFile', a);
                          a = Module.ImageCreateFromFile(v, Module.GetUStringFromJSString('watermarkFile'));
                          d.FS.unlink('watermarkFile');
                          return a;
                        };
                        var t = Module.ElementBuilderCreate();
                        m.push(function () {
                          Module.ElementBuilderDestroy(t);
                        });
                        ...
                        try {
                          ...
                          var D = e(l['default']),
                            A = Module.PDFDocGetPageIterator(v, 1);
                          for (k = -1; Module.IteratorHasNext(A); ) {
                            var y = Module.IteratorCurrent(A);
                            Module.IteratorNext(A);
                            k++;
                            var q = k.toString();
                            try {
                              ...
                              var J = Module.PageGetPageInfo(y),
                                G = Module.ElementBuilderCreateImage(t, z, 0, 0, J.width, J.height);
                              Module.ElementWriterBegin(w, y);
                              Module.ElementWriterWritePlacedElement(w, G);
                              Module.ElementWriterEnd(w);
                            } catch (K) {
                              console.warn('Watermark for page ' + q + 'can not be added due to error: ' + K);
                            }
                          }
                        } catch (K) {
                          console.warn('Watermarks can not be added due to error: ' + K);
                        }
                      }
                      if (r) {
                        var M = Module.SecurityHandlerCreate(x);
                        M && (Module.SecurityHandlerChangeUserPasswordUString(M, r), Module.PDFDocSetSecurityHandler(v, M));
                      }
                      D = 0;
                      if (h) {
                        var H = Module.PDFDocGetRoot(v);
                        (D = Module.ObjFindObj(H, 'OpenAction')) && Module.ObjPut(H, '__OpenActionBackup__', D);
                        var N = Module.ObjPutDict(H, 'OpenAction');
                        Module.ObjPutName(N, 'Type', 'Action');
                        Module.ObjPutName(N, 'S', 'JavaScript');
                        Module.ObjPutString(N, 'JS', 'this.print()');
                      }
                      var O = Module.SaveHelper(v, a, p);
                      h && (D ? Module.ObjPut(H, 'OpenAction', Module.ObjFindObj(H, '__OpenActionBackup__')) : Module.ObjErase(H, 'OpenAction'));
                ...
                a.SaveDocFromFixedElements = function (a, c, d, f, h, l) {
                  a = Module.PDFDocCreateFromLayoutEls(a);
                  a = Module.CreateDoc({ type: 'ptr', value: a });
                  return Module.SaveDoc(a, c, !0, !1, d, f, h, l);
                };
                a.GetCurrentCanvasData = function (a) {
                  ...
                  if (b.bufPtr) {
                    ...
                    for (var d = 0, h = 0; h < b.out_height; ++h)
                      for (var l = b.bufPtr + b.stride * h, n = 0; n < b.out_width; ++n)
                        (a[d++] = Module.HEAPU8[l + 2]),
                          (a[d++] = Module.HEAPU8[l + 1]),
                          (a[d++] = Module.HEAPU8[l]),
                          (a[d++] = Module.HEAPU8[l + 3]),
                          (l += 4);
                  } else a = Module.ReadBufferFile('b', a);
                  Object(f.b)('bufferTiming', 'Copy took '.concat(Date.now() - c));
                  return {
                    pageBuf: a.buffer,
                ...
                a.RasterizePage = function (a, c, d, h, p, n, v, r, x) {
                  return new Promise(function (b, g) {
                    ...
                    var m = Module.currentRenderData;
                    m.out_width = parseInt(d, 10);
                    m.out_height = parseInt(h, 10);
                    var u = [];
                    u.push(function () {
                      Module.currentRenderData = null;
                    });
                    try {
                      var y = Module.stackSave();
                      u[u.length] = function () {
                        Module.stackRestore(y);
                      };
                      var e = Module.GetPage(a, c),
                        k = Module.PageGetPageWidth(e),
                        t = Module.PageGetPageHeight(e);
                      m.stride = 4 * m.out_width;
                      m.buf_size = m.out_width * m.out_height * 4;
                      Object(f.b)('Memory', 'Created rasterizer');
                      m.rast = Module.PDFRasterizerCreate();
                      u.push(function () {
                        Object(f.b)('Memory', 'Destroyed rasterizer');
                        Module._TRN_PDFRasterizerDestroy(m.rast);
                      });
                      if (v) {
                        var w = Module.EMSCreateUpdatedLayersContext(a, v);
                        0 !== w &&
                          (REX(Module._TRN_PDFRasterizerSetOCGContext(m.rast, w)),
                          u.push(function () {
                            Module._TRN_OCGContextDestroy(w);
                          }));
                      }
                      var D = !1;
                      r.hasOwnProperty('renderAnnots')
                        ? (r.renderAnnots && (D = !0), REX(Module._TRN_PDFRasterizerSetDrawAnnotations(m.rast, r.renderAnnots ? 1 : 0)))
                        : REX(Module._TRN_PDFRasterizerSetDrawAnnotations(m.rast, 0));
                      r.hasOwnProperty('highlightFields') &&
                        (r.highlightFields && (D = !0), REX(Module._TRN_PDFRasterizerSetHighlightFields(m.rast, r.highlightFields)));
                      r.hasOwnProperty('antiAliasing') && REX(Module._TRN_PDFRasterizerSetAntiAliasing(m.rast, r.antiAliasing));
                      r.hasOwnProperty('pathHinting') && REX(Module._TRN_PDFRasterizerSetPathHinting(m.rast, r.pathHinting));
                      if (r.hasOwnProperty('thinLinePixelGridFit')) {
                        var A = !0;
                        r.hasOwnProperty('thinLineStrokeAdjust') && (A = r.thinLineStrokeAdjust);
                        REX(Module._TRN_PDFRasterizerSetThinLineAdjustment(m.rast, r.thinLinePixelGridFit, A));
                      } else
                        r.hasOwnProperty('thinLineStrokeAdjust') && REX(Module._TRN_PDFRasterizerSetThinLineAdjustment(m.rast, !1, r.thinLineStrokeAdjust));
                      r.hasOwnProperty('imageSmoothing')
                        ? ((A = !1),
                          r.hasOwnProperty('hqImageResampling') && (A = r.hqImageResampling),
                          REX(Module._TRN_PDFRasterizerSetImageSmoothing(m.rast, r.imageSmoothing, A)))
                        : r.hasOwnProperty('hqImageResampling') && REX(Module._TRN_PDFRasterizerSetImageSmoothing(m.rast, !0, r.hqImageResampling));
                      r.hasOwnProperty('caching') && REX(Module._TRN_PDFRasterizerSetCaching(m.rast, r.caching));
                      r.hasOwnProperty('expGamma') && REX(Module._TRN_PDFRasterizerSetGamma(m.rast, r.expGamma));
                      r.hasOwnProperty('isPrinting') && (r.isPrinting && (D = !0), REX(Module._TRN_PDFRasterizerSetPrintMode(m.rast, r.isPrinting)));
                      r.hasOwnProperty('colorPostProcessMode') &&
                        (r.colorPostProcessMode && (D = !0), REX(Module._TRN_PDFRasterizerSetColorPostProcessMode(m.rast, r.colorPostProcessMode)));
                      var I = Module.PageGetRotation(e);
                      A = 1 === n || 3 === n;
                      I = (1 === I || 3 === I) !== A;
                      var q = Module.allocate(48, 'i8', Module.ALLOC_STACK);
                      if (p) {
                        p.x1 = p[0];
                        p.y1 = p[1];
                        p.x2 = p[2];
                        p.y2 = p[3];
                        var B = Module.PageGetDefaultMatrix(e, 0),
                          z = Module.Matrix2DInverse(B);
                        p = Module.Matrix2DMultBBox(z, p);
                        if (p.x2 < p.x1) {
                          var J = p.x1;
                          p.x1 = p.x2;
                          p.x2 = J;
                        ...
                        var G = m.out_width / (I ? p.y2 - p.y1 : p.x2 - p.x1);
                        var M = Module.GetDefaultMatrixBox(e, p, n);
                      } else (M = Module.PageGetDefaultMatrix(e, n)), (G = m.out_width / (A ? t : k));
                      Module.Matrix2DSet(q, G, 0, 0, G, 0, 0);
                      Module.Matrix2DConcat(q, M);
                      var H = Module.allocate(4, 'i8', Module.ALLOC_STACK),
                        N = Module.allocate(4, 'i8', Module.ALLOC_STACK);
                      D
                        ? ((m.bufPtr = Module._malloc(m.buf_size)),
                          Module._memset(m.bufPtr, r.pageTransparent ? 0 : 255, m.buf_size),
                          u.push(function () {
                            Module._free(m.bufPtr);
                          }))
                        : (Module.CreateBufferFile('b', m.buf_size, r.pageTransparent),
                          u.push(function () {
                            Module.RemoveBufferFile('b');
                          }));
                      var O = r.overprintMode;
                      if (10 === O) {
                        REX(Module._TRN_PDFRasterizerSetOverprint(m.rast, 1));
                        var Q = Module.PDFRasterizerRasterizeSeparations(m.rast, e, m.out_width, m.out_height, q, 0, 0);
                        b({
                          pageBuf: Q,
                          pageWidth: m.out_width,
                          pageHeight: m.out_height,
                        });
                      } else {
                        REX(Module._TRN_PDFRasterizerSetOverprint(m.rast, O));
                        D
                          ? REX(Module._TRN_PDFRasterizerGetChunkRenderer(m.rast, e, m.bufPtr, m.out_width, m.out_height, m.stride, 4, !0, q, 0, 0, 0, H))
                          : REX(
                        ...
                        var K = Module.getValue(H, 'i8*');
                        u.push(function () {
                          REX(Module._TRN_ChunkRendererDestroy(K));
                        });
                      }
                      var R = new Date().getTime();
                      r.useProgress && Module.postProgressiveRenderingStartEvent(x, c);
                      var U = l(function S() {
                        try {
                          if ((REX(Module._TRN_ChunkRendererRenderForTimePeriod(K, 200, N)), Module.getValue(N, 'i8'))) Module.cleanupState.timeout = l(S);
                          else {
                            var a = Module.GetCurrentCanvasData(!1);
                            Object(f.b)('worker', 'Total Page Time '.concat(new Date().getTime() - R));
                      ...
                      Module.cleanupState = { cleanupArr: u, timeout: U };
                      u.push(function () {
                        Module.cleanupState = null;
                      });
                    } catch (V) {
                ...
                a.UpdatePassword = function (a, c) {
                  try {
                    ...
                    return Module.PDFDocInitStdSecurityHandler(d, c)
                      ? (d in downloadDataMap && REX(Module._TRN_PDFDocDownloaderInitialize(d, downloadDataMap[d].downloader)),
                        {
                          success: !0,
                ...
                a.TriggerFullDownload = function (a) {
                  return new Promise(function (b, c) {
                    var d = Module.GetDoc(a);
                    try {
                      d in downloadDataMap && REX(Module.PDFDocDownloaderTriggerFullDownload(d, downloadDataMap[d].downloader)), b({});
                    } catch (p) {
                      c(p);
                    }
                  });
                };
                a.InsertBlankPages = function (a, c, d, f) {
                  return new Promise(function (b, g) {
                    var h = [],
                      m = Module.GetDoc(a);
                    try {
                      ...
                      for (var p = c.length - 1; 0 <= p; --p) {
                        var n = Module.PDFDocGetPageIterator(m, c[p]),
                          u = Module.PDFDocPageCreate(m, d, f);
                        Module.PDFDocPageInsert(m, n, u);
                      }
                      var q = Module.postPagesUpdatedEvent(m, a);
                  ...
                  return new Promise(function (b, g) {
                    ...
                    try {
                      ...
                      if (c instanceof ArrayBuffer) {
                        var r = Module.CreateDoc(c);
                        var v = Module.GetDoc(r);
                        m[m.length] = function () {
                          Module.DeleteDoc(r);
                        };
                      } else v = Module.GetDoc(c);
                      for (var u = d.length, e = Module.PageSetCreate(), k = 0; k < u; ++k) Module.PageSetAddPage(e, d[k]);
                      l ? Module.PDFDocInsertPages2(p, f, v, e, h) : Module.PDFDocInsertPages(p, f, v, e, h);
                      var t;
                      l || (t = Module.postPagesUpdatedEvent(p, a));
                      m.reverse().forEach(function (a) {
                        a();
                      });
                      b(t);
                ...
                a.MovePages = function (a, c, d) {
                  return new Promise(function (b, g) {
                    ...
                    try {
                      ...
                      for (var l = c.length, p = Module.PageSetCreate(), n = 0; n < l; ++n) Module.PageSetAddPage(p, c[n]);
                      Module.PDFDocMovePages(h, d, p);
                      var u = Module.postPagesUpdatedEvent(h, a);
                      f.forEach(function (a) {
                        a();
                      });
                      b(u);
                  ...
                  return new Promise(function (b, g) {
                    ...
                    try {
                      ...
                      for (var l = c.length - 1; 0 <= l; --l) {
                        var p = Module.PDFDocGetPageIterator(f, c[l]);
                        Module.IteratorHasNext(p) && (d ? Module.PDFDocPageRemove2(f, p) : Module.PDFDocPageRemove(f, p));
                      }
                      var n;
                      d || (n = Module.postPagesUpdatedEvent(f, a));
                      h.forEach(function (a) {
                        a();
                      });
                      b(n);
                ...
                a.RotatePages = function (a, c, d) {
                  return new Promise(function (b, f) {
                    ...
                    try {
                      ...
                      var l = c.length,
                        p = 0,
                        n = Module.PDFDocGetPageIterator(g, c[0]),
                        u = [];
                      h.push(function () {
                        Module._TRN_IteratorDestroy(n);
                      });
                      for (var q = c[0]; Module.IteratorHasNext(n) && p < c[l - 1]; ++q) {
                        if (q === c[p]) {
                          var F = Module.IteratorCurrent(n),
                            e = (Module.PageGetRotation(F) + d) % 4;
                          Module.PageSetRotation(F, e);
                          u.push(q);
                          p++;
                        }
                        Module.IteratorNext(n);
                      }
                      var k = Module.postPagesUpdatedEvent(g, a, u, !0);
                ...
                a.ExtractPages = function (a, c, d, f, h, l) {
                  return new Promise(function (b, g) {
                    ...
                    try {
                      ...
                      Module.XFDFMerge(a, d, h);
                      var r = Module.CreateEmptyDoc();
                      m[m.length] = function () {
                        Module.DeleteDoc(r);
                      };
                      var u = Module.InsertPages(r, a, c, 1, !0, l)
                        .then(function () {
                          return Module.SaveDoc(r, void 0, !0, !1, void 0, f);
                        })
                        .then(function (a) {
                          m.reverse().forEach(function (a) {
                            a();
                ...
                a.CropPages = function (a, c, d, f, h, l) {
                  return new Promise(function (b, g) {
                    ...
                    try {
                      ...
                      var r = c.length,
                        u = 0,
                        q = Module.PDFDocGetPageIterator(m, c[0]);
                      n.push(function () {
                        Module._TRN_IteratorDestroy(q);
                      });
                      for (var e = [], k = c[0]; Module.IteratorHasNext(q) && u < c[r - 1]; ++k) {
                        if (k === c[u]) {
                          var t = Module.IteratorCurrent(q),
                            w = Module.allocate(8, 'i8', Module.ALLOC_STACK);
                          REX(Module._TRN_PageGetCropBox(t, w));
                          var D = Module.PageGetRotation(t),
                            A = Module.getValue(w, 'double'),
                            v = Module.getValue(w + 8, 'double'),
                            L = Module.getValue(w + 16, 'double'),
                            P = Module.getValue(w + 24, 'double');
                          0 === D % 4
                            ? (Module.setValue(w, A + h, 'double'),
                              Module.setValue(w + 8, v + f, 'double'),
                              Module.setValue(w + 16, L - l, 'double'),
                              Module.setValue(w + 24, P - d, 'double'))
                            : 1 === D % 4
                            ? (Module.setValue(w, A + d, 'double'),
                              Module.setValue(w + 8, v + h, 'double'),
                              Module.setValue(w + 16, L - f, 'double'),
                              Module.setValue(w + 24, P - l, 'double'))
                            : 2 === D % 4
                            ? (Module.setValue(w, A + l, 'double'),
                              Module.setValue(w + 8, v + d, 'double'),
                              Module.setValue(w + 16, L - h, 'double'),
                              Module.setValue(w + 24, P - f, 'double'))
                            : 3 === D % 4 &&
                              (Module.setValue(w, A + f, 'double'),
                              Module.setValue(w + 8, v + l, 'double'),
                              Module.setValue(w + 16, L - d, 'double'),
                              Module.setValue(w + 24, P - h, 'double'));
                          Module.setValue(w + 32, 0, 'double');
                          REX(Module._TRN_PageSetBox(t, 0, w));
                          REX(Module._TRN_PageSetBox(t, 1, w));
                          e.push(k);
                          u++;
                        }
                        Module.IteratorNext(q);
                      }
                      var z = Module.postPagesUpdatedEvent(m, a, e, !0);
      ...
      (function (c) {
        ...
        (function (a) {
          ...
          var p = function (a, k, b, c, d) {
              ...
              return CancellablePromise(
                function (t, f) {
                  ...
                  var g = ['bytes=', k, '-', k + b - 1].join('');
                  e.setRequestHeader('Range', g);
          ...
          q.prototype = {
            ...
            insert: function (a, k) {
              this.lruList.length >= this.maxChunkNum && (delete this.chunkMap[this.lruList[0]], this.lruList.shift());
              this.lruList.push(k);
              this.chunkMap[k] = a;
            },
            get: function (a) {
          ...
          v.prototype = {
            read: function (a, k, b) {
              ...
              a = a.subarray(k, k + b);
              k = b;
              for (var e = this.filePosition % this.chunkSize, c = this.filePosition - e, d = 0; 0 < b; ) {
                if (this.chunkCache.has(c)) var t = this.chunkCache.get(c);
                else (t = new Int8Array(this.reader.readAsArrayBuffer(this.file.slice(c, c + this.chunkSize)))), this.chunkCache.insert(t, c);
                var f = t.length,
                  g = e + b;
                g <= f
                  ? (a.set(t.subarray(e, g), d), (this.filePosition += b), (b = 0))
                  : (a.set(t.subarray(e), d), (this.filePosition += f - e), (e = 0), (c = this.filePosition), (b = g - f), (d = k - b));
              }
              return k;
            },
            seek: function (a) {
          ...
          x.prototype = {
            ...
            getChunkAsync: function (a) {
              ...
              return p(this.url, a, c, this.customHeaders, this.withCredentials).then(function (k) {
                e.writeChunk(k, a);
              });
            },
            ...
            writeChunk: function (a, k, b) {
              ...
              1048576 !== c || a.buffer.byteLength !== c
                ? (d
                    ? ((e = this.lruList.shift()), (d = this.chunkMap[e]), 1048576 > d.length && (d = new Int8Array(1048576)), (this.chunkMap[e] = null))
                    : (d = e ? this.chunkMap[k] : new Int8Array(1048576)),
          ...
          y.prototype = {
            read: function (a, k, b) {
              ...
              if (this.position < this.length) {
                var d;
                for (d = 0; d < c; ) {
                  var f = this.position % 1048576;
                  var g = this.position - f;
                  var t = c - d,
                    h = a.subarray(k + d, k + d + t);
                  if (this.chunkStorage.hadChunk(g))
                    (g = this.chunkStorage.getChunk(g).subarray(f, f + t)), h.set(g), (h = g.length), (d += h), (this.position += h);
                  else for (this.position += t; d < c; ++d) h[d] = 0;
                }
              }
              if (!e) {
                k += c;
            ...
            write: function (a, k, b) {
              ...
              if (!e) {
                d = k + c;
                if ((b -= c))
                  (k = this.chunkStorage.getCacheData()),
                    b > k.length && (b = k.length),
                    (e = this.position - this.length),
                    (d = a.subarray(d, d + b)),
                    k.subarray(e, e + b).set(d);
                this.position += b;
                return c + b;
              }
              return c;
          ...
          B.prototype = {
            ...
            write: function (a, b, c) {
              for (var e = this.position + c, k = this.data.length; e > k; ) {
                k = Math.max(k * (16777216 < k ? 1.5 : 2), e);
                var d = new Int8Array(k);
          ...
          var C = {
            ...
            open: function (a) {
              ...
              this.IsSink(a)
                ? ((a.provider = new B(e)), (Module.docs[e].sink = a.provider))
                : (a.provider = Module.docs[e].sink
                    ? new r(Module.docs[e].sink.data)
                    : Module.docs[e].chunkStorage
                    ? new y(Module.docs[e].chunkStorage)
                    : Module.docs[e].buffer
                    ? new r(Module.docs[e].buffer)
                    : new v(Module.docs[e].file));
            },
            close: function (a) {
              a.provider.close();
            },
            read: function (a, b, c, d, f) {
              return a.provider.read(b, c, d);
            },
            llseek: function (a, b, c) {
              a = a.provider;
              1 === c ? (b += a.getPos()) : 2 === c && (b = a.getTotalSize() + b);
              if (0 > b) throw new FS.ErrnoError(d.ERRNO_CODES.EINVAL);
              a.seek(b);
              return b;
            },
            write: function (a, b, c, d, f) {
              return d ? a.provider.write(b, c, d) : 0;
            },
          };
          d.THROW = function (a) {
            ...
            try {
              ...
              if (c) {
                ...
                (f = Module.ImageGetImageWidth(b)),
                  (g = Module.ImageGetImageHeight(b)),
                  (c = f / g),
                  c > 612 / 792 ? ((f = 612), (g = parseInt(f / c, 10))) : ((g = 792), (f = parseInt(g * c, 10)));
              var t = Module.ElementBuilderCreateImage(k, b, 0, 0, f, g),
                h = Module.PDFDocPageCreate(a, f, g);
              Module.ElementWriterBegin(d, h);
              Module.ElementWriterWritePlacedElement(d, t);
          ...
          a.DownloaderHint = function (a, b) {
            ...
            if (b.visiblePages) {
              var c = b.visiblePages;
              for (b = 0; b < c.length; ++b) ++c[b];
              Object.keys(k.requirePageCallbacks).forEach(function (a) {
                k.requirePageCallbacks.hasOwnProperty(a) && c.push(parseInt(a, 10));
              });
              (b = Module.docs[a].chunkStorage) && b.keepVisibleChunks(k.downloader, c);
              a = c.length;
              var d = Module.allocate(4 * a, 'i8', Module.ALLOC_STACK);
              for (b = 0; b < a; ++b) Module.setValue(d + 4 * b, c[b], 'i32');
              REX(Module._TRN_PDFDocDownloadPages(e, d, a, 1, 0));
            }
          };
              ...
              var b = function (a) {
                return function (b) {
                  ...
                  b in downloadDataMap
                    ? a.apply(this, e)
                    : c(function () {
                        b in downloadDataMap && a.apply(this, e);
                      }, 0);
                };
              };
              n = {
                downloadProc: Module.addFunction(function (a, b, e, c, k) {
                  ...
                  var d = c.docId;
                  p(c.url, b, e, Module.customHeadersMap[d], Module.withCredentials[d]).then(function (c) {
                    d in Module.docs && Module.docs[d].chunkStorage && Module.docs[d].chunkStorage.writeChunk(c, b);
                    Module._TRN_DownloadComplete(0, b, e, a);
                  });
                }, 'viiiii'),
                notifyUpdatePage: Module.addFunction(
                  b(function (a, b, e, c) {
                    ...
                    if (b in k.requirePageCallbacks) for (e = k.requirePageCallbacks[b], c = 0; c < e.length; ++c) e[c]();
                    k.timeout
                      ? d.push(b)
                      : ((d = k.eventPageArray = [b]),
                        (k.timeout = setTimeout(function () {
                          Module.postPagesDownloadedEvent(a, k.m_id, d);
                          k.timeout = null;
                        }, 100)));
                  }),
                  'viiii',
          ...
          a.CreateDocDownloaderBackend = function (a, b, c) {
            var e = a.url,
              ...
              d = a.customHeaders,
              f = a.withCredentials,
              g = a.shouldUseMinimumDownloads;
            d && (Module.customHeadersMap[c] = d);
            f && (Module.withCredentials[c] = f);
            var h = a.downloadData ? new F(a.downloadData, e, c, d, f) : new F(a.size, e, c, d, f);
            var m = Module.createCallbacksStruct(h.downloadUserData),
              t = Module.allocate(4, 'i8', Module.ALLOC_STACK);
            Module.MakeDev(c);
            a.chunkStorage
              ? (e = new x(a.chunkStorage))
              : ((a = new Int8Array(new ArrayBuffer(Math.ceil((a.size + 1048576 - 1) / 1048576 / 8)))), (e = new x(e, k, d, f, a)));
            Module.docs[c] = { chunkStorage: e };
            REX(Module._TRN_DownloaderCreate(m, k, Module.GetUStringFromJSString(c), g, t));
            h.downloader = Module.getValue(t, 'i8*');
            if ((k = Module._TRN_PDFDocCreateFromFilter(h.downloader, b))) Module._TRN_FilterDestroy(h.downloader), REX(k);
            b = Module.getValue(b, 'i8*');
            Module.docs[c].ptr = b;
            Module.PDFDocInitSecurityHandler(b) && REX(Module._TRN_PDFDocDownloaderInitialize(b, h.downloader));
            downloadDataMap[b] = h;
          };
          a.CreateDocBackend = function (e, c) {
            ...
            try {
              if (k)
                if ('ptr' === g) Module.docs[c] = { ptr: k };
                else {
                  k.shouldUseMinimumDownloads = e.shouldUseMinimumDownloads;
                  var l = 'object' === f(k) && k.url;
                  g = d && 'pdf' !== d;
                  if (l) a.CreateDocDownloaderBackend(k, h, c);
                  else {
                    var n = k instanceof ArrayBuffer;
                    l = n ? 'buffer' : 'file';
                    if (n && ((k = new Uint8Array(k)), 10485760 > k.length + b && !g)) {
                      b += k.length;
                      var p = k.length,
                        r = Module._malloc(k.length);
                      Module.HEAPU8.set(k, r);
                      REX(Module._TRN_PDFDocCreateFromBuffer(r, p, h));
                      var q = Module.getValue(h, 'i8*');
                      Module.docs[c] = {
                        ptr: q,
                        bufPtr: r,
                        bufPtrSize: p,
                    ...
                    Module.docs[c] = n;
                    if (g) {
                      if (e.pageSizes && e.pageSizes.length) var v = e.pageSizes[0];
                      else e.defaultPageSize && (v = e.defaultPageSize);
                      var u = Module.GetUStringFromJSString(c);
                      REX(Module._TRN_PDFDocCreate(h));
                      q = Module.getValue(h, 'i8*');
                      var x = Module.ImageCreateFromFile(q, u);
                      Module.InsertImageIntoDoc(q, x, v);
                    } else {
                      var y = Module.allocate(Module.intArrayFromString(c), 'i8', Module.ALLOC_STACK);
                      REX(Module._TRN_PDFDocCreateFromFilePath(y, h));
                      q = Module.getValue(h, 'i8*');
                    }
                    Module.docs[c].extension = d;
                    Module.docs[c].ptr = q;
          ...
          a.ChangeDocBackend = function (a, c) {
            var e = Module.docs[a];
            e
              ? (e.bufPtr && e.ownership && (Module._free(e.bufPtr), (b -= e.bufPtrSize)), delete Module.docs[a])
              : Object(l.d)('Trying to delete document '.concat(a, ' that does not exist.'));
            Module.docs[a] = c;
          };
          a.DeleteDoc = function (a) {
            ...
            e
              ? (e.ptr &&
                  (e.ptr in downloadDataMap &&
                    (clearTimeout(downloadDataMap[e.ptr].timeout), downloadDataMap[e.ptr].destroyUserData(), delete downloadDataMap[e.ptr]),
                  Module.PDFDocDestroy(e.ptr)),
                e.bufPtr && e.ownership && (Module._free(e.bufPtr), (b -= e.bufPtrSize)),
          ...
          a.PageGetPageInfo = function (a) {
            ...
            return {
              ...
              width: Module.getValue(e, 'double'),
          ...
          a.GetUStringFromJSString = function (a, b) {
            var e = Module.allocate(4, 'i8', Module.ALLOC_STACK),
              c = 2 * (a.length + 1),
              k = Module.allocate(c, 'i8', b ? Module.ALLOC_NORMAL : Module.ALLOC_STACK);
            Module.stringToUTF16(a, k, c);
            a = Module._TRN_UStringCreateFromString(k, e);
            b && Module._free(k);
            REX(a);
          ...
          a.ExtractApRefChangeData = function (a) {
            var b = Module.getValue(a, 'i32'),
              c = Module.getValue(a + 4, 'i32'),
              e = Module.getValue(a + 8, 'i32'),
              d = Module.getValue(a + 12, 'i32');
          ...
          a.Matrix2DMultBBox = function (a, b) {
            ...
            REX(Module._TRN_Matrix2DMult(a, c, e));
          ...
          a.Matrix2DConcat = function (a, b) {
            ...
            REX(Module._TRN_Matrix2DConcat(a, c, e, d, k, f, b));
          };
          ...
          a.PDFDocSetSecurityHandler = function (a, b) {
            REX(Module._TRN_PDFDocSetSecurityHandler(a, b));
          };
          a.SecurityHandlerCreate = function (a) {
            var b = Module.allocate(4, 'i8', Module.ALLOC_STACK);
            REX(Module._TRN_SecurityHandlerCreate(a, b));
            return Module.getValue(b, 'i8*');
          };
          a.SecurityHandlerChangeUserPasswordUString = function (a, b) {
          ...
          a.PDFDocDownloaderTriggerFullDownload = function (a, b) {
          ...
          a.PDFDocInsertPages2 = function (a, b, c, d, f) {
            REX(Module._TRN_PDFDocInsertPageSet2(a, b, c, d, f ? 1 : 0, 0));
          };
          ...
          a.PDFDocPageRemove2 = function (a, b) {
          ...
          a.PDFDocFDFUpdate = function (a, b, c) {
            if (c) {
              for (var d = Object.keys(c), e = d.length, f = Module._malloc(8 * e), g = 0; g < e; ++g) {
                ...
                Module.setValue(f + h, m, 'i8*');
                Module.setValue(f + h + 4, k, 'i8*');
              }
              c = Module.allocate(8, 'i8', Module.ALLOC_STACK);
              REX(Module._TRN_PDFDocFDFUpdateAppearanceDocs(a, b, f, e, c));
              a = Module.getValue(c, 'i8*');
              b = Module.VectorGetSize(a);
              e = Array(b);
              for (f = 0; f < b; ++f) (c = Module.VectorGetAt(a, f)), (e[f] = Module.ExtractApRefChangeData(c));
              Module.VectorDestroy(a);
              if (b) return e;
            ...
            var d = function y(a) {
              ...
              l = function (c, f) {
                return new Promise(function (g, h) {
                  c = d(c);
                  var m = c.docId;
                  m = m ? Module.GetDoc(m) : 0;
                  (m = Module.EMSCallSharedFunction(b, f, m))
                    ? h({
                        type: 'PDFWorkerError',
                        message: Module.GetErrToString(m),
                      })
                    : ((h = Module.EMSGetLastResponse(b)), (h = a(h)), g(h));
                });
              };
            (g = Module._TRN_EMSFunctionIteratorGetNextCommandName(m));

          )
            (g = Module.GetJSStringFromCString(g)), c.queue.onAsync(g, l);
          ...
          if (Module._TRN_EMSCreatePDFNetWorkerInstance) {
            ...
            m('ExtractPDFNetLayersContext', function (a) {
              ...
              b
                ...
                : Module.PDFDocHasOC(a) && ((b = Module.PDFDocGetOCGConfig(a)), (c = Module.OCGContextCreate(b)));
              return c.toString(16);
            });
            var v = Module._TRN_EMSCreatePDFNetWorkerInstance();
            m = Module._TRN_EMSWorkerInstanceGetFunctionIterator(v);
            for (
              l = function (b) {
                return new Promise(function (c, f) {
                  b = d(b);
                  var g = Module.EMSCallPDFNetFunction(v, b);
                  g ? f(Module.GetErrToString(g)) : ((f = Module.EMSGetLastResponse(v)), (f = a(f)), c(f));
                });
              };
              (g = Module._TRN_EMSFunctionIteratorGetNextCommandName(m));

            )
              if (((g = Module.GetJSStringFromCString(g)), !n[g])) h.onAsync(g, l);
            Module._TRN_EMSFunctionIteratorDestroy(m);
          }
        };
      })(self);
    ...
    function (c, l, h) {
      ...
      (function (c) {
        ...
        c.basePath = '../';
        var l = function () {
          var f = c.pdfWorkerPath || '';
          c.workerBasePath && (c.basePath = c.workerBasePath);
          var h = c.isFull,
            l = h ? 'full/' : 'lean/';
          c.useOptimizedWorker && (l += g.a);
          var m = c.wasmDisabled,
            n = c.disableObjectURLBlobs;
          Object(b.c)();
          c.overriddenPdfWorkerPath && ((f = c.overriddenPdfWorkerPath), (c.basePath = '../'), !Object(d.a)() || m) && (f = '');
          c.basePath = c.externalPath ? c.externalPath : c.basePath + 'external/';
          Object(a.a)(
            ''.concat(f + l, 'PDFNetC'),
            {
              'Wasm.wasm': h ? 1e7 : 4e6,
          ...
          OnInitialized: function (a) {
            Module.loaded
              ...
              : ((Module.initCb = function () {
                ...
                Object(b.b)('worker', 'PDFNet is not initialized yet!'));
          },
          NewDoc: function (a, b) {
        ...
        var m = {
          setup: function (a) {
            function d(a) {
              var d = a.data,
                e = a.action;
              var f = 'GetCanvas' === e || 'GetCanvasPartial' === e ? p.shouldRunRender(d) : !0;
              if (f) {
                h = a;
                var g = a.asyncCallCapability;
                Object(b.b)('Memory', 'Worker running command: '.concat(e));
                q.actionMap[e](d, a).then(
                  function (a) {
              ...
              } else c.deferredQueue.queue(a), m();
            }
            function g(a) {
              a.asyncCallCapability = createPromiseCapability();
              h || q.length ? q.queue(a) : d(a);
              return a.asyncCallCapability.promise;
            }
            function l(b) {
              self.shouldResize && p.Initialize(b.options.workerHeapSize, b.options.pdfResourcePath, b.options.pdfAsmPath, b.options.parentUrl);
              Module.chunkMax = b.options.chunkMax;
              if (b.array instanceof Uint8Array) {
                var d = 255 === b.array[0];
                a.postMessageTransfers = d;
                'response' in new XMLHttpRequest()
                  ? p.OnInitialized(function () {
                      c.SetupPDFNetFunctions(a);
                      k();
                      a.send('test', {
                        supportTypedArray: !0,
                        supportTransfers: d,
            ...
            function m() {
              n.a.setImmediate(function () {
                if ((!h || 'BeginOperation' !== h.action) && q.length && !h) {
                  var a = q.dequeue();
                  d(a);
                }
              });
            ...
            var p = new c.EmscriptenPDFManager(),
              ...
              u = !1,
              e = !1;
            Module.workerMessageHandler = a;
            var k = function () {
              u ? e || (a.send('workerLoaded', {}), (e = !0)) : (u = !0);
            };
            p.OnInitialized(k);
            (function () {
              c.queue = q = new f.a({
            ...
            q.onAsync('GetCanvas', function (a) {
              Object(b.b)('workerdetails', 'Run GetCanvas PageIdx: '.concat(a.pageIndex, ' Width: ').concat(a.width));
              Object(b.b)('Memory', 'loadCanvas with potential memory usage '.concat(a.width * a.height * 8));
              return Module.loadCanvas(a.docId, a.pageIndex, a.width, a.height, a.rotation, null, a.layers, a.renderOptions);
            });
            q.onAsync('GetCanvasPartial', function (a) {
              Object(b.b)('Memory', 'GetCanvasPartial with potential memory usage '.concat(a.width * a.height * 8));
              return Module.loadCanvas(a.docId, a.pageIndex, a.width, a.height, a.rotation, a.bbox, a.layers, a.renderOptions);
            });
            q.onAsync('SaveDoc', function (a) {
              return Module.SaveDoc(
                ...
                a.apdocs,
                a.password,
                a.encryptionAlgorithmType,
              );
            });
            q.onAsync('SaveDocFromFixedElements', function (a) {
              return Module.SaveDocFromFixedElements(a.bytes, a.xfdfString, a.flags, a.watermarks, a.password, a.encryptionAlgorithmType);
            });
            q.onAsync('MergeXFDF', function (a) {
              return Module.MergeXFDF(a.docId, a.xfdf, a.apdocs);
            });
            q.onAsync('InsertPages', function (a) {
              return Module.InsertPages(a.docId, a.doc, a.pageArray, a.destPos, a.insertBookmarks, a.skipUpdateEvent);
            });
            ...
            q.onAsync('ExtractPages', function (a) {
              return Module.ExtractPages(a.docId, a.pageArray, a.xfdfString, a.watermarks, a.apdocs, a.skipUpdateEvent);
            });
            ...
            q.onAsync('TriggerFullDownload', function (a) {
              return Module.TriggerFullDownload(a.docId);
            });
            ...
            a.on('FinishOperation', function () {
              if (h && 'BeginOperation' === h.action) (h = null), m();
              else throw { message: 'Operation has not started.' };
            });
            a.on('DeleteDocument', function (a) {
              a = a.docId;
              v(a);
              Module.DeleteDoc(a);
            });
            a.on('GetCanvasProgressive', function (a) {
              if (h && h.callbackId === a.callbackId) {
                Object(b.b)('worker', 'Progressive request in progress');
                var d = Module.GetCurrentCanvasData(!0);
              } else {
                if (q.find({ priority: 0, callbackId: a.callbackId }))
                  throw (
                    (Object(b.b)('worker', 'Progressive request Queued'),
                    {
                      type: 'Queued',
                ...
                if (
                  c.deferredQueue.find({
                    priority: 0,
                    callbackId: a.callbackId,
                  })
                )
                  throw (
                    (Object(b.b)('worker', 'Progressive request Deferred'),
                    {
                      type: 'Queued',
                      message: 'Rendering has not started yet.',
                    })
              ...
              if (!d)
                throw (
                  (Object(b.b)('worker', 'Progressive request invalid (render already complete)'),
                  {
                    type: 'Unavailable',
            ...
            a.on('actionCancel', function (a) {
              h && h.callbackId === a.callbackId
                ? (Object(b.b)('workerdetails', 'Cancelled Current Operation'), Module.cancelCurrent() && ((h = null), m()))
                : (Object(b.b)('workerdetails', 'Cancelled queued operation'),
                  q.remove({ priority: 0, callbackId: a.callbackId }),
        ...
        c.onmessage = function (a) {
          if ('init' === a.data.action) {
            var d = a.data.shouldResize;
            c.shouldResize = d;
            c.isFull = a.data.isFull;
            c.wasmDisabled = !a.data.wasm;
            c.externalPath = a.data.externalPath;
            c.useOptimizedWorker = a.data.useOptimizedWorker;
            c.disableObjectURLBlobs = a.data.disableObjectURLBlobs;
            if ((a = a.data.pdfWorkerPath)) c.overriddenPdfWorkerPath = a;
            d || l();
            d = new q.a('worker_processor', self);
            Object(b.a)(d);
            m.setup(d);
          }
        };
