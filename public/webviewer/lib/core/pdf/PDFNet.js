(function () {
  ...
  $jscomp.polyfill(
    ...
    function (NativePromise) {
      ...
      PolyfillPromise.prototype.resolveTo_ = function (value) {
        if (value === this) this.reject_(new TypeError('A Promise cannot resolve to itself'));
        else if (value instanceof PolyfillPromise) this.settleSameAsPromise_(value);
        else {
  ...
  $jscomp.checkStringArgs = function (thisArg, arg, func) {
    if (null == thisArg) throw new TypeError("The 'this' value for String.prototype." + func + ' must not be null or undefined');
    if (arg instanceof RegExp) throw new TypeError('First argument to String.prototype.' + func + ' must not be a regular expression');
    return thisArg + '';
  };
  $jscomp.polyfill(
    ...
    function (orig) {
      return orig
        ...
        : function (searchString, opt_position) {
            ...
            for (var j = 0; j < searchLen && opt_position < strLen; ) if (string[opt_position++] != searchString[j++]) return !1;
            return j >= searchLen;
          };
    },
    'es6',
    ...
    function (orig) {
      return orig
        ...
        : function (arrayLike, opt_mapFn, opt_thisArg) {
            ...
            } else for (iteratorFunction = arrayLike.length, k = 0; k < iteratorFunction; k++) result.push(opt_mapFn.call(opt_thisArg, arrayLike[k], k));
            return result;
          };
    },
    'es6',
      ...
      (function (exports) {
        function optionsHelpers() {
          return {
            putBool: function (implObj, key, value) {
              if (!1 !== value && !0 !== value) throw new TypeError('An boolean value is expected for putBool');
              implObj[key] = value;
            },
        ...
        exports.isArrayBuffer = function (obj) {
          return (
            ...
            (null != obj && null != obj.constructor && 'ArrayBuffer' === obj.constructor.name && 'number' === typeof obj.byteLength)
          );
        };
        ...
        PDFNet.ByteRange = function (m_offset, m_size) {
          this.name = 'ByteRange';
          if (m_offset && 'undefined' === typeof m_size) copyFunc(m_offset, this);
          else
            return (
        ...
        PDFNet.ContentItem = function (o, p) {
          ...
          else return 'undefined' === typeof o && (o = '0'), 'undefined' === typeof p && (p = '0'), new PDFNet.ContentItem({ o: o, p: p });
        };
        ...
        PDFNet.DigitalSignatureField = function (mp_field_dict_obj) {
          ...
          if ('object' === _typeof(mp_field_dict_obj)) copyFunc(mp_field_dict_obj, this);
        ...
        PDFNet.FDFField = function (mp_leaf_node, mp_root_array) {
          this.name = 'FDFField';
          if (mp_leaf_node && 'undefined' === typeof mp_root_array) copyFunc(mp_leaf_node, this);
          else
            return (
        ...
        PDFNet.Field = function (leaf_node, builder) {
          this.name = 'Field';
          if (leaf_node && 'undefined' === typeof builder) copyFunc(leaf_node, this);
          else
            return (
        ...
        PDFNet.PageLabel = function (mp_obj, m_first_page, m_last_page) {
          this.name = 'PageLabel';
          if (mp_obj && 'undefined' === typeof m_first_page) copyFunc(mp_obj, this);
          else
            return (
              'undefined' === typeof mp_obj && (mp_obj = '0'),
        ...
        PDFNet.SElement = function (obj, k) {
          ...
          else return 'undefined' === typeof obj && (obj = '0'), 'undefined' === typeof k && (k = '0'), new PDFNet.SElement({ obj: obj, k: k });
        };
        ...
        PDFNet.TextExtractorStyle = function (mp_imp) {
          ...
          else if ('undefined' !== typeof mp_imp) return new PDFNet.TextExtractorStyle({ mp_imp: mp_imp });
        };
        ...
        PDFNet.PDFDoc.TextDiffOptions.prototype.addZonesForPage = function (zones, regions, page_num) {
          ...
          if (this.mImpl[zones].length < page_num) for (var i = this.mImpl[zones].length; i < page_num; i++) this.mImpl[zones].push([]);
        ...
        PDFNet.Point = function (x, y) {
          ...
          else return 'undefined' === typeof x && (x = 0), 'undefined' === typeof y && (y = 0), new PDFNet.Point({ x: x, y: y });
        };
        PDFNet.CharData = function (charData) {
          if ('undefined' === typeof charData) throw new TypeError('CharData requires an object to construct with.');
          this.name = 'CharData';
          copyFunc(charData, this);
        };
        PDFNet.Separation = function (separation) {
          if ('undefined' === typeof separation) throw new TypeError('Separation requires an object to construct with.');
        ...
        PDFNet.Matrix2D.prototype.copy = function () {
          ...
          return PDFNet.sendWithPromise('Matrix2D.copy', { m: this }).then(function (id) {
        ...
        PDFNet.Matrix2D.prototype.preTranslate = function (h, v) {
          checkArguments(arguments.length, 2, 'preTranslate', '(number, number)', [
            [h, 'number'],
            [v, 'number'],
          ]);
        ...
        PDFNet.Matrix2D.prototype.postTranslate = function (h, v) {
          checkArguments(arguments.length, 2, 'postTranslate', '(number, number)', [
            [h, 'number'],
            [v, 'number'],
          ]);
        ...
        PDFNet.Field.prototype.getValue = function () {
          ...
          return PDFNet.sendWithPromise('Field.getValue', { field: this }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id);
          });
        };
        ...
        PDFNet.FDFDoc.prototype.getFDF = function () {
          return PDFNet.sendWithPromise('FDFDoc.getFDF', { doc: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id);
          });
        };
        ...
        PDFNet.FDFDoc.prototype.getID = function () {
          return PDFNet.sendWithPromise('FDFDoc.getID', { doc: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id);
          });
        };
        ...
        PDFNet.FDFDoc.prototype.fieldCreate = function (field_name, type, field_value) {
          ...
          checkArguments(arguments.length, 2, 'fieldCreate', '(string, number, PDFNet.Obj)', [
            [field_name, 'string'],
            [type, 'number'],
        ...
        PDFNet.FDFDoc.prototype.fieldCreateFromString = function (field_name, type, field_value) {
          checkArguments(arguments.length, 3, 'fieldCreateFromString', '(string, number, string)', [
            [field_name, 'string'],
            [type, 'number'],
            [field_value, 'string'],
          ]);
        ...
        PDFNet.FDFDoc.prototype.saveAsXFDFWithOptions = function (filepath, opts) {
          ...
          checkArguments(arguments.length, 1, 'saveAsXFDFWithOptions', '(string, PDFNet.OptionBase)', [
            [filepath, 'string'],
            [opts, 'OptionBase'],
          ]);
        ...
        PDFNet.FDFDoc.prototype.saveAsXFDFAsStringWithOptions = function (opts) {
          ...
          opts = opts ? opts.getJsonString() : '{}';
          return PDFNet.sendWithPromise('FDFDoc.saveAsXFDFAsStringWithOptions', { doc: this.id, opts: opts });
        };
        PDFNet.FDFDoc.prototype.mergeAnnots = function (command_file, permitted_user) {
          'undefined' === typeof permitted_user && (permitted_user = '');
          checkArguments(arguments.length, 1, 'mergeAnnots', '(string, string)', [
            [command_file, 'string'],
        ...
        PDFNet.FDFField.create = function (field_dict, fdf_dict) {
          ...
          checkArguments(arguments.length, 0, 'create', '(PDFNet.Obj, PDFNet.Obj)', [
        ...
        PDFNet.Filter.prototype.createASCII85Encode = function (line_width, buf_sz) {
          checkArguments(arguments.length, 2, 'createASCII85Encode', '(number, number)', [
            [line_width, 'number'],
            [buf_sz, 'number'],
          ]);
        ...
        PDFNet.Filter.createMemoryFilter = function (buf_sz, is_input) {
          checkArguments(arguments.length, 2, 'createMemoryFilter', '(number, boolean)', [
            [buf_sz, 'number'],
            [is_input, 'boolean'],
          ]);
        ...
        PDFNet.Filter.createImage2RGBAFromElement = function (elem, premultiply) {
          checkArguments(arguments.length, 2, 'createImage2RGBAFromElement', '(PDFNet.Element, boolean)', [
        ...
        PDFNet.Filter.createImage2RGBAFromObj = function (obj, premultiply) {
          checkArguments(arguments.length, 2, 'createImage2RGBAFromObj', '(PDFNet.Obj, boolean)', [
        ...
        PDFNet.Filter.createImage2RGBA = function (img, premultiply) {
          checkArguments(arguments.length, 2, 'createImage2RGBA', '(PDFNet.Image, boolean)', [
        ...
        PDFNet.OCG.create = function (pdfdoc, name) {
          checkArguments(arguments.length, 2, 'create', '(PDFNet.PDFDoc, string)', [
            [pdfdoc, 'PDFDoc'],
            [name, 'string'],
          ]);
        ...
        PDFNet.OCG.prototype.copy = function () {
          return PDFNet.sendWithPromise('OCG.copy', { ocg: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.OCG, id);
          });
        };
        PDFNet.OCG.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise('OCG.getSDFObj', { ocg: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id);
          });
        };
        ...
        PDFNet.OCG.prototype.getIntent = function () {
          return PDFNet.sendWithPromise('OCG.getIntent', { c: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id);
          });
        };
        ...
        PDFNet.OCG.prototype.setCurrentState = function (ctx, state) {
          checkArguments(arguments.length, 2, 'setCurrentState', '(PDFNet.OCGContext, boolean)', [
        ...
        PDFNet.OCG.prototype.setInitialState = function (cfg, state) {
          checkArguments(arguments.length, 2, 'setInitialState', '(PDFNet.OCGConfig, boolean)', [
        ...
        PDFNet.OCG.prototype.setLocked = function (cfg, state) {
          checkArguments(arguments.length, 2, 'setLocked', '(PDFNet.OCGConfig, boolean)', [
            [cfg, 'Object', PDFNet.OCGConfig, 'OCGConfig'],
            [state, 'boolean'],
          ]);
        ...
        PDFNet.OCGConfig.create = function (pdfdoc, default_config) {
          checkArguments(arguments.length, 2, 'create', '(PDFNet.PDFDoc, boolean)', [
            [pdfdoc, 'PDFDoc'],
        ...
        PDFNet.OCGConfig.prototype.copy = function () {
          return PDFNet.sendWithPromise('OCGConfig.copy', { c: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.OCGConfig, id);
          });
        };
        ...
        PDFNet.OCGContext.prototype.copy = function () {
          return PDFNet.sendWithPromise('OCGContext.copy', { c: this.id }).then(function (id) {
            return createDestroyableObj(PDFNet.OCGContext, id);
          });
        };
        ...
        PDFNet.OCGContext.prototype.setState = function (grp, state) {
          checkArguments(arguments.length, 2, 'setState', '(PDFNet.OCG, boolean)', [
        ...
        PDFNet.OCMD.create = function (pdfdoc, ocgs, vis_policy) {
          checkArguments(arguments.length, 3, 'create', '(PDFNet.PDFDoc, PDFNet.Obj, number)', [
            [pdfdoc, 'PDFDoc'],
        ...
        PDFNet.OCMD.prototype.copy = function () {
          return PDFNet.sendWithPromise('OCMD.copy', { ocmd: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.OCMD, id);
          });
        };
        ...
        PDFNet.OCMD.prototype.getOCGs = function () {
          return PDFNet.sendWithPromise('OCMD.getOCGs', { ocmd: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id);
          });
        };
        ...
        PDFNet.PDFACompliance.getDeclaredConformance = function (doc) {
          ...
          return PDFNet.sendWithPromise('pdfaComplianceGetDeclaredConformance', { doc: doc.id });
        };
        ...
        PDFNet.AttrObj.prototype.copy = function () {
          return PDFNet.sendWithPromise('AttrObj.copy', { a: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.AttrObj, id);
          });
        };
        ...
        PDFNet.ClassMap.prototype.copy = function () {
          return PDFNet.sendWithPromise('ClassMap.copy', { p: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.ClassMap, id);
          });
        };
        ...
        PDFNet.ContentItem.prototype.copy = function () {
          checkThisYieldFunction('copy', this.yieldFunction);
          return PDFNet.sendWithPromise('ContentItem.copy', { c: this }).then(function (id) {
        ...
        PDFNet.RoleMap.prototype.copy = function () {
          return PDFNet.sendWithPromise('RoleMap.copy', { p: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.RoleMap, id);
          });
        };
        ...
        PDFNet.SElement.createFromPDFDoc = function (doc, struct_type) {
          checkArguments(arguments.length, 2, 'createFromPDFDoc', '(PDFNet.PDFDoc, string)', [
            [doc, 'PDFDoc'],
            [struct_type, 'string'],
          ]);
        ...
        PDFNet.SElement.prototype.insert = function (kid, insert_before) {
          checkArguments(arguments.length, 2, 'insert', '(PDFNet.SElement, number)', [
        ...
        PDFNet.SElement.prototype.createContentItem = function (doc, page, insert_before) {
          ...
          checkArguments(arguments.length, 2, 'createContentItem', '(PDFNet.PDFDoc, PDFNet.Page, number)', [
            [doc, 'PDFDoc'],
        ...
        PDFNet.SElement.prototype.getParent = function () {
          checkThisYieldFunction('getParent', this.yieldFunction);
          return PDFNet.sendWithPromise('SElement.getParent', { e: this }).then(function (id) {
            return new PDFNet.SElement(id);
          });
        };
        ...
        PDFNet.SElement.prototype.getID = function () {
          ...
          return PDFNet.sendWithPromise('SElement.getID', { e: this }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id);
          });
        };
        ...
        PDFNet.SElement.prototype.getSDFObj = function () {
          checkThisYieldFunction('getSDFObj', this.yieldFunction);
          return PDFNet.sendWithPromise('SElement.getSDFObj', { e: this }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id);
          });
        };
        ...
        PDFNet.STree.prototype.copy = function () {
          return PDFNet.sendWithPromise('STree.copy', { c: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.STree, id);
          });
        };
        ...
        PDFNet.Action.createGotoWithKey = function (key, dest) {
          checkArguments(arguments.length, 2, 'createGotoWithKey', '(string, PDFNet.Destination)', [
            [key, 'string'],
        ...
        PDFNet.Action.createGotoRemote = function (file, page_num) {
          checkArguments(arguments.length, 2, 'createGotoRemote', '(PDFNet.FileSpec, number)', [
        ...
        PDFNet.Action.createURI = function (sdfdoc, uri) {
          checkArguments(arguments.length, 2, 'createURI', '(PDFNet.SDFDoc, string)', [
            [sdfdoc, 'SDFDoc'],
            [uri, 'string'],
          ]);
        ...
        PDFNet.Action.createURIWithUString = function (sdfdoc, uri) {
          checkArguments(arguments.length, 2, 'createURIWithUString', '(PDFNet.SDFDoc, string)', [
            [sdfdoc, 'SDFDoc'],
            [uri, 'string'],
          ]);
        ...
        PDFNet.Action.createLaunch = function (sdfdoc, path) {
          checkArguments(arguments.length, 2, 'createLaunch', '(PDFNet.SDFDoc, string)', [
            [sdfdoc, 'SDFDoc'],
            [path, 'string'],
          ]);
        ...
        PDFNet.Action.createHideField = function (sdfdoc, field_names_list) {
          checkArguments(arguments.length, 2, 'createHideField', '(PDFNet.SDFDoc, Array<string>)', [
            [sdfdoc, 'SDFDoc'],
        ...
        PDFNet.Action.createImportData = function (sdfdoc, path) {
          checkArguments(arguments.length, 2, 'createImportData', '(PDFNet.SDFDoc, string)', [
            [sdfdoc, 'SDFDoc'],
            [path, 'string'],
          ]);
        ...
        PDFNet.Action.createJavaScript = function (sdfdoc, script) {
          checkArguments(arguments.length, 2, 'createJavaScript', '(PDFNet.SDFDoc, string)', [
            [sdfdoc, 'SDFDoc'],
            [script, 'string'],
          ]);
        ...
        PDFNet.Action.prototype.setFormActionFlag = function (flag, value) {
          checkArguments(arguments.length, 2, 'setFormActionFlag', '(number, boolean)', [
            [flag, 'number'],
            [value, 'boolean'],
          ]);
        ...
        PDFNet.Action.prototype.executeKeyStrokeAction = function (data) {
          checkArguments(arguments.length, 1, 'executeKeyStrokeAction', '(PDFNet.KeyStrokeEventData)', [
        ...
        PDFNet.KeyStrokeEventData.create = function (field_name, current, change, selection_start, selection_end) {
          checkArguments(arguments.length, 5, 'create', '(string, string, string, number, number)', [
            [field_name, 'string'],
            [current, 'string'],
            [change, 'string'],
        ...
        PDFNet.Page.prototype.copy = function () {
          return PDFNet.sendWithPromise('Page.copy', { p: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Page, id);
          });
        };
        ...
        PDFNet.Page.prototype.setBox = function (type, box) {
          checkArguments(arguments.length, 2, 'setBox', '(number, PDFNet.Rect)', [
            [type, 'number'],
        ...
        PDFNet.Page.addRotations = function (r0, r1) {
          checkArguments(arguments.length, 2, 'addRotations', '(number, number)', [
            [r0, 'number'],
            [r1, 'number'],
          ]);
        ...
        PDFNet.Page.subtractRotations = function (r0, r1) {
          checkArguments(arguments.length, 2, 'subtractRotations', '(number, number)', [
            [r0, 'number'],
            [r1, 'number'],
          ]);
        ...
        PDFNet.Page.prototype.getDefaultMatrix = function (flip_y, box_type, angle) {
          ...
          checkArguments(arguments.length, 0, 'getDefaultMatrix', '(boolean, number, number)', [
            [flip_y, 'boolean'],
            [box_type, 'number'],
            [angle, 'number'],
          ]);
        ...
        PDFNet.Page.prototype.annotInsert = function (pos, annot) {
          checkArguments(arguments.length, 2, 'annotInsert', '(number, PDFNet.Annot)', [
            [pos, 'number'],
        ...
        PDFNet.Annot.create = function (doc, type, pos) {
          checkArguments(arguments.length, 3, 'create', '(PDFNet.SDFDoc, number, PDFNet.Rect)', [
            [doc, 'SDFDoc'],
            [type, 'number'],
        ...
        PDFNet.Annot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise('annotCreateFromObj', { d: d.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Annot, id);
          });
        };
        PDFNet.Annot.prototype.copy = function () {
          return PDFNet.sendWithPromise('Annot.copy', { d: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Annot, id);
          });
        };
        ...
        PDFNet.Annot.prototype.setCustomData = function (key, value) {
          checkArguments(arguments.length, 2, 'setCustomData', '(string, string)', [
            [key, 'string'],
            [value, 'string'],
          ]);
        ...
        PDFNet.AnnotBorderStyle.create = function (s, b_width, b_hr, b_vr) {
          ...
          checkArguments(arguments.length, 2, 'create', '(number, number, number, number)', [
            [s, 'number'],
            [b_width, 'number'],
            [b_hr, 'number'],
            [b_vr, 'number'],
        ...
        PDFNet.AnnotBorderStyle.createWithDashPattern = function (s, b_width, b_hr, b_vr, b_dash) {
          checkArguments(arguments.length, 5, 'createWithDashPattern', '(number, number, number, number, Array<number>)', [
            [s, 'number'],
            [b_width, 'number'],
            [b_hr, 'number'],
            [b_vr, 'number'],
        ...
        PDFNet.Annot.prototype.getAppearance = function (annot_state, app_state) {
          ...
          checkArguments(arguments.length, 0, 'getAppearance', '(number, string)', [
            [annot_state, 'number'],
        ...
        PDFNet.Annot.prototype.setAppearance = function (app_stream, annot_state, app_state) {
          'undefined' === typeof annot_state && (annot_state = PDFNet.Annot.State.e_normal);
          'undefined' === typeof app_state && (app_state = null);
          checkArguments(arguments.length, 1, 'setAppearance', '(PDFNet.Obj, number, string)', [
        ...
        PDFNet.Annot.prototype.removeAppearance = function (annot_state, app_state) {
          'undefined' === typeof annot_state && (annot_state = PDFNet.Annot.State.e_normal);
          'undefined' === typeof app_state && (app_state = null);
          checkArguments(arguments.length, 0, 'removeAppearance', '(number, string)', [
            [annot_state, 'number'],
            [app_state, 'const char* = 0'],
          ]);
        ...
        PDFNet.Annot.prototype.setColor = function (col, numcomp) {
          ...
          checkArguments(arguments.length, 1, 'setColor', '(PDFNet.ColorPt, number)', [
        ...
        PDFNet.Annot.prototype.refreshAppearanceRefreshOptions = function (options) {
          ...
          return PDFNet.sendWithPromise('Annot.refreshAppearanceRefreshOptions', { annot: this.id, options: options });
        };
        ...
        PDFNet.Annot.prototype.setBorderStyle = function (bs, oldStyleOnly) {
          ...
          checkArguments(arguments.length, 1, 'setBorderStyle', '(PDFNet.AnnotBorderStyle, boolean)', [
        ...
        PDFNet.Annot.getBorderStyleStyle = function (bs) {
          checkArguments(arguments.length, 1, 'getBorderStyleStyle', '(PDFNet.AnnotBorderStyle)', [
            [bs, 'Object', PDFNet.AnnotBorderStyle, 'AnnotBorderStyle'],
          ]);
        ...
        PDFNet.Annot.setBorderStyleStyle = function (bs, bst) {
          checkArguments(arguments.length, 2, 'setBorderStyleStyle', '(PDFNet.AnnotBorderStyle, number)', [
            [bs, 'Object', PDFNet.AnnotBorderStyle, 'AnnotBorderStyle'],
            [bst, 'number'],
          ]);
        ...
        PDFNet.CaretAnnot.create = function (doc, pos) {
          checkArguments(arguments.length, 2, 'create', '(PDFNet.SDFDoc, PDFNet.Rect)', [
            [doc, 'SDFDoc'],
            [pos, 'Structure', PDFNet.Rect, 'Rect'],
          ]);
        ...
        PDFNet.LineAnnot.prototype.getLeaderLineExtensionLength = function () {
          return PDFNet.sendWithPromise('LineAnnot.getLeaderLineExtensionLength', { line: this.id });
        };
        PDFNet.LineAnnot.prototype.setLeaderLineExtensionLength = function (length) {
          ...
          return PDFNet.sendWithPromise('LineAnnot.setLeaderLineExtensionLength', { line: this.id, length: length });
        };
        ...
        PDFNet.CircleAnnot.prototype.setInteriorColor = function (col, numcomp) {
          checkArguments(arguments.length, 2, 'setInteriorColor', '(PDFNet.ColorPt, number)', [
            [col, 'Object', PDFNet.ColorPt, 'ColorPt'],
            [numcomp, 'number'],
          ]);
        ...
        PDFNet.FileAttachmentAnnot.createWithFileSpec = function (doc, pos, fs, icon_name) {
          ...
          return PDFNet.sendWithPromise('fileAttachmentAnnotCreateWithFileSpec', { doc: doc.id, pos: pos, fs: fs.id, icon_name: icon_name }).then(
            function (id) {
              return createPDFNetObj(PDFNet.FileAttachmentAnnot, id);
            },
          );
        ...
        PDFNet.FileAttachmentAnnot.createDefault = function (doc, pos, path) {
          checkArguments(arguments.length, 3, 'createDefault', '(PDFNet.SDFDoc, PDFNet.Rect, string)', [
            [doc, 'SDFDoc'],
            [pos, 'Structure', PDFNet.Rect, 'Rect'],
            [path, 'string'],
          ]);
        ...
        PDFNet.FreeTextAnnot.prototype.setCalloutLinePoints = function (p1, p2, p3) {
          checkArguments(arguments.length, 3, 'setCalloutLinePoints', '(PDFNet.Point, PDFNet.Point, PDFNet.Point)', [
        ...
        PDFNet.FreeTextAnnot.prototype.setCalloutLinePointsTwo = function (p1, p2) {
          checkArguments(arguments.length, 2, 'setCalloutLinePointsTwo', '(PDFNet.Point, PDFNet.Point)', [
            [p1, 'Structure', PDFNet.Point, 'Point'],
            [p2, 'Structure', PDFNet.Point, 'Point'],
          ]);
          ...
          return PDFNet.sendWithPromise('FreeTextAnnot.setCalloutLinePointsTwo', { ft: this.id, p1: p1, p2: p2 });
        };
        ...
        PDFNet.FreeTextAnnot.prototype.setTextColor = function (color, col_comp) {
          checkArguments(arguments.length, 2, 'setTextColor', '(PDFNet.ColorPt, number)', [
        ...
        PDFNet.FreeTextAnnot.prototype.setLineColor = function (color, col_comp) {
          checkArguments(arguments.length, 2, 'setLineColor', '(PDFNet.ColorPt, number)', [
            [color, 'Object', PDFNet.ColorPt, 'ColorPt'],
            [col_comp, 'number'],
          ]);
        ...
        PDFNet.InkAnnot.prototype.erase = function (pt1, pt2, width) {
          checkArguments(arguments.length, 3, 'erase', '(PDFNet.Point, PDFNet.Point, number)', [
        ...
        PDFNet.LinkAnnot.prototype.setQuadPoint = function (idx, qp) {
          checkArguments(arguments.length, 2, 'setQuadPoint', '(number, PDFNet.QuadPoint)', [
            [idx, 'number'],
        ...
        PDFNet.MarkupAnnot.prototype.getBorderEffectIntensity = function () {
          return PDFNet.sendWithPromise('MarkupAnnot.getBorderEffectIntensity', { markup: this.id });
        };
        PDFNet.MarkupAnnot.prototype.setBorderEffectIntensity = function (intensity) {
          ...
          return PDFNet.sendWithPromise('MarkupAnnot.setBorderEffectIntensity', { markup: this.id, intensity: intensity });
        };
        ...
        PDFNet.RedactionAnnot.prototype.getOverlayTextAppearance = function () {
          return PDFNet.sendWithPromise('RedactionAnnot.getOverlayTextAppearance', { redaction: this.id });
        };
        PDFNet.RedactionAnnot.prototype.setOverlayTextAppearance = function (app) {
          ...
          return PDFNet.sendWithPromise('RedactionAnnot.setOverlayTextAppearance', { redaction: this.id, app: app });
        };
        ...
        PDFNet.RubberStampAnnot.createCustom = function (doc, pos, form_xobject) {
          checkArguments(arguments.length, 3, 'createCustom', '(PDFNet.SDFDoc, PDFNet.Rect, PDFNet.Obj)', [
            [doc, 'SDFDoc'],
            [pos, 'Structure', PDFNet.Rect, 'Rect'],
        ...
        PDFNet.rubberStampAnnotSetOpacity = function (stamp, opacity) {
          checkArguments(arguments.length, 2, 'rubberStampAnnotSetOpacity', '(PDFNet.Annot, number)', [
        ...
        PDFNet.ScreenAnnot.prototype.setBorderColor = function (col, numcomp) {
          checkArguments(arguments.length, 2, 'setBorderColor', '(PDFNet.ColorPt, number)', [
            [col, 'Object', PDFNet.ColorPt, 'ColorPt'],
            [numcomp, 'number'],
          ]);
        ...
        PDFNet.ScreenAnnot.prototype.getBackgroundColorCompNum = function () {
          return PDFNet.sendWithPromise('ScreenAnnot.getBackgroundColorCompNum', { s: this.id });
        };
        ...
        PDFNet.ScreenAnnot.prototype.setBackgroundColor = function (col, numcomp) {
          checkArguments(arguments.length, 2, 'setBackgroundColor', '(PDFNet.ColorPt, number)', [
            [col, 'Object', PDFNet.ColorPt, 'ColorPt'],
            [numcomp, 'number'],
          ]);
        ...
        PDFNet.SoundAnnot.createWithData = function (doc, pos, stream, sample_bits, sample_freq, num_channels) {
          checkArguments(arguments.length, 6, 'createWithData', '(PDFNet.SDFDoc, PDFNet.Rect, PDFNet.Filter, number, number, number)', [
            [doc, 'SDFDoc'],
            [pos, 'Structure', PDFNet.Rect, 'Rect'],
        ...
        PDFNet.SoundAnnot.createAtPoint = function (doc, pos) {
          checkArguments(arguments.length, 2, 'createAtPoint', '(PDFNet.SDFDoc, PDFNet.Point)', [
            [doc, 'SDFDoc'],
        ...
        PDFNet.WidgetAnnot.create = function (doc, pos, field) {
          checkArguments(arguments.length, 3, 'create', '(PDFNet.SDFDoc, PDFNet.Rect, PDFNet.Field)', [
            [doc, 'SDFDoc'],
            [pos, 'Structure', PDFNet.Rect, 'Rect'],
        ...
        PDFNet.WidgetAnnot.prototype.getBackgroundColorCompNum = function () {
          return PDFNet.sendWithPromise('WidgetAnnot.getBackgroundColorCompNum', { widget: this.id });
        };
        ...
        PDFNet.SignatureWidget.create = function (doc, pos, field_name) {
          ...
          checkArguments(arguments.length, 2, 'create', '(PDFNet.PDFDoc, PDFNet.Rect, string)', [
            [doc, 'PDFDoc'],
            [pos, 'Structure', PDFNet.Rect, 'Rect'],
            [field_name, 'string'],
          ]);
        ...
        PDFNet.SignatureWidget.createWithField = function (doc, pos, field) {
          checkArguments(arguments.length, 3, 'createWithField', '(PDFNet.PDFDoc, PDFNet.Rect, PDFNet.Field)', [
            [doc, 'PDFDoc'],
            [pos, 'Structure', PDFNet.Rect, 'Rect'],
            [field, 'Structure', PDFNet.Field, 'Field'],
          ]);
        ...
        PDFNet.SignatureWidget.createWithDigitalSignatureField = function (doc, pos, field) {
          checkArguments(arguments.length, 3, 'createWithDigitalSignatureField', '(PDFNet.PDFDoc, PDFNet.Rect, PDFNet.DigitalSignatureField)', [
            [doc, 'PDFDoc'],
            [pos, 'Structure', PDFNet.Rect, 'Rect'],
            [field, 'Structure', PDFNet.DigitalSignatureField, 'DigitalSignatureField'],
          ]);
          checkParamsYieldFunction('createWithDigitalSignatureField', [
            [pos, 1],
            [field, 2],
          ]);
          return PDFNet.sendWithPromise('signatureWidgetCreateWithDigitalSignatureField', { doc: doc.id, pos: pos, field: field }).then(function (id) {
            return createPDFNetObj(PDFNet.SignatureWidget, id);
          });
        };
        ...
        PDFNet.SignatureWidget.prototype.createSignatureAppearance = function (img) {
          ...
          return PDFNet.sendWithPromise('SignatureWidget.createSignatureAppearance', { self: this.id, img: img.id });
        };
        PDFNet.SignatureWidget.prototype.getDigitalSignatureField = function () {
          return PDFNet.sendWithPromise('SignatureWidget.getDigitalSignatureField', { self: this.id }).then(function (id) {
        ...
        PDFNet.Bookmark.prototype.setColor = function (in_r, in_g, in_b) {
          ...
          checkArguments(arguments.length, 0, 'setColor', '(number, number, number)', [
            [in_r, 'number'],
            [in_g, 'number'],
            [in_b, 'number'],
          ]);
        ...
        PDFNet.ColorPt.prototype.set = function (x, y, z, w) {
          ...
          'undefined' === typeof z && (z = 0);
          'undefined' === typeof w && (w = 0);
          checkArguments(arguments.length, 0, 'set', '(number, number, number, number)', [
            [x, 'number'],
            [y, 'number'],
            [z, 'number'],
            [w, 'number'],
        ...
        PDFNet.ColorSpace.createICCFromFilter = function (doc, filter) {
          checkArguments(arguments.length, 2, 'createICCFromFilter', '(PDFNet.SDFDoc, PDFNet.Filter)', [
            [doc, 'SDFDoc'],
        ...
        PDFNet.ColorSpace.createICCFromBuffer = function (doc, buf) {
          checkArguments(arguments.length, 2, 'createICCFromBuffer', '(PDFNet.SDFDoc, ArrayBuffer|TypedArray)', [
            [doc, 'SDFDoc'],
            [buf, 'ArrayBuffer'],
          ]);
          var bufArrayBuffer = getArrayBuffer(buf, !1);
        ...
        PDFNet.ColorSpace.getComponentNumFromObj = function (cs_type, cs_obj) {
          checkArguments(arguments.length, 2, 'getComponentNumFromObj', '(number, PDFNet.Obj)', [
            [cs_type, 'number'],
        ...
        PDFNet.ContentReplacer.prototype.addImage = function (target_region, replacement_image) {
          checkArguments(arguments.length, 2, 'addImage', '(PDFNet.Rect, PDFNet.Obj)', [
        ...
        PDFNet.ContentReplacer.prototype.addText = function (target_region, replacement_text) {
          checkArguments(arguments.length, 2, 'addText', '(PDFNet.Rect, string)', [
            [target_region, 'Structure', PDFNet.Rect, 'Rect'],
        ...
        PDFNet.ContentReplacer.prototype.setMatchStrings = function (start_str, end_str) {
          checkArguments(arguments.length, 2, 'setMatchStrings', '(string, string)', [
            [start_str, 'string'],
            [end_str, 'string'],
          ]);
        ...
        PDFNet.Reflow.prototype.setMessageWhenNoReflowContent = function (content) {
          ...
          return PDFNet.sendWithPromise('Reflow.setMessageWhenNoReflowContent', { self: this.id, content: content });
        };
        ...
        PDFNet.Reflow.prototype.setIncludeBBoxForRecognizedZones = function (include) {
          ...
          return PDFNet.sendWithPromise('Reflow.setIncludeBBoxForRecognizedZones', { self: this.id, include: include });
        };
        ...
        PDFNet.Convert.createReflow = function (in_page, json_zones) {
          checkArguments(arguments.length, 2, 'createReflow', '(PDFNet.Page, string)', [
        ...
        PDFNet.Convert.fromTextWithBuffer = function (in_pdfdoc, fileData, options) {
          ...
          checkArguments(arguments.length, 2, 'fromTextWithBuffer', '(PDFNet.PDFDoc, ArrayBuffer|TypedArray, PDFNet.Obj)', [
            [in_pdfdoc, 'PDFDoc'],
        ...
        PDFNet.Convert.toXpsBuffer = function (in_pdfdoc, options$jscomp$0) {
          ...
          checkArguments(arguments.length, 1, 'toXpsBuffer', '(PDFNet.PDFDoc, PDFNet.Obj)', [
            [in_pdfdoc, 'PDFDoc'],
            [options$jscomp$0, 'OptionObject', PDFNet.Obj, 'Obj', 'PDFNet.Convert.XPSOutputOptions'],
          ]);
        ...
        PDFNet.Convert.fileToXpsWithBuffer = function (fileData, fileType, options$jscomp$0) {
          'undefined' === typeof options$jscomp$0 && (options$jscomp$0 = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 2, 'fileToXpsWithBuffer', '(ArrayBuffer|TypedArray, string, PDFNet.Obj)', [
            [fileData, 'ArrayBuffer'],
            [fileType, 'string'],
            [options$jscomp$0, 'OptionObject', PDFNet.Obj, 'Obj', 'PDFNet.Convert.XPSOutputOptions'],
          ]);
        ...
        PDFNet.Convert.fileToXodWithBuffer = function (fileData, fileType, options$jscomp$0) {
          'undefined' === typeof options$jscomp$0 && (options$jscomp$0 = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 2, 'fileToXodWithBuffer', '(ArrayBuffer|TypedArray, string, PDFNet.Obj)', [
            [fileData, 'ArrayBuffer'],
            [fileType, 'string'],
            [options$jscomp$0, 'OptionObject', PDFNet.Obj, 'Obj', 'PDFNet.Convert.XODOutputOptions'],
          ]);
          fileType.startsWith('.') || (fileType = '.' + fileType);
          fileData = getArrayBuffer(fileData, !1);
        ...
        PDFNet.Convert.toXodBuffer = function (in_pdfdoc, options$jscomp$0) {
          'undefined' === typeof options$jscomp$0 && (options$jscomp$0 = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 1, 'toXodBuffer', '(PDFNet.PDFDoc, PDFNet.Obj)', [
            [in_pdfdoc, 'PDFDoc'],
            [options$jscomp$0, 'OptionObject', PDFNet.Obj, 'Obj', 'PDFNet.Convert.XODOutputOptions'],
          ]);
          options$jscomp$0 = getOptsObjPromise(options$jscomp$0, 'PDFNet.Convert.XODOutputOptions');
        ...
        PDFNet.Convert.officeToPdfWithFilter = function (in_pdfdoc, in_stream, options$jscomp$0) {
          'undefined' === typeof options$jscomp$0 && (options$jscomp$0 = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 2, 'officeToPdfWithFilter', '(PDFNet.PDFDoc, PDFNet.Filter, PDFNet.Obj)', [
            [in_pdfdoc, 'PDFDoc'],
            [in_stream, 'Object', PDFNet.Filter, 'Filter'],
            [options$jscomp$0, 'OptionObject', PDFNet.Obj, 'Obj', 'PDFNet.Convert.ConversionOptions'],
          ]);
        ...
        PDFNet.Convert.toPdfWithBuffer = function (in_pdfdoc, fileData, fileType) {
          checkArguments(arguments.length, 3, 'toPdfWithBuffer', '(PDFNet.PDFDoc, ArrayBuffer|TypedArray, string)', [
            [in_pdfdoc, 'PDFDoc'],
            [fileData, 'ArrayBuffer'],
            [fileType, 'string'],
          ]);
        ...
        PDFNet.Convert.fromTiff = function (in_pdfdoc, in_data) {
          checkArguments(arguments.length, 2, 'fromTiff', '(PDFNet.PDFDoc, PDFNet.Filter)', [
            [in_pdfdoc, 'PDFDoc'],
        ...
        PDFNet.Convert.pageToHtmlZoned = function (page, json_zones) {
          checkArguments(arguments.length, 2, 'pageToHtmlZoned', '(PDFNet.Page, string)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [json_zones, 'string'],
          ]);
        ...
        PDFNet.Convert.fileToTiffWithBuffer = function (fileData, fileType, options$jscomp$0) {
          'undefined' === typeof options$jscomp$0 && (options$jscomp$0 = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 2, 'fileToTiffWithBuffer', '(ArrayBuffer|TypedArray, string, PDFNet.Obj)', [
            [fileData, 'ArrayBuffer'],
            [fileType, 'string'],
            [options$jscomp$0, 'OptionObject', PDFNet.Obj, 'Obj', 'PDFNet.Convert.TiffOutputOptions'],
          ]);
          fileType.startsWith('.') || (fileType = '.' + fileType);
          fileData = getArrayBuffer(fileData, !1);
        ...
        PDFNet.Convert.toTiffBuffer = function (in_pdfdoc, options$jscomp$0) {
          'undefined' === typeof options$jscomp$0 && (options$jscomp$0 = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 1, 'toTiffBuffer', '(PDFNet.PDFDoc, PDFNet.Obj)', [
            [in_pdfdoc, 'PDFDoc'],
            [options$jscomp$0, 'OptionObject', PDFNet.Obj, 'Obj', 'PDFNet.Convert.TiffOutputOptions'],
          ]);
          options$jscomp$0 = getOptsObjPromise(options$jscomp$0, 'PDFNet.Convert.TiffOutputOptions');
        ...
        PDFNet.Date.init = function (year, month, day, hour, minute, second) {
          checkArguments(arguments.length, 6, 'init', '(number, number, number, number, number, number)', [
            [year, 'number'],
            [month, 'number'],
            [day, 'number'],
            [hour, 'number'],
        ...
        PDFNet.Destination.createXYZ = function (page, left, top, zoom) {
          checkArguments(arguments.length, 4, 'createXYZ', '(PDFNet.Page, number, number, number)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [left, 'number'],
            [top, 'number'],
            [zoom, 'number'],
        ...
        PDFNet.Destination.createFitH = function (page, top) {
          checkArguments(arguments.length, 2, 'createFitH', '(PDFNet.Page, number)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [top, 'number'],
          ]);
        ...
        PDFNet.Destination.createFitV = function (page, left) {
          checkArguments(arguments.length, 2, 'createFitV', '(PDFNet.Page, number)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [left, 'number'],
          ]);
        ...
        PDFNet.Destination.createFitR = function (page, left, bottom, right, top) {
          checkArguments(arguments.length, 5, 'createFitR', '(PDFNet.Page, number, number, number, number)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [left, 'number'],
            [bottom, 'number'],
            [right, 'number'],
        ...
        PDFNet.Destination.createFitBH = function (page, top) {
          checkArguments(arguments.length, 2, 'createFitBH', '(PDFNet.Page, number)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [top, 'number'],
          ]);
        ...
        PDFNet.Destination.createFitBV = function (page, left) {
          checkArguments(arguments.length, 2, 'createFitBV', '(PDFNet.Page, number)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [left, 'number'],
          ]);
        ...
        PDFNet.GState.prototype.getFont = function () {
          return PDFNet.sendWithPromise('GState.getFont', { gs: this.id }).then(function (id) {
            return createDestroyableObj(PDFNet.Font, id);
          });
        };
        ...
        PDFNet.GState.prototype.setTransform = function (a, b, c, d, h, v) {
          checkArguments(arguments.length, 6, 'setTransform', '(number, number, number, number, number, number)', [
            [a, 'number'],
            [b, 'number'],
            [c, 'number'],
            [d, 'number'],
        ...
        PDFNet.GState.prototype.setStrokeColor = function (pattern, c) {
          checkArguments(arguments.length, 2, 'setStrokeColor', '(PDFNet.PatternColor, PDFNet.ColorPt)', [
        ...
        PDFNet.GState.prototype.setFillColor = function (pattern, c) {
          checkArguments(arguments.length, 2, 'setFillColor', '(PDFNet.PatternColor, PDFNet.ColorPt)', [
            [pattern, 'Object', PDFNet.PatternColor, 'PatternColor'],
            [c, 'Object', PDFNet.ColorPt, 'ColorPt'],
          ]);
        ...
        PDFNet.GState.prototype.setDashPattern = function (dash_array, phase) {
          checkArguments(arguments.length, 2, 'setDashPattern', '(Array<number>, number)', [
            [dash_array, 'Array'],
            [phase, 'number'],
          ]);
        ...
        PDFNet.GState.prototype.setFont = function (font, font_sz) {
          checkArguments(arguments.length, 2, 'setFont', '(PDFNet.Font, number)', [
        ...
        PDFNet.Element.prototype.getCTM = function () {
          return PDFNet.sendWithPromise('Element.getCTM', { e: this.id }).then(function (id) {
            return new PDFNet.Matrix2D(id);
          });
        };
        ...
        PDFNet.Element.prototype.setPathTypes = function (in_seg_types, count) {
          checkArguments(arguments.length, 2, 'setPathTypes', '(string, number)', [
            [in_seg_types, 'string'],
            [count, 'number'],
          ]);
        ...
        PDFNet.Element.prototype.getMask = function () {
          return PDFNet.sendWithPromise('Element.getMask', { e: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id);
          });
        };
        ...
        PDFNet.Element.prototype.setTextMatrixEntries = function (a, b, c, d, h, v) {
          checkArguments(arguments.length, 6, 'setTextMatrixEntries', '(number, number, number, number, number, number)', [
            [a, 'number'],
            [b, 'number'],
            [c, 'number'],
            [d, 'number'],
        ...
        PDFNet.Element.prototype.setNewTextLineOffset = function (dx, dy) {
          checkArguments(arguments.length, 2, 'setNewTextLineOffset', '(number, number)', [
            [dx, 'number'],
            [dy, 'number'],
          ]);
        ...
        PDFNet.ElementBuilder.prototype.createImageFromMatrix = function (img, mtx) {
          checkArguments(arguments.length, 2, 'createImageFromMatrix', '(PDFNet.Image, PDFNet.Matrix2D)', [
            [img, 'Object', PDFNet.Image, 'Image'],
            [mtx, 'Structure', PDFNet.Matrix2D, 'Matrix2D'],
          ]);
          checkParamsYieldFunction('createImageFromMatrix', [[mtx, 1]]);
          return PDFNet.sendWithPromise('ElementBuilder.createImageFromMatrix', { b: this.id, img: img.id, mtx: mtx }).then(function (id) {
            return createPDFNetObj(PDFNet.Element, id);
          });
        };
        PDFNet.ElementBuilder.prototype.createImageScaled = function (img, x, y, hscale, vscale) {
          checkArguments(arguments.length, 5, 'createImageScaled', '(PDFNet.Image, number, number, number, number)', [
            [img, 'Object', PDFNet.Image, 'Image'],
            [x, 'number'],
            [y, 'number'],
            [hscale, 'number'],
        ...
        PDFNet.ElementBuilder.prototype.createFormFromDoc = function (page, doc) {
          checkArguments(arguments.length, 2, 'createFormFromDoc', '(PDFNet.Page, PDFNet.PDFDoc)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [doc, 'PDFDoc'],
          ]);
        ...
        PDFNet.ElementBuilder.prototype.createTextBeginWithFont = function (font, font_sz) {
          ...
          return PDFNet.sendWithPromise('ElementBuilder.createTextBeginWithFont', { b: this.id, font: font.id, font_sz: font_sz }).then(function (id) {
            return createPDFNetObj(PDFNet.Element, id);
          });
        };
        ...
        PDFNet.ElementBuilder.prototype.createTextRun = function (text_data, font, font_sz) {
          checkArguments(arguments.length, 3, 'createTextRun', '(string, PDFNet.Font, number)', [
            [text_data, 'string'],
            [font, 'Object', PDFNet.Font, 'Font'],
            [font_sz, 'number'],
          ]);
        ...
        PDFNet.ElementBuilder.prototype.createTextRunUnsigned = function (text_data, font, font_sz) {
          checkArguments(arguments.length, 3, 'createTextRunUnsigned', '(string, PDFNet.Font, number)', [
            [text_data, 'string'],
            [font, 'Object', PDFNet.Font, 'Font'],
            [font_sz, 'number'],
          ]);
        ...
        PDFNet.ElementBuilder.prototype.createNewTextRunUnsigned = function (text_data) {
          ...
          return PDFNet.sendWithPromise('ElementBuilder.createNewTextRunUnsigned', { b: this.id, text_data: text_data }).then(function (id) {
            return createPDFNetObj(PDFNet.Element, id);
          });
        };
        ...
        PDFNet.ElementBuilder.prototype.createTextNewLineWithOffset = function (dx, dy) {
          checkArguments(arguments.length, 2, 'createTextNewLineWithOffset', '(number, number)', [
            [dx, 'number'],
            [dy, 'number'],
          ]);
          return PDFNet.sendWithPromise('ElementBuilder.createTextNewLineWithOffset', { b: this.id, dx: dx, dy: dy }).then(function (id) {
            return createPDFNetObj(PDFNet.Element, id);
          });
        };
        ...
        PDFNet.ElementBuilder.prototype.createPath = function (points, buf_seg_types) {
          checkArguments(arguments.length, 2, 'createPath', '(Array<number>, ArrayBuffer|TypedArray)', [
            [points, 'Array'],
        ...
        PDFNet.ElementBuilder.prototype.createRect = function (x, y, width, height) {
          checkArguments(arguments.length, 4, 'createRect', '(number, number, number, number)', [
            [x, 'number'],
            [y, 'number'],
            [width, 'number'],
            [height, 'number'],
        ...
        PDFNet.ElementBuilder.prototype.createEllipse = function (x, y, width, height) {
          checkArguments(arguments.length, 4, 'createEllipse', '(number, number, number, number)', [
            [x, 'number'],
            [y, 'number'],
            [width, 'number'],
            [height, 'number'],
        ...
        PDFNet.ElementBuilder.prototype.rect = function (x, y, width, height) {
          checkArguments(arguments.length, 4, 'rect', '(number, number, number, number)', [
            [x, 'number'],
            [y, 'number'],
            [width, 'number'],
            [height, 'number'],
        ...
        PDFNet.ElementBuilder.prototype.ellipse = function (x, y, width, height) {
          checkArguments(arguments.length, 4, 'ellipse', '(number, number, number, number)', [
            [x, 'number'],
            [y, 'number'],
            [width, 'number'],
            [height, 'number'],
        ...
        PDFNet.ElementBuilder.prototype.curveTo = function (cx1, cy1, cx2, cy2, x2, y2) {
          checkArguments(arguments.length, 6, 'curveTo', '(number, number, number, number, number, number)', [
            [cx1, 'number'],
            [cy1, 'number'],
            [cx2, 'number'],
            [cy2, 'number'],
        ...
        PDFNet.ElementBuilder.prototype.arcTo = function (x, y, width, height, start, extent) {
          checkArguments(arguments.length, 6, 'arcTo', '(number, number, number, number, number, number)', [
            [x, 'number'],
            [y, 'number'],
            [width, 'number'],
            [height, 'number'],
        ...
        PDFNet.ElementBuilder.prototype.arcTo2 = function (xr, yr, rx, isLargeArc, sweep, endX, endY) {
          checkArguments(arguments.length, 7, 'arcTo2', '(number, number, number, boolean, boolean, number, number)', [
            [xr, 'number'],
            [yr, 'number'],
            [rx, 'number'],
            [isLargeArc, 'boolean'],
        ...
        PDFNet.ElementBuilder.prototype.createMarkedContentBeginInlineProperties = function (tag) {
          ...
          return PDFNet.sendWithPromise('ElementBuilder.createMarkedContentBeginInlineProperties', { b: this.id, tag: tag }).then(function (id) {
            return createPDFNetObj(PDFNet.Element, id);
          });
        };
        PDFNet.ElementBuilder.prototype.createMarkedContentBegin = function (tag, property_dict) {
          checkArguments(arguments.length, 2, 'createMarkedContentBegin', '(string, PDFNet.Obj)', [
            [tag, 'string'],
            [property_dict, 'Object', PDFNet.Obj, 'Obj'],
          ]);
          return PDFNet.sendWithPromise('ElementBuilder.createMarkedContentBegin', { b: this.id, tag: tag, property_dict: property_dict.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Element, id);
            },
          );
        ...
        PDFNet.ElementBuilder.prototype.createMarkedContentEnd = function () {
          return PDFNet.sendWithPromise('ElementBuilder.createMarkedContentEnd', { b: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Element, id);
          });
        };
        PDFNet.ElementBuilder.prototype.createMarkedContentPointInlineProperties = function (tag) {
          ...
          return PDFNet.sendWithPromise('ElementBuilder.createMarkedContentPointInlineProperties', { b: this.id, tag: tag }).then(function (id) {
            return createPDFNetObj(PDFNet.Element, id);
          });
        };
        PDFNet.ElementBuilder.prototype.createMarkedContentPoint = function (tag, property_dict) {
          checkArguments(arguments.length, 2, 'createMarkedContentPoint', '(string, PDFNet.Obj)', [
            [tag, 'string'],
            [property_dict, 'Object', PDFNet.Obj, 'Obj'],
          ]);
          return PDFNet.sendWithPromise('ElementBuilder.createMarkedContentPoint', { b: this.id, tag: tag, property_dict: property_dict.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Element, id);
            },
          );
        ...
        PDFNet.ElementReader.prototype.beginOnPage = function (page, ctx) {
          ...
          checkArguments(arguments.length, 1, 'beginOnPage', '(PDFNet.Page, PDFNet.OCGContext)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [ctx, 'Object', PDFNet.OCGContext, 'OCGContext'],
          ]);
        ...
        PDFNet.ElementReader.prototype.begin = function (content_stream, resource_dict, ctx) {
          ...
          'undefined' === typeof ctx && (ctx = new PDFNet.OCGContext('0'));
          checkArguments(arguments.length, 1, 'begin', '(PDFNet.Obj, PDFNet.Obj, PDFNet.OCGContext)', [
        ...
        PDFNet.ElementReader.prototype.patternBegin = function (fill_pattern, reset_ctm_tfm) {
          ...
          checkArguments(arguments.length, 1, 'patternBegin', '(boolean, boolean)', [
        ...
        PDFNet.ElementReader.prototype.type3FontBegin = function (char_data, resource_dict) {
          'undefined' === typeof resource_dict && (resource_dict = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 1, 'type3FontBegin', '(PDFNet.CharData, PDFNet.Obj)', [
        ...
        PDFNet.ElementWriter.prototype.begin = function (doc, compress) {
          'undefined' === typeof compress && (compress = !0);
          checkArguments(arguments.length, 1, 'begin', '(PDFNet.SDFDoc, boolean)', [
            [doc, 'SDFDoc'],
            [compress, 'boolean'],
          ]);
        ...
        PDFNet.ElementWriter.prototype.beginOnObj = function (stream_obj_to_update, compress, resources) {
          'undefined' === typeof compress && (compress = !0);
          'undefined' === typeof resources && (resources = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 1, 'beginOnObj', '(PDFNet.Obj, boolean, PDFNet.Obj)', [
        ...
        PDFNet.FileSpec.create = function (doc, path, embed) {
          ...
          checkArguments(arguments.length, 2, 'create', '(PDFNet.SDFDoc, string, boolean)', [
            [doc, 'SDFDoc'],
            [path, 'string'],
            [embed, 'boolean'],
          ]);
        ...
        PDFNet.FileSpec.createURL = function (doc, url) {
          checkArguments(arguments.length, 2, 'createURL', '(PDFNet.SDFDoc, string)', [
            [doc, 'SDFDoc'],
            [url, 'string'],
          ]);
        ...
        PDFNet.FileSpec.prototype.copy = function () {
          return PDFNet.sendWithPromise('FileSpec.copy', { d: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.FileSpec, id);
          });
        };
        ...
        PDFNet.Flattener.prototype.process = function (doc, mode) {
          checkArguments(arguments.length, 2, 'process', '(PDFNet.PDFDoc, number)', [
            [doc, 'PDFDoc'],
            [mode, 'number'],
          ]);
        ...
        PDFNet.Flattener.prototype.processPage = function (page, mode) {
          checkArguments(arguments.length, 2, 'processPage', '(PDFNet.Page, number)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [mode, 'number'],
          ]);
        ...
        PDFNet.Font.create = function (doc, type) {
          checkArguments(arguments.length, 2, 'create', '(PDFNet.SDFDoc, number)', [
            [doc, 'SDFDoc'],
            [type, 'number'],
          ]);
        ...
        PDFNet.Font.createFromFontDescriptor = function (doc, from, char_set) {
          checkArguments(arguments.length, 3, 'createFromFontDescriptor', '(PDFNet.SDFDoc, PDFNet.Font, string)', [
            [doc, 'SDFDoc'],
        ...
        PDFNet.Font.createFromName = function (doc, name, char_set) {
          checkArguments(arguments.length, 3, 'createFromName', '(PDFNet.SDFDoc, string, string)', [
            [doc, 'SDFDoc'],
            [name, 'string'],
            [char_set, 'string'],
          ]);
        ...
        PDFNet.Font.createAndEmbed = function (doc, type) {
          checkArguments(arguments.length, 2, 'createAndEmbed', '(PDFNet.SDFDoc, number)', [
            [doc, 'SDFDoc'],
            [type, 'number'],
          ]);
        ...
        PDFNet.Font.createTrueTypeFontWithBuffer = function (doc, font_buffer, embed, subset) {
          ...
          checkArguments(arguments.length, 2, 'createTrueTypeFontWithBuffer', '(PDFNet.SDFDoc, ArrayBuffer|TypedArray, boolean, boolean)', [
            [doc, 'SDFDoc'],
        ...
        PDFNet.Font.createCIDTrueTypeFontWithBuffer = function (doc, font_buffer, embed, subset, encoding, ttc_font_index) {
          ...
          checkArguments(arguments.length, 2, 'createCIDTrueTypeFontWithBuffer', '(PDFNet.SDFDoc, ArrayBuffer|TypedArray, boolean, boolean, number, number)', [
            [doc, 'SDFDoc'],
            [font_buffer, 'ArrayBuffer'],
            [embed, 'boolean'],
            [subset, 'boolean'],
        ...
        PDFNet.Font.createType1FontWithBuffer = function (doc, font_buffer, embed) {
          'undefined' === typeof embed && (embed = !0);
          checkArguments(arguments.length, 2, 'createType1FontWithBuffer', '(PDFNet.SDFDoc, ArrayBuffer|TypedArray, boolean)', [
            [doc, 'SDFDoc'],
            [font_buffer, 'ArrayBuffer'],
            [embed, 'boolean'],
          ]);
        ...
        PDFNet.Font.prototype.getBBox = function () {
          return PDFNet.sendWithPromise('Font.getBBox', { font: this.id }).then(function (id) {
            return new PDFNet.Rect(id);
          });
        };
        ...
        PDFNet.Image.createFromMemory2 = function (doc, buf, encoder_hints) {
          'undefined' === typeof encoder_hints && (encoder_hints = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 2, 'createFromMemory2', '(PDFNet.SDFDoc, ArrayBuffer|TypedArray, PDFNet.Obj)', [
            [doc, 'SDFDoc'],
            [buf, 'ArrayBuffer'],
            [encoder_hints, 'Object', PDFNet.Obj, 'Obj'],
          ]);
        ...
        PDFNet.Image.createFromStream2 = function (doc, image_data, encoder_hints) {
          'undefined' === typeof encoder_hints && (encoder_hints = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 2, 'createFromStream2', '(PDFNet.SDFDoc, PDFNet.Filter, PDFNet.Obj)', [
            [doc, 'SDFDoc'],
        ...
        PDFNet.Image.createImageMaskFromStream = function (doc, image_data, width, height, encoder_hints) {
          'undefined' === typeof encoder_hints && (encoder_hints = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 4, 'createImageMaskFromStream', '(PDFNet.SDFDoc, PDFNet.FilterReader, number, number, PDFNet.Obj)', [
            [doc, 'SDFDoc'],
            [image_data, 'Object', PDFNet.FilterReader, 'FilterReader'],
            [width, 'number'],
            [height, 'number'],
        ...
        PDFNet.Image.createSoftMask = function (doc, buf, width, height, bpc, encoder_hints) {
          'undefined' === typeof encoder_hints && (encoder_hints = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 5, 'createSoftMask', '(PDFNet.SDFDoc, ArrayBuffer|TypedArray, number, number, number, PDFNet.Obj)', [
            [doc, 'SDFDoc'],
            [buf, 'ArrayBuffer'],
            [width, 'number'],
            [height, 'number'],
        ...
        PDFNet.Image.createSoftMaskFromStream = function (doc, image_data, width, height, bpc, encoder_hints) {
          'undefined' === typeof encoder_hints && (encoder_hints = new PDFNet.Obj('0'));
          checkArguments(arguments.length, 5, 'createSoftMaskFromStream', '(PDFNet.SDFDoc, PDFNet.FilterReader, number, number, number, PDFNet.Obj)', [
            [doc, 'SDFDoc'],
            [image_data, 'Object', PDFNet.FilterReader, 'FilterReader'],
            [width, 'number'],
            [height, 'number'],
        ...
        PDFNet.Image.prototype.copy = function () {
          return PDFNet.sendWithPromise('Image.copy', { c: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Image, id);
          });
        };
        ...
        PDFNet.Image.prototype.getMask = function () {
          return PDFNet.sendWithPromise('Image.getMask', { img: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id);
          });
        };
        ...
        PDFNet.PageLabel.create = function (doc, style, prefix, start_at) {
          ...
          checkArguments(arguments.length, 2, 'create', '(PDFNet.SDFDoc, number, string, number)', [
            [doc, 'SDFDoc'],
            [style, 'number'],
            [prefix, 'string'],
            [start_at, 'number'],
        ...
        PDFNet.PageLabel.createFromObj = function (l, first_page, last_page) {
          ...
          checkArguments(arguments.length, 0, 'createFromObj', '(PDFNet.Obj, number, number)', [
        ...
        PDFNet.PageSet.createRange = function (range_start, range_end) {
          checkArguments(arguments.length, 2, 'createRange', '(number, number)', [
            [range_start, 'number'],
            [range_end, 'number'],
          ]);
        ...
        PDFNet.PageSet.createFilteredRange = function (range_start, range_end, filter) {
          ...
          checkArguments(arguments.length, 2, 'createFilteredRange', '(number, number, number)', [
            [range_start, 'number'],
            [range_end, 'number'],
            [filter, 'number'],
          ]);
        ...
        PDFNet.PageSet.prototype.addRange = function (range_start, range_end, filter) {
          'undefined' === typeof filter && (filter = PDFNet.PageSet.Filter.e_all);
          checkArguments(arguments.length, 2, 'addRange', '(number, number, number)', [
            [range_start, 'number'],
            [range_end, 'number'],
            [filter, 'number'],
          ]);
        ...
        PDFNet.GeometryCollection.prototype.snapToNearest = function (x, y, mode) {
          checkArguments(arguments.length, 3, 'snapToNearest', '(number, number, number)', [
            [x, 'number'],
            [y, 'number'],
            [mode, 'number'],
          ]);
        ...
        PDFNet.GeometryCollection.prototype.snapToNearestPixel = function (x, y, dpi, mode) {
          ...
          return PDFNet.sendWithPromise('GeometryCollection.snapToNearestPixel', { self: this.id, x: x, y: y, dpi: dpi, mode: mode });
        };
        PDFNet.DigestAlgorithm.calculateDigest = function (in_algorithm, in_buffer) {
          checkArguments(arguments.length, 2, 'calculateDigest', '(number, ArrayBuffer|TypedArray)', [
            [in_algorithm, 'number'],
        ...
        PDFNet.ObjectIdentifier.createFromPredefined = function (in_oid_enum) {
          ...
          return PDFNet.sendWithPromise('objectIdentifierCreateFromPredefined', { in_oid_enum: in_oid_enum }).then(function (id) {
        ...
        PDFNet.ObjectIdentifier.createFromDigestAlgorithm = function (in_algorithm) {
          ...
          return PDFNet.sendWithPromise('objectIdentifierCreateFromDigestAlgorithm', { in_algorithm: in_algorithm }).then(function (id) {
            return createDestroyableObj(PDFNet.ObjectIdentifier, id);
          });
        };
        ...
        PDFNet.X501DistinguishedName.prototype.getStringValuesForAttribute = function (in_oid) {
          checkArguments(arguments.length, 1, 'getStringValuesForAttribute', '(PDFNet.ObjectIdentifier)', [
            [in_oid, 'Object', PDFNet.ObjectIdentifier, 'ObjectIdentifier'],
          ]);
          return PDFNet.sendWithPromise('X501DistinguishedName.getStringValuesForAttribute', { self: this.id, in_oid: in_oid.id });
        };
        PDFNet.X501DistinguishedName.prototype.getAllAttributesAndValues = function () {
          return PDFNet.sendWithPromise('X501DistinguishedName.getAllAttributesAndValues', { self: this.id }).then(function (idArray) {
        ...
        PDFNet.X509Certificate.prototype.getNotBeforeEpochTime = function () {
          return PDFNet.sendWithPromise('X509Certificate.getNotBeforeEpochTime', { self: this.id });
        };
        PDFNet.X509Certificate.prototype.getNotAfterEpochTime = function () {
          return PDFNet.sendWithPromise('X509Certificate.getNotAfterEpochTime', { self: this.id });
        };
        PDFNet.X509Certificate.prototype.getRawX509VersionNumber = function () {
          return PDFNet.sendWithPromise('X509Certificate.getRawX509VersionNumber', { self: this.id });
        };
        ...
        PDFNet.TimestampingConfiguration.createFromURL = function (in_url) {
          ...
          return PDFNet.sendWithPromise('timestampingConfigurationCreateFromURL', { in_url: in_url }).then(function (id) {
        ...
        PDFNet.TimestampingConfiguration.prototype.setTimestampAuthorityServerURL = function (in_url) {
          ...
          return PDFNet.sendWithPromise('TimestampingConfiguration.setTimestampAuthorityServerURL', { self: this.id, in_url: in_url });
        };
        PDFNet.TimestampingConfiguration.prototype.setTimestampAuthorityServerUsername = function (in_username) {
          ...
          return PDFNet.sendWithPromise('TimestampingConfiguration.setTimestampAuthorityServerUsername', { self: this.id, in_username: in_username });
        };
        PDFNet.TimestampingConfiguration.prototype.setTimestampAuthorityServerPassword = function (in_password) {
          ...
          return PDFNet.sendWithPromise('TimestampingConfiguration.setTimestampAuthorityServerPassword', { self: this.id, in_password: in_password });
        };
        PDFNet.TimestampingConfiguration.prototype.setUseNonce = function (in_use_nonce) {
          ...
          return PDFNet.sendWithPromise('TimestampingConfiguration.setUseNonce', { self: this.id, in_use_nonce: in_use_nonce });
        };
        PDFNet.TimestampingConfiguration.prototype.testConfiguration = function (in_opts) {
          checkArguments(arguments.length, 1, 'testConfiguration', '(PDFNet.VerificationOptions)', [
            [in_opts, 'Object', PDFNet.VerificationOptions, 'VerificationOptions'],
          ]);
          return PDFNet.sendWithPromise('TimestampingConfiguration.testConfiguration', { self: this.id, in_opts: in_opts.id }).then(function (id) {
        ...
        PDFNet.DigitalSignatureField.prototype.hasCryptographicSignature = function () {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.hasCryptographicSignature', { self: this });
        };
        ...
        PDFNet.DigitalSignatureField.prototype.getSignatureName = function () {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.getSignatureName', { self: this });
        };
        ...
        PDFNet.DigitalSignatureField.prototype.getContactInfo = function () {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.getContactInfo', { self: this });
        };
        ...
        PDFNet.DigitalSignatureField.prototype.hasVisibleAppearance = function () {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.hasVisibleAppearance', { self: this });
        };
        PDFNet.DigitalSignatureField.prototype.setContactInfo = function (in_contact_info) {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.setContactInfo', { self: this, in_contact_info: in_contact_info }).then(function (id) {
            me.yieldFunction = void 0;
            copyFunc(id, me);
          });
        };
        ...
        PDFNet.DigitalSignatureField.prototype.setDocumentPermissions = function (in_perms) {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.setDocumentPermissions', { self: this, in_perms: in_perms }).then(function (id) {
            me.yieldFunction = void 0;
            copyFunc(id, me);
          });
        };
        PDFNet.DigitalSignatureField.prototype.signOnNextSave = function (in_pkcs12_keyfile_path, in_password) {
          checkArguments(arguments.length, 2, 'signOnNextSave', '(string, string)', [
        ...
        PDFNet.DigitalSignatureField.prototype.certifyOnNextSave = function (in_pkcs12_keyfile_path, in_password) {
          checkArguments(arguments.length, 2, 'certifyOnNextSave', '(string, string)', [
            [in_pkcs12_keyfile_path, 'string'],
            [in_password, 'string'],
          ]);
        ...
        PDFNet.DigitalSignatureField.prototype.isLockedByDigitalSignature = function () {
          checkThisYieldFunction('isLockedByDigitalSignature', this.yieldFunction);
          return PDFNet.sendWithPromise('DigitalSignatureField.isLockedByDigitalSignature', { self: this });
        };
        PDFNet.DigitalSignatureField.prototype.getDocumentPermissions = function () {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.getDocumentPermissions', { self: this });
        };
        PDFNet.DigitalSignatureField.prototype.clearSignature = function () {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.clearSignature', { self: this }).then(function (id) {
            me.yieldFunction = void 0;
            copyFunc(id, me);
          });
        };
        PDFNet.DigitalSignatureField.createFromField = function (in_field) {
          ...
          return PDFNet.sendWithPromise('digitalSignatureFieldCreateFromField', { in_field: in_field }).then(function (id) {
            return new PDFNet.DigitalSignatureField(id);
          });
        };
        PDFNet.DigitalSignatureField.prototype.getSigningTime = function () {
          checkThisYieldFunction('getSigningTime', this.yieldFunction);
          return PDFNet.sendWithPromise('DigitalSignatureField.getSigningTime', { self: this }).then(function (id) {
            return new PDFNet.Date(id);
          });
        };
        ...
        PDFNet.DigitalSignatureField.prototype.setFieldPermissions = function (in_action, in_field_names_list) {
          ...
          checkArguments(arguments.length, 1, 'setFieldPermissions', '(number, Array<string>)', [
            [in_action, 'number'],
        ...
        PDFNet.DigitalSignatureField.prototype.signOnNextSaveFromBuffer = function (in_pkcs12_buffer, in_password) {
          checkArguments(arguments.length, 2, 'signOnNextSaveFromBuffer', '(ArrayBuffer|TypedArray, string)', [
        ...
        PDFNet.DigitalSignatureField.prototype.certifyOnNextSaveFromBuffer = function (in_pkcs12_buffer, in_password) {
          checkArguments(arguments.length, 2, 'certifyOnNextSaveFromBuffer', '(ArrayBuffer|TypedArray, string)', [
            [in_pkcs12_buffer, 'ArrayBuffer'],
            [in_password, 'string'],
          ]);
        ...
        PDFNet.DigitalSignatureField.prototype.getLockedFields = function () {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.getLockedFields', { self: this });
        };
        PDFNet.DigitalSignatureField.prototype.verify = function (in_opts) {
          checkArguments(arguments.length, 1, 'verify', '(PDFNet.VerificationOptions)', [
            [in_opts, 'Object', PDFNet.VerificationOptions, 'VerificationOptions'],
          ]);
        ...
        PDFNet.DigitalSignatureField.prototype.isCertification = function () {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.isCertification', { self: this });
        };
        PDFNet.DigitalSignatureField.prototype.getSignerCertFromCMS = function () {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.getSignerCertFromCMS', { self: this }).then(function (id) {
            return createDestroyableObj(PDFNet.X509Certificate, id);
          });
        };
        ...
        PDFNet.DigitalSignatureField.prototype.enableLTVOfflineVerification = function (in_verification_result) {
          checkArguments(arguments.length, 1, 'enableLTVOfflineVerification', '(PDFNet.VerificationResult)', [
            [in_verification_result, 'Object', PDFNet.VerificationResult, 'VerificationResult'],
          ]);
        ...
        PDFNet.DigitalSignatureField.prototype.timestampOnNextSave = function (in_timestamping_config, in_timestamp_response_verification_options) {
          checkArguments(arguments.length, 2, 'timestampOnNextSave', '(PDFNet.TimestampingConfiguration, PDFNet.VerificationOptions)', [
        ...
        PDFNet.DigitalSignatureField.prototype.generateContentsWithEmbeddedTimestamp = function (
          in_timestamping_config,
          in_timestamp_response_verification_options,
        ) {
          checkArguments(arguments.length, 2, 'generateContentsWithEmbeddedTimestamp', '(PDFNet.TimestampingConfiguration, PDFNet.VerificationOptions)', [
            [in_timestamping_config, 'Object', PDFNet.TimestampingConfiguration, 'TimestampingConfiguration'],
            [in_timestamp_response_verification_options, 'Object', PDFNet.VerificationOptions, 'VerificationOptions'],
          ]);
        ...
        PDFNet.DigitalSignatureField.prototype.calculateDigest = function (in_digest_algorithm_type) {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.calculateDigest', { self: this, in_digest_algorithm_type: in_digest_algorithm_type }).then(
            function (id) {
              me.yieldFunction = void 0;
        ...
        PDFNet.DigitalSignatureField.prototype.setPreferredDigestAlgorithm = function (in_digest_algorithm_type, in_make_mandatory) {
          'undefined' === typeof in_make_mandatory && (in_make_mandatory = !0);
          checkArguments(arguments.length, 1, 'setPreferredDigestAlgorithm', '(number, boolean)', [
        ...
        PDFNet.DigitalSignatureField.prototype.createSigDictForCustomCertification = function (in_filter_name, in_subfilter_type, in_contents_size_to_reserve) {
          checkArguments(arguments.length, 3, 'createSigDictForCustomCertification', '(string, number, number)', [
        ...
        PDFNet.DigitalSignatureField.prototype.createSigDictForCustomSigning = function (in_filter_name, in_subfilter_type, in_contents_size_to_reserve) {
          checkArguments(arguments.length, 3, 'createSigDictForCustomSigning', '(string, number, number)', [
            [in_filter_name, 'string'],
            [in_subfilter_type, 'number'],
            [in_contents_size_to_reserve, 'number'],
          ]);
        ...
        PDFNet.DigitalSignatureField.prototype.setSigDictTimeOfSigning = function (in_date) {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.setSigDictTimeOfSigning', { self: this, in_date: in_date }).then(function (id) {
            me.yieldFunction = void 0;
            copyFunc(id, me);
          });
        };
        PDFNet.DigitalSignatureField.signDigestBuffer = function (in_digest, in_pkcs12_buffer, in_keyfile_password, in_pades_mode, in_digest_algorithm_type) {
          checkArguments(arguments.length, 5, 'signDigestBuffer', '(ArrayBuffer|TypedArray, ArrayBuffer|TypedArray, string, boolean, number)', [
        ...
        PDFNet.DigitalSignatureField.generateESSSigningCertPAdESAttribute = function (in_signer_cert, in_digest_algorithm_type) {
          checkArguments(arguments.length, 2, 'generateESSSigningCertPAdESAttribute', '(PDFNet.X509Certificate, number)', [
            [in_signer_cert, 'Object', PDFNet.X509Certificate, 'X509Certificate'],
            [in_digest_algorithm_type, 'number'],
          ]);
        ...
        PDFNet.DigitalSignatureField.generateCMSSignedAttributes = function (in_digest_buf, in_custom_signedattributes_buf) {
          ...
          checkArguments(arguments.length, 1, 'generateCMSSignedAttributes', '(ArrayBuffer|TypedArray, ArrayBuffer|TypedArray)', [
        ...
        PDFNet.DigitalSignatureField.generateCMSSignature = function (
          ...
          checkArguments(
            ...
            [
              ...
              [in_digest_algorithm_oid, 'Object', PDFNet.ObjectIdentifier, 'ObjectIdentifier'],
              [in_signature_algorithm_oid, 'Object', PDFNet.ObjectIdentifier, 'ObjectIdentifier'],
        ...
        PDFNet.PDFDoc.prototype.initStdSecurityHandlerUString = function (password) {
          ...
          return PDFNet.sendWithPromise('PDFDoc.initStdSecurityHandlerUString', { doc: this.id, password: password });
        };
        ...
        PDFNet.PDFDoc.prototype.setSecurityHandler = function (handler) {
          checkArguments(arguments.length, 1, 'setSecurityHandler', '(PDFNet.SecurityHandler)', [
        ...
        PDFNet.PDFDoc.prototype.saveStream = function (stream, flags) {
          checkArguments(arguments.length, 2, 'saveStream', '(PDFNet.Filter, number)', [
            [stream, 'Object', PDFNet.Filter, 'Filter'],
            [flags, 'number'],
          ]);
        ...
        PDFNet.PDFDoc.prototype.saveCustomSignatureBuffer = function (in_signature, in_field) {
          checkArguments(arguments.length, 2, 'saveCustomSignatureBuffer', '(ArrayBuffer|TypedArray, PDFNet.DigitalSignatureField)', [
            [in_signature, 'ArrayBuffer'],
            [in_field, 'Structure', PDFNet.DigitalSignatureField, 'DigitalSignatureField'],
          ]);
        ...
        PDFNet.PDFDoc.prototype.saveCustomSignatureStream = function (in_signature, in_field) {
          checkArguments(arguments.length, 2, 'saveCustomSignatureStream', '(ArrayBuffer|TypedArray, PDFNet.DigitalSignatureField)', [
            [in_signature, 'ArrayBuffer'],
            [in_field, 'Structure', PDFNet.DigitalSignatureField, 'DigitalSignatureField'],
          ]);
        ...
        PDFNet.PDFDoc.prototype.pageInsert = function (where, page) {
          checkArguments(arguments.length, 2, 'pageInsert', '(PDFNet.Iterator, PDFNet.Page)', [
        ...
        PDFNet.PDFDoc.prototype.appendTextDiffPage = function (page1, page2) {
          checkArguments(arguments.length, 2, 'appendTextDiffPage', '(PDFNet.Page, PDFNet.Page)', [
        ...
        PDFNet.PDFDoc.prototype.appendTextDiffDoc = function (doc1, doc2, options) {
          'undefined' === typeof options && (options = null);
          checkArguments(arguments.length, 2, 'appendTextDiffDoc', '(PDFNet.PDFDoc, PDFNet.PDFDoc, PDFNet.OptionBase)', [
            [doc1, 'PDFDoc'],
            [doc2, 'PDFDoc'],
            [options, 'OptionBase'],
          ]);
        ...
        PDFNet.PDFDoc.highlightTextDiff = function (doc1, doc2, options) {
          'undefined' === typeof options && (options = null);
          checkArguments(arguments.length, 2, 'highlightTextDiff', '(PDFNet.PDFDoc, PDFNet.PDFDoc, PDFNet.OptionBase)', [
            [doc1, 'PDFDoc'],
            [doc2, 'PDFDoc'],
            [options, 'OptionBase'],
          ]);
        ...
        PDFNet.PDFDoc.prototype.fieldCreate = function (field_name, type, field_value, def_field_value) {
          ...
          checkArguments(arguments.length, 2, 'fieldCreate', '(string, number, PDFNet.Obj, PDFNet.Obj)', [
            [field_name, 'string'],
            [type, 'number'],
            [field_value, 'Object', PDFNet.Obj, 'Obj'],
        ...
        PDFNet.PDFDoc.prototype.fieldCreateFromStrings = function (field_name, type, field_value, def_field_value) {
          ...
          checkArguments(arguments.length, 3, 'fieldCreateFromStrings', '(string, number, string, string)', [
            [field_name, 'string'],
            [type, 'number'],
            [field_value, 'string'],
        ...
        PDFNet.PDFDoc.prototype.fdfExtractPageSet = function (pages_to_extract, flag) {
          'undefined' === typeof flag && (flag = PDFNet.PDFDoc.ExtractFlag.e_forms_only);
          checkArguments(arguments.length, 1, 'fdfExtractPageSet', '(PDFNet.PageSet, number)', [
        ...
        PDFNet.PDFDoc.prototype.addFileAttachment = function (file_key, embedded_file) {
          checkArguments(arguments.length, 2, 'addFileAttachment', '(string, PDFNet.FileSpec)', [
            [file_key, 'string'],
        ...
        PDFNet.PDFDoc.prototype.setPageLabel = function (page_num, label) {
          checkArguments(arguments.length, 2, 'setPageLabel', '(number, PDFNet.PageLabel)', [
            [page_num, 'number'],
        ...
        PDFNet.PDFDoc.prototype.createIndirectString = function (value, buf_size) {
          checkArguments(arguments.length, 2, 'createIndirectString', '(number, number)', [
            [value, 'number'],
            [buf_size, 'number'],
          ]);
        ...
        PDFNet.PDFDoc.prototype.createIndirectStringFromUString = function (str) {
          ...
          return PDFNet.sendWithPromise('PDFDoc.createIndirectStringFromUString', { doc: this.id, str: str }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id);
          });
        };
        PDFNet.PDFDoc.prototype.createIndirectStreamFromFilter = function (data, filter_chain) {
          ...
          checkArguments(arguments.length, 1, 'createIndirectStreamFromFilter', '(PDFNet.FilterReader, PDFNet.Filter)', [
        ...
        PDFNet.PDFDoc.prototype.createIndirectStream = function (data, filter_chain) {
          checkArguments(arguments.length, 2, 'createIndirectStream', '(ArrayBuffer|TypedArray, PDFNet.Filter)', [
            [data, 'ArrayBuffer'],
            [filter_chain, 'Object', PDFNet.Filter, 'Filter'],
          ]);
        ...
        PDFNet.PDFDoc.prototype.unlock = function () {
          var me = this;
          return PDFNet.sendWithPromise('PDFDoc.unlock', { doc: this.id }).then(function () {
        ...
        PDFNet.PDFDoc.prototype.addSignatureHandler = function (signature_handler) {
          checkArguments(arguments.length, 1, 'addSignatureHandler', '(PDFNet.SignatureHandler)', [
            [signature_handler, 'Object', PDFNet.SignatureHandler, 'SignatureHandler'],
          ]);
        ...
        PDFNet.PDFDoc.prototype.addStdSignatureHandlerFromBuffer = function (pkcs12_buffer, pkcs12_pass) {
          checkArguments(arguments.length, 2, 'addStdSignatureHandlerFromBuffer', '(ArrayBuffer|TypedArray, string)', [
        ...
        PDFNet.PDFDoc.prototype.appendVisualDiff = function (p1, p2, opts) {
          'undefined' === typeof opts && (opts = null);
          checkArguments(arguments.length, 2, 'appendVisualDiff', '(PDFNet.Page, PDFNet.Page, PDFNet.OptionBase)', [
        ...
        PDFNet.PDFDoc.prototype.getGeometryCollectionForPageWithOptions = function (page_num, options) {
          'undefined' === typeof options && (options = null);
          checkArguments(arguments.length, 1, 'getGeometryCollectionForPageWithOptions', '(number, PDFNet.OptionBase)', [
            [page_num, 'number'],
            [options, 'OptionBase'],
          ]);
          checkParamsYieldFunction('getGeometryCollectionForPageWithOptions', [[options, 1]]);
          options = options ? options.getJsonString() : '{}';
          return PDFNet.sendWithPromise('PDFDoc.getGeometryCollectionForPageWithOptions', { in_pdfdoc: this.id, page_num: page_num, options: options }).then(
            function (id) {
              return createDestroyableObj(PDFNet.GeometryCollection, id);
            },
          );
        ...
        PDFNet.PDFDoc.prototype.getDigitalSignatureFieldIteratorBegin = function () {
          return PDFNet.sendWithPromise('PDFDoc.getDigitalSignatureFieldIteratorBegin', { doc: this.id }).then(function (id) {
        ...
        PDFNet.PDFDoc.prototype.getDigitalSignaturePermissions = function () {
          return PDFNet.sendWithPromise('PDFDoc.getDigitalSignaturePermissions', { doc: this.id });
        };
        PDFNet.PDFDoc.prototype.saveViewerOptimizedBuffer = function (opts$jscomp$0) {
          checkArguments(arguments.length, 1, 'saveViewerOptimizedBuffer', '(PDFNet.Obj)', [
            [opts$jscomp$0, 'OptionObject', PDFNet.Obj, 'Obj', 'PDFNet.PDFDoc.ViewerOptimizedOptions'],
          ]);
        ...
        PDFNet.PDFDoc.prototype.verifySignedDigitalSignatures = function (opts) {
          checkArguments(arguments.length, 1, 'verifySignedDigitalSignatures', '(PDFNet.VerificationOptions)', [
            [opts, 'Object', PDFNet.VerificationOptions, 'VerificationOptions'],
          ]);
          return PDFNet.sendWithPromise('PDFDoc.verifySignedDigitalSignatures', { doc: this.id, opts: opts.id });
        };
        PDFNet.convertPageToAnnotAppearance = function (docWithAppearance, objNum, annot_state, appearance_state) {
          checkArguments(arguments.length, 4, 'convertPageToAnnotAppearance', '(PDFNet.PDFDoc, number, number, string)', [
        ...
        PDFNet.PDFDoc.prototype.mergeXFDF = function (stream, options) {
          'undefined' === typeof options && (options = null);
          checkArguments(arguments.length, 1, 'mergeXFDF', '(PDFNet.Filter, PDFNet.OptionBase)', [
            [stream, 'Object', PDFNet.Filter, 'Filter'],
            [options, 'OptionBase'],
          ]);
        ...
        PDFNet.PDFDoc.prototype.mergeXFDFString = function (xfdf, options) {
          'undefined' === typeof options && (options = null);
          checkArguments(arguments.length, 1, 'mergeXFDFString', '(string, PDFNet.OptionBase)', [
            [xfdf, 'string'],
            [options, 'OptionBase'],
          ]);
        ...
        PDFNet.PDFDocInfo.create = function (tr) {
          ...
          return PDFNet.sendWithPromise('pdfDocInfoCreate', { tr: tr.id }).then(function (id) {
            return createPDFNetObj(PDFNet.PDFDocInfo, id);
          });
        };
        ...
        PDFNet.PDFDocViewPrefs.prototype.setNonFullScreenPageMode = function (mode) {
          ...
          return PDFNet.sendWithPromise('PDFDocViewPrefs.setNonFullScreenPageMode', { p: this.id, mode: mode });
        };
        PDFNet.PDFDocViewPrefs.prototype.getNonFullScreenPageMode = function () {
          return PDFNet.sendWithPromise('PDFDocViewPrefs.getNonFullScreenPageMode', { p: this.id });
        };
        ...
        PDFNet.PDFRasterizer.prototype.setThinLineAdjustment = function (grid_fit, stroke_adjust) {
          checkArguments(arguments.length, 2, 'setThinLineAdjustment', '(boolean, boolean)', [
            [grid_fit, 'boolean'],
        ...
        PDFNet.PDFRasterizer.prototype.setImageSmoothing = function (smoothing_enabled, hq_image_resampling) {
          ...
          checkArguments(arguments.length, 0, 'setImageSmoothing', '(boolean, boolean)', [
        ...
        PDFNet.PDFRasterizer.prototype.setAnnotationState = function (annot, new_view_state) {
          checkArguments(arguments.length, 2, 'setAnnotationState', '(PDFNet.Annot, number)', [
            [annot, 'Object', PDFNet.Annot, 'Annot'],
        ...
        PDFNet.PDFRasterizer.prototype.setColorPostProcessMode = function (mode) {
          ...
          return PDFNet.sendWithPromise('PDFRasterizer.setColorPostProcessMode', { r: this.id, mode: mode });
        };
        PDFNet.PDFRasterizer.prototype.getColorPostProcessMode = function () {
          return PDFNet.sendWithPromise('PDFRasterizer.getColorPostProcessMode', { r: this.id });
        };
        PDFNet.PDFRasterizer.prototype.enableDisplayListCaching = function (enabled) {
          ...
          return PDFNet.sendWithPromise('PDFRasterizer.enableDisplayListCaching', { r: this.id, enabled: enabled });
        };
        ...
        PDFNet.PDFRasterizer.prototype.rasterizeAnnot = function (annot, page, device_mtx, demult, cancel) {
          checkArguments(arguments.length, 5, 'rasterizeAnnot', '(PDFNet.Annot, PDFNet.Page, PDFNet.Matrix2D, boolean, boolean)', [
            [annot, 'Object', PDFNet.Annot, 'Annot'],
            [page, 'Object', PDFNet.Page, 'Page'],
        ...
        PDFNet.PDFRasterizer.prototype.rasterizeSeparations = function (page, width, height, mtx, clip, cancel) {
          checkArguments(arguments.length, 6, 'rasterizeSeparations', '(PDFNet.Page, number, number, PDFNet.Matrix2D, PDFNet.Rect, boolean)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [width, 'number'],
            [height, 'number'],
            [mtx, 'Structure', PDFNet.Matrix2D, 'Matrix2D'],
        ...
        PDFNet.PDFDraw.create = function (dpi) {
          ...
          return PDFNet.sendWithPromise('pdfDrawCreate', { dpi: dpi }).then(function (id) {
        ...
        PDFNet.PDFDraw.prototype.setImageSize = function (width, height, preserve_aspect_ratio) {
          ...
          checkArguments(arguments.length, 2, 'setImageSize', '(number, number, boolean)', [
            [width, 'number'],
            [height, 'number'],
        ...
        PDFNet.PDFDraw.prototype.setDefaultPageColor = function (r, g, b) {
          checkArguments(arguments.length, 3, 'setDefaultPageColor', '(number, number, number)', [
            [r, 'number'],
            [g, 'number'],
            [b, 'number'],
          ]);
        ...
        PDFNet.setDefaultDeviceCMYKProfileFromFilter = function (stream) {
          ...
          return PDFNet.sendWithPromise('pdfNetSetDefaultDeviceCMYKProfileFromFilter', { stream: stream.id });
        };
        PDFNet.setDefaultDeviceRGBProfileFromFilter = function (stream) {
          ...
          return PDFNet.sendWithPromise('pdfNetSetDefaultDeviceRGBProfileFromFilter', { stream: stream.id });
        };
        PDFNet.setDefaultFlateCompressionLevel = function (level) {
          ...
          return PDFNet.sendWithPromise('pdfNetSetDefaultFlateCompressionLevel', { level: level });
        };
        PDFNet.setViewerCache = function (max_cache_size, on_disk) {
          checkArguments(arguments.length, 2, 'setViewerCache', '(number, boolean)', [
        ...
        PDFNet.setConnectionErrorHandlingMode = function (mode) {
          ...
          return PDFNet.sendWithPromise('pdfNetSetConnectionErrorHandlingMode', { mode: mode });
        };
        PDFNet.Rect.init = function (x1, y1, x2, y2) {
          checkArguments(arguments.length, 4, 'init', '(number, number, number, number)', [
            [x1, 'number'],
            [y1, 'number'],
            [x2, 'number'],
            [y2, 'number'],
        ...
        PDFNet.Rect.prototype.set = function (x1, y1, x2, y2) {
          checkArguments(arguments.length, 4, 'set', '(number, number, number, number)', [
            [x1, 'number'],
            [y1, 'number'],
            [x2, 'number'],
            [y2, 'number'],
        ...
        PDFNet.Rect.prototype.intersectRect = function (rect1, rect2) {
          checkArguments(arguments.length, 2, 'intersectRect', '(PDFNet.Rect, PDFNet.Rect)', [
        ...
        PDFNet.Rect.prototype.normalize = function () {
          ...
          return PDFNet.sendWithPromise('Rect.normalize', { rect: this }).then(function (id) {
            me.yieldFunction = void 0;
            copyFunc(id, me);
          });
        };
        ...
        PDFNet.Redactor.redactionCreate = function (page_num, bbox, negative, text) {
          checkArguments(arguments.length, 4, 'redactionCreate', '(number, PDFNet.Rect, boolean, string)', [
            [page_num, 'number'],
        ...
        PDFNet.Shading.prototype.getBBox = function () {
          return PDFNet.sendWithPromise('Shading.getBBox', { s: this.id }).then(function (id) {
            return new PDFNet.Rect(id);
          });
        };
        ...
        PDFNet.Stamper.create = function (size_type, a, b) {
          checkArguments(arguments.length, 3, 'create', '(number, number, number)', [
            [size_type, 'number'],
            [a, 'number'],
            [b, 'number'],
          ]);
        ...
        PDFNet.Stamper.prototype.stampImage = function (dest_doc, img, dest_pages) {
          checkArguments(arguments.length, 3, 'stampImage', '(PDFNet.PDFDoc, PDFNet.Image, PDFNet.PageSet)', [
            [dest_doc, 'PDFDoc'],
            [img, 'Object', PDFNet.Image, 'Image'],
        ...
        PDFNet.Stamper.prototype.stampPage = function (dest_doc, page, dest_pages) {
          checkArguments(arguments.length, 3, 'stampPage', '(PDFNet.PDFDoc, PDFNet.Page, PDFNet.PageSet)', [
            [dest_doc, 'PDFDoc'],
            [page, 'Object', PDFNet.Page, 'Page'],
            [dest_pages, 'Object', PDFNet.PageSet, 'PageSet'],
          ]);
        ...
        PDFNet.Stamper.prototype.stampText = function (dest_doc, txt, dest_pages) {
          checkArguments(arguments.length, 3, 'stampText', '(PDFNet.PDFDoc, string, PDFNet.PageSet)', [
            [dest_doc, 'PDFDoc'],
            [txt, 'string'],
            [dest_pages, 'Object', PDFNet.PageSet, 'PageSet'],
          ]);
        ...
        PDFNet.Stamper.prototype.setAlignment = function (horizontal_alignment, vertical_alignment) {
          checkArguments(arguments.length, 2, 'setAlignment', '(number, number)', [
        ...
        PDFNet.Stamper.prototype.setPosition = function (horizontal_distance, vertical_distance, use_percentage) {
          ...
          checkArguments(arguments.length, 2, 'setPosition', '(number, number, boolean)', [
        ...
        PDFNet.Stamper.prototype.setSize = function (size_type, a, b) {
          checkArguments(arguments.length, 3, 'setSize', '(number, number, number)', [
            [size_type, 'number'],
            [a, 'number'],
            [b, 'number'],
          ]);
        ...
        PDFNet.Stamper.deleteStamps = function (doc, page_set) {
          checkArguments(arguments.length, 2, 'deleteStamps', '(PDFNet.PDFDoc, PDFNet.PageSet)', [
            [doc, 'PDFDoc'],
        ...
        PDFNet.Stamper.hasStamps = function (doc, page_set) {
          checkArguments(arguments.length, 2, 'hasStamps', '(PDFNet.PDFDoc, PDFNet.PageSet)', [
            [doc, 'PDFDoc'],
            [page_set, 'Object', PDFNet.PageSet, 'PageSet'],
          ]);
        ...
        PDFNet.TextExtractor.prototype.begin = function (page, clip_ptr, flags) {
          ...
          checkArguments(arguments.length, 1, 'begin', '(PDFNet.Page, PDFNet.Rect, number)', [
            [page, 'Object', PDFNet.Page, 'Page'],
        ...
        PDFNet.TextExtractor.prototype.setRightToLeftLanguage = function (rtl) {
          ...
          return PDFNet.sendWithPromise('TextExtractor.setRightToLeftLanguage', { te: this.id, rtl: rtl });
        };
        PDFNet.TextExtractor.prototype.getRightToLeftLanguage = function () {
          return PDFNet.sendWithPromise('TextExtractor.getRightToLeftLanguage', { te: this.id });
        };
        ...
        PDFNet.TextExtractor.prototype.getQuads = function (mtx, quads, quads_size) {
          checkArguments(arguments.length, 3, 'getQuads', '(PDFNet.Matrix2D, number, number)', [
            [mtx, 'Structure', PDFNet.Matrix2D, 'Matrix2D'],
            [quads, 'number'],
            [quads_size, 'number'],
          ]);
        ...
        PDFNet.TextSearch.prototype.begin = function (doc, pattern, mode, start_page, end_page) {
          ...
          checkArguments(arguments.length, 3, 'begin', '(PDFNet.PDFDoc, string, number, number, number)', [
            [doc, 'PDFDoc'],
            [pattern, 'string'],
            [mode, 'number'],
            [start_page, 'number'],
        ...
        PDFNet.NameTree.create = function (doc, name) {
          checkArguments(arguments.length, 2, 'create', '(PDFNet.SDFDoc, string)', [
            [doc, 'SDFDoc'],
            [name, 'string'],
          ]);
        ...
        PDFNet.NameTree.find = function (doc, name) {
          checkArguments(arguments.length, 2, 'find', '(PDFNet.SDFDoc, string)', [
            [doc, 'SDFDoc'],
            [name, 'string'],
          ]);
        ...
        PDFNet.NameTree.prototype.copy = function () {
          return PDFNet.sendWithPromise('NameTree.copy', { d: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.NameTree, id);
          });
        };
        ...
        PDFNet.Obj.prototype.getDoc = function () {
          return PDFNet.sendWithPromise('Obj.getDoc', { o: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.SDFDoc, id);
          });
        };
        ...
        PDFNet.Obj.prototype.putRect = function (key, x1, y1, x2, y2) {
          checkArguments(arguments.length, 5, 'putRect', '(string, number, number, number, number)', [
            [key, 'string'],
            [x1, 'number'],
            [y1, 'number'],
            [x2, 'number'],
        ...
        PDFNet.Obj.prototype.putMatrix = function (key, mtx) {
          checkArguments(arguments.length, 2, 'putMatrix', '(string, PDFNet.Matrix2D)', [
            [key, 'string'],
            [mtx, 'Structure', PDFNet.Matrix2D, 'Matrix2D'],
          ]);
        ...
        PDFNet.Obj.prototype.insertName = function (pos, name) {
          checkArguments(arguments.length, 2, 'insertName', '(number, string)', [
            [pos, 'number'],
            [name, 'string'],
          ]);
        ...
        PDFNet.Obj.prototype.insertBool = function (pos, value) {
          checkArguments(arguments.length, 2, 'insertBool', '(number, boolean)', [
            [pos, 'number'],
            [value, 'boolean'],
          ]);
        ...
        PDFNet.Obj.prototype.insertNumber = function (pos, value) {
          checkArguments(arguments.length, 2, 'insertNumber', '(number, number)', [
            [pos, 'number'],
            [value, 'number'],
          ]);
        ...
        PDFNet.Obj.prototype.insertString = function (pos, value) {
          checkArguments(arguments.length, 2, 'insertString', '(number, string)', [
            [pos, 'number'],
            [value, 'string'],
          ]);
        ...
        PDFNet.Obj.prototype.insertText = function (pos, t) {
          checkArguments(arguments.length, 2, 'insertText', '(number, string)', [
            [pos, 'number'],
            [t, 'string'],
          ]);
        ...
        PDFNet.Obj.prototype.insert = function (pos, input_obj) {
          checkArguments(arguments.length, 2, 'insert', '(number, PDFNet.Obj)', [
            [pos, 'number'],
            [input_obj, 'Object', PDFNet.Obj, 'Obj'],
          ]);
        ...
        PDFNet.Obj.prototype.insertRect = function (pos, x1, y1, x2, y2) {
          checkArguments(arguments.length, 5, 'insertRect', '(number, number, number, number, number)', [
            [pos, 'number'],
            [x1, 'number'],
            [y1, 'number'],
            [x2, 'number'],
        ...
        PDFNet.Obj.prototype.insertMatrix = function (pos, mtx) {
          checkArguments(arguments.length, 2, 'insertMatrix', '(number, PDFNet.Matrix2D)', [
            [pos, 'number'],
            [mtx, 'Structure', PDFNet.Matrix2D, 'Matrix2D'],
          ]);
        ...
        PDFNet.Obj.prototype.pushBackRect = function (x1, y1, x2, y2) {
          checkArguments(arguments.length, 4, 'pushBackRect', '(number, number, number, number)', [
            [x1, 'number'],
            [y1, 'number'],
            [x2, 'number'],
            [y2, 'number'],
        ...
        PDFNet.Obj.prototype.setStreamDataWithFilter = function (data_buf, filter_chain) {
          checkArguments(arguments.length, 2, 'setStreamDataWithFilter', '(ArrayBuffer|TypedArray, PDFNet.Filter)', [
        ...
        PDFNet.SDFDoc.prototype.initStdSecurityHandlerUString = function (password) {
          checkArguments(arguments.length, 1, 'initStdSecurityHandlerUString', '(string)', [[password, 'string']]);
          return PDFNet.sendWithPromise('SDFDoc.initStdSecurityHandlerUString', { doc: this.id, password: password });
        };
        ...
        PDFNet.SDFDoc.prototype.importObjsWithExcludeList = function (obj_list, exclude_list) {
          checkArguments(arguments.length, 2, 'importObjsWithExcludeList', '(Array<Core.PDFNet.Obj>, Array<Core.PDFNet.Obj>)', [
            [obj_list, 'Array'],
            [exclude_list, 'Array'],
          ]);
        ...
        PDFNet.SDFDoc.prototype.saveMemory = function (flags, header) {
          checkArguments(arguments.length, 2, 'saveMemory', '(number, string)', [
            [flags, 'number'],
            [header, 'string'],
          ]);
        ...
        PDFNet.SDFDoc.prototype.lock = function () {
          var me = this;
          return PDFNet.sendWithPromise('SDFDoc.lock', { doc: this.id }).then(function () {
            lockedObjects.push({
              name: 'SDFDoc',
              id: me.id,
              unlocktype: 'unlock',
        ...
        PDFNet.SDFDoc.prototype.unlock = function () {
          var me = this;
          return PDFNet.sendWithPromise('SDFDoc.unlock', { doc: this.id }).then(function () {
            unregisterLockedObject(me);
          });
        };
        ...
        PDFNet.SDFDoc.prototype.createIndirectStringFromUString = function (str) {
          checkArguments(arguments.length, 1, 'createIndirectStringFromUString', '(string)', [[str, 'string']]);
          return PDFNet.sendWithPromise('SDFDoc.createIndirectStringFromUString', { doc: this.id, str: str }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id);
          });
        };
        ...
        PDFNet.SecurityHandler.prototype.getEncryptionAlgorithmID = function () {
          return PDFNet.sendWithPromise('SecurityHandler.getEncryptionAlgorithmID', { sh: this.id });
        };
        ...
        PDFNet.SecurityHandler.createFromEncCode = function (name, key_len, enc_code) {
          checkArguments(arguments.length, 3, 'createFromEncCode', '(string, number, number)', [
            [name, 'string'],
            [key_len, 'number'],
            [enc_code, 'number'],
          ]);
        ...
        PDFNet.SecurityHandler.prototype.setPermission = function (perm, value) {
          checkArguments(arguments.length, 2, 'setPermission', '(number, boolean)', [
            [perm, 'number'],
            [value, 'boolean'],
          ]);
        ...
        PDFNet.SecurityHandler.prototype.changeRevisionNumber = function (rev_num) {
          ...
          return PDFNet.sendWithPromise('SecurityHandler.changeRevisionNumber', { sh: this.id, rev_num: rev_num });
        };
        ...
        PDFNet.SecurityHandler.prototype.isUserPasswordRequired = function () {
          return PDFNet.sendWithPromise('SecurityHandler.isUserPasswordRequired', { sh: this.id });
        };
        PDFNet.SecurityHandler.prototype.isMasterPasswordRequired = function () {
          return PDFNet.sendWithPromise('SecurityHandler.isMasterPasswordRequired', { sh: this.id });
        };
        ...
        PDFNet.SecurityHandler.prototype.changeUserPasswordUString = function (password) {
          ...
          return PDFNet.sendWithPromise('SecurityHandler.changeUserPasswordUString', { sh: this.id, password: password });
        };
        PDFNet.SecurityHandler.prototype.changeUserPasswordBuffer = function (password_buf) {
          ...
          var password_bufArrayBuffer = getArrayBuffer(password_buf, !1);
          return PDFNet.sendWithPromise('SecurityHandler.changeUserPasswordBuffer', { sh: this.id, password_buf: password_bufArrayBuffer });
        };
        PDFNet.SecurityHandler.prototype.changeMasterPasswordUString = function (password) {
          ...
          return PDFNet.sendWithPromise('SecurityHandler.changeMasterPasswordUString', { sh: this.id, password: password });
        };
        PDFNet.SecurityHandler.prototype.changeMasterPasswordBuffer = function (password_buf) {
          ...
          var password_bufArrayBuffer = getArrayBuffer(password_buf, !1);
          return PDFNet.sendWithPromise('SecurityHandler.changeMasterPasswordBuffer', { sh: this.id, password_buf: password_bufArrayBuffer });
        };
        ...
        PDFNet.OCRModule.applyOCRJsonToPDF = function (dst, json) {
          checkArguments(arguments.length, 2, 'applyOCRJsonToPDF', '(PDFNet.PDFDoc, string)', [
            [dst, 'PDFDoc'],
            [json, 'string'],
          ]);
        ...
        PDFNet.OCRModule.applyOCRXmlToPDF = function (dst, xml) {
          checkArguments(arguments.length, 2, 'applyOCRXmlToPDF', '(PDFNet.PDFDoc, string)', [
            [dst, 'PDFDoc'],
            [xml, 'string'],
          ]);
        ...
        PDFNet.VerificationOptions.prototype.addTrustedCertificate = function (in_certificate_buf, in_trust_flags) {
          ...
          checkArguments(arguments.length, 1, 'addTrustedCertificate', '(ArrayBuffer|TypedArray, number)', [
        ...
        PDFNet.VerificationOptions.prototype.addTrustedCertificates = function (in_P7C_binary_DER_certificates_file_data) {
          checkArguments(arguments.length, 1, 'addTrustedCertificates', '(ArrayBuffer|TypedArray)', [
        ...
        PDFNet.VerificationOptions.prototype.enableModificationVerification = function (in_on_or_off) {
          ...
          return PDFNet.sendWithPromise('VerificationOptions.enableModificationVerification', { self: this.id, in_on_or_off: in_on_or_off });
        };
        PDFNet.VerificationOptions.prototype.enableDigestVerification = function (in_on_or_off) {
          ...
          return PDFNet.sendWithPromise('VerificationOptions.enableDigestVerification', { self: this.id, in_on_or_off: in_on_or_off });
        };
        PDFNet.VerificationOptions.prototype.enableTrustVerification = function (in_on_or_off) {
          ...
          return PDFNet.sendWithPromise('VerificationOptions.enableTrustVerification', { self: this.id, in_on_or_off: in_on_or_off });
        };
        PDFNet.VerificationOptions.prototype.setRevocationProxyPrefix = function (in_str) {
          ...
          return PDFNet.sendWithPromise('VerificationOptions.setRevocationProxyPrefix', { self: this.id, in_str: in_str });
        };
        ...
        PDFNet.VerificationOptions.prototype.enableOnlineCRLRevocationChecking = function (in_on_or_off) {
          ...
          return PDFNet.sendWithPromise('VerificationOptions.enableOnlineCRLRevocationChecking', { self: this.id, in_on_or_off: in_on_or_off });
        };
        PDFNet.VerificationOptions.prototype.enableOnlineOCSPRevocationChecking = function (in_on_or_off) {
          ...
          return PDFNet.sendWithPromise('VerificationOptions.enableOnlineOCSPRevocationChecking', { self: this.id, in_on_or_off: in_on_or_off });
        };
        PDFNet.VerificationOptions.prototype.enableOnlineRevocationChecking = function (in_on_or_off) {
          ...
          return PDFNet.sendWithPromise('VerificationOptions.enableOnlineRevocationChecking', { self: this.id, in_on_or_off: in_on_or_off });
        };
        PDFNet.VerificationResult.prototype.getDigitalSignatureField = function () {
          return PDFNet.sendWithPromise('VerificationResult.getDigitalSignatureField', { self: this.id }).then(function (id) {
            return new PDFNet.DigitalSignatureField(id);
          });
        };
        PDFNet.VerificationResult.prototype.getVerificationStatus = function () {
          return PDFNet.sendWithPromise('VerificationResult.getVerificationStatus', { self: this.id });
        };
        PDFNet.VerificationResult.prototype.getDocumentStatus = function () {
          return PDFNet.sendWithPromise('VerificationResult.getDocumentStatus', { self: this.id });
        };
        ...
        PDFNet.VerificationResult.prototype.getPermissionsStatus = function () {
          return PDFNet.sendWithPromise('VerificationResult.getPermissionsStatus', { self: this.id });
        };
        PDFNet.VerificationResult.prototype.getTrustVerificationResult = function () {
          return PDFNet.sendWithPromise('VerificationResult.getTrustVerificationResult', { self: this.id }).then(function (id) {
        ...
        PDFNet.VerificationResult.prototype.hasTrustVerificationResult = function () {
          return PDFNet.sendWithPromise('VerificationResult.hasTrustVerificationResult', { self: this.id });
        };
        PDFNet.VerificationResult.prototype.getDisallowedChanges = function () {
          return PDFNet.sendWithPromise('VerificationResult.getDisallowedChanges', { self: this.id }).then(function (idArray) {
            for (var retArray = [], i = 0; i < idArray.length; ++i) {
              var id = idArray[i];
              if ('0' === id) return null;
        ...
        PDFNet.VerificationResult.prototype.getDigestAlgorithm = function () {
          return PDFNet.sendWithPromise('VerificationResult.getDigestAlgorithm', { self: this.id });
        };
        PDFNet.VerificationResult.prototype.getDocumentStatusAsString = function () {
          return PDFNet.sendWithPromise('VerificationResult.getDocumentStatusAsString', { self: this.id });
        };
        PDFNet.VerificationResult.prototype.getDigestStatusAsString = function () {
          return PDFNet.sendWithPromise('VerificationResult.getDigestStatusAsString', { self: this.id });
        };
        PDFNet.VerificationResult.prototype.getTrustStatusAsString = function () {
          return PDFNet.sendWithPromise('VerificationResult.getTrustStatusAsString', { self: this.id });
        };
        PDFNet.VerificationResult.prototype.getPermissionsStatusAsString = function () {
          return PDFNet.sendWithPromise('VerificationResult.getPermissionsStatusAsString', { self: this.id });
        };
        PDFNet.VerificationResult.prototype.getUnsupportedFeatures = function () {
          return PDFNet.sendWithPromise('VerificationResult.getUnsupportedFeatures', { self: this.id });
        };
        PDFNet.EmbeddedTimestampVerificationResult.prototype.getVerificationStatus = function () {
          return PDFNet.sendWithPromise('EmbeddedTimestampVerificationResult.getVerificationStatus', { self: this.id });
        };
        PDFNet.EmbeddedTimestampVerificationResult.prototype.getCMSDigestStatus = function () {
          return PDFNet.sendWithPromise('EmbeddedTimestampVerificationResult.getCMSDigestStatus', { self: this.id });
        };
        PDFNet.EmbeddedTimestampVerificationResult.prototype.getMessageImprintDigestStatus = function () {
          return PDFNet.sendWithPromise('EmbeddedTimestampVerificationResult.getMessageImprintDigestStatus', { self: this.id });
        };
        PDFNet.EmbeddedTimestampVerificationResult.prototype.getTrustStatus = function () {
          return PDFNet.sendWithPromise('EmbeddedTimestampVerificationResult.getTrustStatus', { self: this.id });
        };
        PDFNet.EmbeddedTimestampVerificationResult.prototype.getCMSDigestStatusAsString = function () {
          return PDFNet.sendWithPromise('EmbeddedTimestampVerificationResult.getCMSDigestStatusAsString', { self: this.id });
        };
        PDFNet.EmbeddedTimestampVerificationResult.prototype.getMessageImprintDigestStatusAsString = function () {
          return PDFNet.sendWithPromise('EmbeddedTimestampVerificationResult.getMessageImprintDigestStatusAsString', { self: this.id });
        };
        PDFNet.EmbeddedTimestampVerificationResult.prototype.getTrustStatusAsString = function () {
          return PDFNet.sendWithPromise('EmbeddedTimestampVerificationResult.getTrustStatusAsString', { self: this.id });
        };
        PDFNet.EmbeddedTimestampVerificationResult.prototype.hasTrustVerificationResult = function () {
          return PDFNet.sendWithPromise('EmbeddedTimestampVerificationResult.hasTrustVerificationResult', { self: this.id });
        };
        PDFNet.EmbeddedTimestampVerificationResult.prototype.getTrustVerificationResult = function () {
          return PDFNet.sendWithPromise('EmbeddedTimestampVerificationResult.getTrustVerificationResult', { self: this.id }).then(function (id) {
            return createDestroyableObj(PDFNet.TrustVerificationResult, id);
          });
        };
        PDFNet.EmbeddedTimestampVerificationResult.prototype.getCMSSignatureDigestAlgorithm = function () {
          return PDFNet.sendWithPromise('EmbeddedTimestampVerificationResult.getCMSSignatureDigestAlgorithm', { self: this.id });
        };
        PDFNet.EmbeddedTimestampVerificationResult.prototype.getMessageImprintDigestAlgorithm = function () {
          return PDFNet.sendWithPromise('EmbeddedTimestampVerificationResult.getMessageImprintDigestAlgorithm', { self: this.id });
        };
        PDFNet.EmbeddedTimestampVerificationResult.prototype.getUnsupportedFeatures = function () {
          return PDFNet.sendWithPromise('EmbeddedTimestampVerificationResult.getUnsupportedFeatures', { self: this.id });
        };
        PDFNet.TrustVerificationResult.prototype.wasSuccessful = function () {
          return PDFNet.sendWithPromise('TrustVerificationResult.wasSuccessful', { self: this.id });
        };
        PDFNet.TrustVerificationResult.prototype.getResultString = function () {
          return PDFNet.sendWithPromise('TrustVerificationResult.getResultString', { self: this.id });
        };
        PDFNet.TrustVerificationResult.prototype.getTimeOfTrustVerification = function () {
          return PDFNet.sendWithPromise('TrustVerificationResult.getTimeOfTrustVerification', { self: this.id });
        };
        PDFNet.TrustVerificationResult.prototype.getTimeOfTrustVerificationEnum = function () {
          return PDFNet.sendWithPromise('TrustVerificationResult.getTimeOfTrustVerificationEnum', { self: this.id });
        };
        PDFNet.TrustVerificationResult.prototype.hasEmbeddedTimestampVerificationResult = function () {
          return PDFNet.sendWithPromise('TrustVerificationResult.hasEmbeddedTimestampVerificationResult', { self: this.id });
        };
        PDFNet.TrustVerificationResult.prototype.getEmbeddedTimestampVerificationResult = function () {
          return PDFNet.sendWithPromise('TrustVerificationResult.getEmbeddedTimestampVerificationResult', { self: this.id }).then(function (id) {
        ...
        PDFNet.X501AttributeTypeAndValue.prototype.getAttributeTypeOID = function () {
          return PDFNet.sendWithPromise('X501AttributeTypeAndValue.getAttributeTypeOID', { self: this.id }).then(function (id) {
            return createDestroyableObj(PDFNet.ObjectIdentifier, id);
          });
        };
        PDFNet.X501AttributeTypeAndValue.prototype.getStringValue = function () {
          return PDFNet.sendWithPromise('X501AttributeTypeAndValue.getStringValue', { self: this.id });
        };
        ...
        PDFNet.TimestampingResult.prototype.hasResponseVerificationResult = function () {
          return PDFNet.sendWithPromise('TimestampingResult.hasResponseVerificationResult', { self: this.id });
        };
        PDFNet.TimestampingResult.prototype.getResponseVerificationResult = function () {
          return PDFNet.sendWithPromise('TimestampingResult.getResponseVerificationResult', { self: this.id }).then(function (id) {
            return createDestroyableObj(PDFNet.EmbeddedTimestampVerificationResult, id);
          });
        };
        ...
        PDFNet.RadioButtonGroup.create = function (doc, field_name) {
          'undefined' === typeof field_name && (field_name = '');
          checkArguments(arguments.length, 1, 'create', '(PDFNet.PDFDoc, string)', [
            [doc, 'PDFDoc'],
            [field_name, 'string'],
          ]);
        ...
        PDFNet.RadioButtonGroup.prototype.addGroupButtonsToPage = function (page) {
          ...
          return PDFNet.sendWithPromise('RadioButtonGroup.addGroupButtonsToPage', { group: this.id, page: page.id });
        };
        ...
        PDFNet.WebFontDownloader.setCustomWebFontURL = function (url) {
          ...
          return PDFNet.sendWithPromise('webFontDownloaderSetCustomWebFontURL', { url: url });
        };
        var getUrlAsBuffer = function (jsUrl, options) {
            ...
            return new Promise(
              function (resolve, reject) {
                ...
                if (customHeaders) for (var header in customHeaders) xhr.setRequestHeader(header, customHeaders[header]);
                xhr.send();
              },
              function () {
                xhr.abort();
            ...
            for (minNum = 0; minNum < maxNum; minNum++) {
              ...
              if ('OptionBase' === argType) {
                if (arg$jscomp$0)
                  ...
                  } else throwParaTypeError(minNum, arg$jscomp$0.name, 'object');
              } else
                'Array' === argType
                  ? Array.isArray(arg$jscomp$0) || inputArgNum(arg$jscomp$0, minNum, 'Array')
                  : 'ArrayBuffer' === argType
                  ? exports.isArrayBuffer(arg$jscomp$0) ||
                    exports.isArrayBuffer(arg$jscomp$0.buffer) ||
                    inputArgNum(arg$jscomp$0, minNum, 'ArrayBuffer|TypedArray')
                  : 'ArrayAsBuffer' === argType
                  ? Array.isArray(arg$jscomp$0) ||
                    exports.isArrayBuffer(arg$jscomp$0) ||
                    exports.isArrayBuffer(arg$jscomp$0.buffer) ||
                    inputArgNum(arg$jscomp$0, minNum, 'ArrayBuffer|TypedArray')
                  : 'PDFDoc' === argType || 'SDFDoc' === argType || 'FDFDoc' === argType
                  ? arg$jscomp$0 instanceof PDFNet.PDFDoc ||
                    arg$jscomp$0 instanceof PDFNet.SDFDoc ||
                    arg$jscomp$0 instanceof PDFNet.FDFDoc ||
                    inputArgNum(arg$jscomp$0, minNum, 'PDFDoc|SDFDoc|FDFDoc')
                  : 'Structure' === argType
                  ? arg$jscomp$0 instanceof argInfo[2] || !arg$jscomp$0 || arg$jscomp$0.name === argInfo[3] || inputArgNum(arg$jscomp$0, minNum, argInfo[3])
                  : 'OptionObject' === argType
                  ? arg$jscomp$0 instanceof argInfo[2] ||
                    ('object' === _typeof(arg$jscomp$0) && arg$jscomp$0.name
                      ? arg$jscomp$0.name !== argInfo[4] && throwParaTypeError(minNum, arg$jscomp$0.name, argInfo[3])
                      : throwParaTypeError(minNum, _typeof(arg$jscomp$0), argInfo[3]))
                  : 'Object' === argType
                  ? arg$jscomp$0 instanceof argInfo[2] || inputArgNum(arg$jscomp$0, minNum, argInfo[3])
                  : 'const char* = 0' === argType
                  ? 'string' !== typeof arg$jscomp$0 && null !== arg$jscomp$0 && throwParaTypeError(minNum, _typeof(arg$jscomp$0), 'string')
          ...
          getArrayBuffer = function (buffer, arrayAsBuffer) {
            ...
            exports.isArrayBuffer(bufferArrayBuffer) ||
              ...
              buffer.byteLength < bufferArrayBuffer.byteLength &&
                (bufferArrayBuffer = bufferArrayBuffer.slice(buffer.byteOffset, buffer.byteOffset + buffer.byteLength)));
        ...
        var createDestroyableObj = function (constructor, id, type) {
          ...
          avoidCleanup = function (id) {
            ...
            if (-1 != objIndex)
              for (createdObjects.splice(objIndex, 1), i = deallocStackCounter.length - 1; 0 <= i; i--)
        ...
        PDFNet.runGeneratorWithoutCleanup = function (generator, license_key) {
          ...
          checkArguments(arguments.length, 1, 'runGeneratorWithoutCleanup', '(object, string)', [
            [generator, 'object'],
            [license_key, 'string'],
          ]);
        ...
        PDFNet.runGeneratorWithCleanup = function (generator, license_key) {
          'undefined' === typeof license_key && (license_key = '');
          checkArguments(arguments.length, 1, 'runGeneratorWithCleanup', '(object, string)', [
            [generator, 'object'],
            [license_key, 'string'],
          ]);
        ...
        PDFNet.displayAllocatedObjects = function () {
          ...
          else for (var i = 0; i < createdObjects.length; i++) console.log(createdObjects[i]);
        ...
        PDFNet.endDeallocateStack = function () {
          ...
          if ('undefined' !== typeof unlockStackPos && 0 !== lockedObjects.length && lockedObjects.length !== unlockStackPos)
            for (; lockedObjects.length > unlockStackPos; ) {
              ...
              objToUnlock = PDFNet.sendWithPromise(objToUnlock.name + '.' + objToUnlock.unlocktype, { doc: objToUnlock.id });
          ...
          if ('undefined' !== typeof deallocStackPos && 0 !== createdObjects.length && createdObjects.length !== deallocStackPos)
            for (; createdObjects.length > deallocStackPos; )
              (unlockStackPos = createdObjects.pop()),
                (unlockStackPos = PDFNet.sendWithPromise(unlockStackPos.name + '.destroy', { auto_dealloc_obj: unlockStackPos.id })),
        ...
        PDFNet.deallocateAllObjects = function () {
          ...
          for (deallocStackCounter = []; lockedObjects.length; )
            (objToUnlock = lockedObjects.pop()),
              (unlockPromise = PDFNet.sendWithPromise(objToUnlock.name + '.' + objToUnlock.unlocktype, { doc: objToUnlock.id })),
          ...
          for (; createdObjects.length; ) {
            ...
            objToDealloc = PDFNet.sendWithPromise(objToDealloc.name + '.destroy', { auto_dealloc_obj: objToDealloc.id });
        ...
        PDFNet.Redactor.redact = function (doc, red_arr, appearance, ext_neg_mode, page_coord_sys) {
          ...
          'undefined' === typeof appearance.positive_overlay_color
            ...
            : 'undefined' !== typeof appearance.positive_overlay_color.id && (appearance.positive_overlay_color = appearance.positive_overlay_color.id);
          'undefined' === typeof appearance.negative_overlay_color
            ? (appearance.negative_overlay_color = void 0)
            : 'undefined' !== typeof appearance.negative_overlay_color.id && (appearance.negative_overlay_color = appearance.negative_overlay_color.id);
          ...
          'undefined' === typeof appearance.font
            ...
            : 'undefined' !== typeof appearance.font.id && (appearance.font = appearance.font.id);
          ...
          'undefined' === typeof appearance.text_color
            ...
            : 'undefined' !== typeof appearance.text_color.id && (appearance.text_color = appearance.text_color.id);
          ...
          'undefined' === typeof appearance.redacted_content_color
            ...
            : 'undefined' !== typeof appearance.redacted_content_color.id && (appearance.redacted_content_color = appearance.redacted_content_color.id);
          'undefined' === typeof ext_neg_mode && (ext_neg_mode = !0);
          'undefined' === typeof page_coord_sys && (page_coord_sys = !0);
          checkArguments(arguments.length, 2, 'redact', '(PDFNet.PDFDoc, Array<Core.PDFNet.Redaction>, object, boolean, boolean)', [
            [doc, 'PDFDoc'],
            [red_arr, 'Array'],
            [appearance, 'object'],
        ...
        PDFNet.Highlights.prototype.getCurrentQuads = function () {
          return PDFNet.sendWithPromise('Highlights.getCurrentQuads', {
            ...
            for (var retArray = [], currQuad, i = 0; i < id.length; i += 8)
              (currQuad = PDFNet.QuadPoint(id[i + 0], id[i + 1], id[i + 2], id[i + 3], id[i + 4], id[i + 5], id[i + 6], id[i + 7])), retArray.push(currQuad);
            return retArray;
          });
        };
        PDFNet.TextSearch.prototype.run = function () {
          ...
          return PDFNet.sendWithPromise('TextSearch.run', { ts: this.id }).then(function (searchObj) {
        ...
        PDFNet.PDFDoc.createFromURL = function (url, options) {
          ...
          checkArguments(arguments.length, 1, 'createFromURL', '(string, object)', [
            [url, 'string'],
            [options, 'object'],
          ]);
        ...
        PDFNet.PDFDraw.prototype.exportBuffer = function (page, format, encoder_params) {
          ...
          checkArguments(arguments.length, 1, 'exportBuffer', '(PDFNet.Page, string, PDFNet.Obj)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [format, 'string'],
        ...
        PDFNet.PDFDoc.prototype.convertToXod = function (options) {
          ...
          checkArguments(arguments.length, 0, 'convertToXod', '(PDFNet.Obj)', [
            [options, 'OptionObject', PDFNet.Obj, 'Obj', 'PDFNet.Convert.XODOutputOptions'],
          ]);
        ...
        PDFNet.PDFDraw.prototype.getBitmap = function (page, pix_fmt, demult) {
          checkArguments(arguments.length, 3, 'getBitmap', '(PDFNet.Page, number, boolean)', [
            [page, 'Object', PDFNet.Page, 'Page'],
            [pix_fmt, 'number'],
            [demult, 'boolean'],
          ]);
        ...
        PDFNet.Matrix2D.create = function (a, b, c, d, h, v) {
          ...
          void 0 == h && (h = 0);
          void 0 == v && (v = 0);
          checkArguments(arguments.length, 0, 'create', '(number, number, number, number, number, number)', [
            [a, 'number'],
            [b, 'number'],
            [c, 'number'],
            [d, 'number'],
        ...
        PDFNet.PDFDoc.prototype.getPDFDoc = function () {
          return PDFNet.sendWithPromise('GetPDFDoc', { doc: this.id }).then(function (id) {
        ...
        PDFNet.TextExtractor.prototype.getHighlights = function (char_ranges) {
          ...
          return PDFNet.sendWithPromise('TextExtractor.getHighlights', {
            ...
            return '0' == id ? null : new PDFNet.Highlights(id);
          });
        };
        PDFNet.SecurityHandler.prototype.changeUserPasswordNonAscii = function (password) {
          ...
          return PDFNet.sendWithPromise('SecurityHandler.changeUserPasswordNonAscii', { sh: this.id, password: password, pwd_length: password.length });
        };
        PDFNet.SecurityHandler.prototype.changeMasterPasswordNonAscii = function (password) {
          ...
          return PDFNet.sendWithPromise('SecurityHandler.changeMasterPasswordNonAscii', { sh: this.id, password: password, pwd_length: password.length });
        };
        ...
        PDFNet.SecurityHandler.prototype.initPasswordNonAscii = function (password) {
          ...
          return PDFNet.sendWithPromise('SecurityHandler.initPasswordNonAscii', { sh: this.id, password: password, pwd_length: password.length });
        };
        PDFNet.Element.prototype.getBBox = function () {
          ...
          return PDFNet.sendWithPromise('Element.getBBox', { e: this.id }).then(function (id) {
            me.yieldFunction = void 0;
            return new PDFNet.Rect(id);
          });
        };
        ...
        PDFNet.Image.createFromURL = function (doc, url, encoder_hints, options) {
          'undefined' === typeof encoder_hints && (encoder_hints = new PDFNet.Obj('0'));
          'undefined' === typeof options && (options = {});
          checkArguments(arguments.length, 2, 'createFromURL', '(PDFNet.PDFDoc, string, PDFNet.Obj, object)', [
            [doc, 'PDFDoc'],
            [url, 'string'],
            [encoder_hints, 'Object', PDFNet.Obj, 'Obj'],
            [options, 'object'],
        ...
        PDFNet.PDFDoc.prototype.addStdSignatureHandlerFromURL = function (pkcs12_file, pkcs12_pass) {
          checkArguments(arguments.length, 2, 'addStdSignatureHandlerFromURL', '(string, string)', [
            [pkcs12_file, 'string'],
            [pkcs12_pass, 'string'],
          ]);
          var me = this;
        ...
        PDFNet.PDFDoc.prototype.addStdSignatureHandlerFromBufferWithDoc = function (pkcs12_buffer, pkcs12_pass, doc) {
          checkArguments(arguments.length, 3, 'addStdSignatureHandlerFromBufferWithDoc', '(ArrayBuffer|TypedArray, string, PDFNet.PDFDoc)', [
            [pkcs12_buffer, 'ArrayBuffer'],
            [pkcs12_pass, 'string'],
            [doc, 'PDFDoc'],
          ]);
        ...
        PDFNet.Filter.createURLFilter = function (url, options) {
          'undefined' === typeof options && (options = {});
          checkArguments(arguments.length, 1, 'createURLFilter', '(string, object)', [
            [url, 'string'],
            [options, 'object'],
          ]);
          return getUrlAsBuffer(url, options).then(function (data) {
        ...
        PDFNet.Filter.createFlateEncode = function (input_filter, compression_level, buf_sz) {
          ...
          checkArguments(arguments.length, 0, 'createFlateEncode', '(PDFNet.Filter, number, number)', [
        ...
        PDFNet.PDFDoc.prototype.importPages = function (page_arr, import_bookmarks) {
          ...
          checkArguments(arguments.length, 1, 'importPages', '(Array<Core.PDFNet.Page>, boolean)', [
            [page_arr, 'Array'],
        ...
        PDFNet.PDFACompliance.createFromUrl = function (convert, url, pwd, conform, excep, max_ref_objs, first_stop) {
          ...
          checkArguments(arguments.length, 2, 'createFromUrl', '(boolean, string, string, number, ArrayBuffer|TypedArray, number, boolean)', [
            [convert, 'boolean'],
            [url, 'string'],
            [pwd, 'string'],
            [conform, 'number'],
        ...
        PDFNet.Optimizer.optimize = function (doc, optimizerSettings) {
          ...
          checkArguments(arguments.length, 1, 'optimize', '(PDFNet.PDFDoc, object)', [
            [doc, 'PDFDoc'],
        ...
        PDFNet.VerificationOptions.prototype.addTrustedCertificateFromURL = function (url, options, trust_flags) {
          ...
          checkArguments(arguments.length, 1, 'addTrustedCertificateFromURL', '(string, object, number)', [
            [url, 'string'],
            [options, 'object'],
            [trust_flags, 'number'],
          ]);
        ...
        PDFNet.DigitalSignatureField.prototype.signOnNextSaveFromURL = function (url, in_password, options) {
          'undefined' === typeof options && (options = {});
          checkArguments(arguments.length, 2, 'signOnNextSaveFromURL', '(string, string, object)', [
            [url, 'string'],
            [in_password, 'string'],
            [options, 'object'],
          ]);
        ...
        PDFNet.DigitalSignatureField.prototype.getCertPathsFromCMS = function () {
          ...
          return PDFNet.sendWithPromise('DigitalSignatureField.getCertPathsFromCMS', { self: this }).then(function (arrArray) {
        ...
        PDFNet.PDFDoc.prototype.requirePage = function (page_number) {
          ...
          if (0 >= page_number)
            throw Error(
              "1st input argument '" + page_number + "' in function 'requirePage' is invalid. Expected number between 1 and number of pages in the document.",
            );
        ...
        PDFNet.beginOperation = function (optionsObj) {
          'undefined' === typeof optionsObj
            ...
            : 'undefined' === typeof optionsObj.allowMultipleInstances &&
              console.log("Warning: passing in options object without value 'allowMultipleInstances'");
          ...
          if (1 < arguments.length)
            throw new RangeError(
              arguments.length + " arguments passed into function 'beginOperation'. Expected 0 to 1 arguments. Function Signature: beginOperation(optObj = {})",
            );
        ...
        PDFNet.runWithCleanup = function (callback, license_key) {
          'undefined' === typeof license_key && (license_key = '');
          checkArguments(arguments.length, 1, 'runWithCleanup', '(function, string)', [
            [callback, 'function'],
            [license_key, 'string'],
          ]);
          var result,
        ...
        PDFNet.initialize = function (licenseKey, pdfBackendType) {
          ...
          checkArguments(arguments.length, 0, 'initialize', '(string, string)', [
            [licenseKey, 'string'],
          ...
          if (!finishedInitializeCapability) {
            ...
            var finishInit = function (pdfBackendType) {
              ...
              exports.Core.initPDFWorkerTransports(pdfBackendType, workerHandlers, licenseKey).then(
                function (transport) {
            ...
            pdfBackendType && 'auto' !== pdfBackendType
              ...
              : exports.Core.getDefaultBackendType().then(finishInit, function (e) {
                  finishedInitializeCapability.reject(e);
                });
          }
