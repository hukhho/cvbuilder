(function () {
    ...
    function (c) {
      ...
      a.prototype.executeOnSettledCallbacks_ = function () {
        if (null != this.onSettledCallbacks_) {
          for (var a = 0; a < this.onSettledCallbacks_.length; ++a) d.asyncExecute(this.onSettledCallbacks_[a]);
      ...
      a.race = function (b) {
        return new a(function (a, d) {
          for (var g = $jscomp.makeIterator(b), k = g.next(); !k.done; k = g.next()) l(k.value).callWhenSettled_(a, d);
        });
      };
      a.all = function (b) {
        ...
        return g.done
          ...
          : new a(function (a, b) {
              ...
              var c = [],
                x = 0;
              do c.push(void 0), x++, l(g.value).callWhenSettled_(k(c.length - 1), b), (g = d.next());
              while (!g.done);
            });
      };
      return a;
  ...
  (function (c) {
    ...
    b.r = function (b) {
      'undefined' !== typeof Symbol && Symbol.toStringTag && Object.defineProperty(b, Symbol.toStringTag, { value: 'Module' });
      ...
      (function (g) {
        ...
        var c = d.Module,
          ...
          z = function (a) {
            ...
            a in d.AsyncFSHack.readCalls || (d.AsyncFSHack.readCalls[a] = new k(d.AsyncFSHack.read_total, d.AsyncFSHack.q));
          },
          A = function (a) {
            var n = d.AsyncFSHack.readCalls[a];
            ++n.fs_read_counter;
            n.fs_read_counter >= n.fs_read_total &&
              (n.needCallback ? c._finish_do_call_operation(n.fsQ) : (d.AsyncFSHack.readingAsyncFS = 0), delete d.AsyncFSHack.readCalls[a]);
          },
        ...
        C.prototype = {
          ...
          downloadChunk: function (a, b) {
            ...
            if (n) {
              ...
              if (this.customHeaders) for (var f in this.customHeaders) h.setRequestHeader(f, this.customHeaders[f]);
              h.send();
              var e = this;
              h.onload = function () {
                if (200 === h.status || 206 === h.status) {
                  ...
                  e.writeChunk(b, a);
                } else window.parent.parentWarn('Failed to load data from' + e.url), (b = new Int8Array(0));
        ...
        var v = {
          ...
          D = function (a) {
            ...
            return 'object' === typeof a && null !== a && ('[object File]' === b || '[object Blob]' === b);
          };
      }).call(this, l(3));
    },
    function (c, b, l) {
    ...
    function (c, b, l) {
      ...
      var x = !1,
        ...
        E = function (b) {
          ...
          if ('NewDoc' === e && c)
            (e = c.value),
              'url' === c.type
                ? ((e = Object(a.b)(e.url, e.size, e.customHeaders, e.withCredentials)), (v[f] = e), (c.value.docDevId = e))
            ...
            'GetCanvas' === e && c
              ? ((f = c.docId),
                f in p &&
                  ...
                  e in d.Module.docs &&
                    ((e = d.Module.docs[e]),
                    'chunkStorage' in e && ((c = d.Module.GetRequiredChunkOffsetArray(f, c.pageIndex + 1)), c.length && e.chunkStorage.updateCache(c)))))
      ...
      var D = function (a) {
        window.parent.loadThreadedBackend(a, { 'Wasm.wasm': 1e7, 'Wasm.js': 15e4 }, window);
        this.eventListeners = [];
      };
      D.prototype = {
      ...
      var t = (function () {
        ...
        n = function m(a) {
          'object' === g(a.data) && 'action' in a.data && 'workerLoaded' === a.data.action && (t.resolve(r), r.removeEventListener('message', m));
        };
      window.addEventListener('message', function (a) {
        var b = a.data;
        a.origin === window.location.origin && 'loadWasmWorker' === b.action
          ? ((k = b.workerFolder), (r = new D(''.concat(b.wasmSource, 'PDFNetThreaded'))), q || r.addEventListener('message', n))
          : r.postMessage(b);
      });
