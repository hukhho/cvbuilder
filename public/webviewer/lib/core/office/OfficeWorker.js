...
*****************************************************************************/
  ...
  $jscomp.polyfill = function (b, e, g, a) {
    if (e) {
      g = $jscomp.global;
      b = b.split('.');
    ...
    function (b) {
      function e() {
        ...
        try {
          ...
          if (2 != a.get(c) || 3 != a.get(d)) return !1;
          a.delete(c);
          a.set(d, 4);
          return !a.has(c) && 4 == a.get(d);
        } catch (v) {
          return !1;
        }
      }
      ...
      function a(c) {
        if (!$jscomp.owns(c, h)) {
          var d = new g();
          $jscomp.defineProperty(c, h, { value: d });
        }
      }
      function f(c) {
        var d = Object[c];
      ...
      d.prototype.set = function (c, d) {
        a(c);
        if (!$jscomp.owns(c, h)) throw Error('WeakMap key fail: ' + c);
        c[h][this.id_] = d;
        return this;
      };
      d.prototype.get = function (c) {
        return $jscomp.owns(c, h) ? c[h][this.id_] : void 0;
      };
      d.prototype.has = function (c) {
        return $jscomp.owns(c, h) && $jscomp.owns(c[h], this.id_);
      };
      d.prototype.delete = function (c) {
        return $jscomp.owns(c, h) && $jscomp.owns(c[h], this.id_) ? delete c[h][this.id_] : !1;
      };
      return d;
    },
    'es6',
  ...
  $jscomp.polyfill(
    ...
    function (b) {
      ...
      a.prototype.forEach = function (c, d) {
        for (var a = this.entries(), f; !(f = a.next()).done; ) (f = f.value), c.call(d, f[1], f[0], this);
      };
      a.prototype[Symbol.iterator] = a.prototype.entries;
      var f = function (c, a) {
          var f = a && typeof a;
          'object' == f || 'function' == f ? (g.has(a) ? (f = g.get(a)) : ((f = '' + ++d), g.set(a, f))) : (f = 'p_' + a);
          var b = c.data_[f];
          if (b && $jscomp.owns(c.data_, f))
            for (c = 0; c < b.length; c++) {
              var e = b[c];
              if ((a !== a && e.key !== e.key) || a === e.key) return { id: f, list: b, index: c, entry: e };
            }
          return { id: f, list: b, index: -1, entry: void 0 };
        },
        h = function (c, d) {
          var a = c.head_;
          return $jscomp.iteratorPrototype(function () {
            if (a) {
              ...
              for (; a.next != a.head; ) return (a = a.next), { done: !1, value: d(a) };
              a = null;
            }
  ...
  $jscomp.polyfill(
    ...
    function (b) {
      ...
      e.prototype.asyncExecuteFunction = function (f) {
        a(f, 0);
      };
      ...
      f.prototype.then = function (a, d) {
        ...
        var b,
          e,
          g = new f(function (a, c) {
            b = a;
            e = c;
          });
        this.callWhenSettled_(c(a, b), c(d, e));
        return g;
      };
      ...
      f.race = function (a) {
        return new f(function (d, c) {
          for (var f = $jscomp.makeIterator(a), b = f.next(); !b.done; b = f.next()) g(b.value).callWhenSettled_(d, c);
        });
      };
      f.all = function (a) {
        ...
        return c.done
          ...
          : new f(function (a, f) {
              ...
              var e = [],
                h = 0;
              do e.push(void 0), h++, g(c.value).callWhenSettled_(b(e.length - 1), f), (c = d.next());
              while (!c.done);
            });
      };
      return f;
    ...
    function (b) {
      return b
        ...
        : function (b, g) {
            ...
            for (var f = b.length; 0 < f && 0 < g; ) if (a[--g] != b[--f]) return !1;
            return 0 >= f;
          };
    },
    'es6',
  ...
  $jscomp.setPrototypeOf =
    'function' == typeof Object.setPrototypeOf
      ...
      ? function (b, e) {
          b.__proto__ = e;
          if (b.__proto__ !== e) throw new TypeError(b + ' is not extensible');
          return b;
        }
      : null;
  $jscomp.polyfill(
    ...
    'function' == typeof Object.assign
      ...
      : function (b, e) {
          for (var g = 1; g < arguments.length; g++) {
            var a = arguments[g];
            if (a) for (var f in a) $jscomp.owns(a, f) && (b[f] = a[f]);
          }
          return b;
        };
  $jscomp.polyfill(
  ...
  (function (b) {
    function e(a) {
      ...
      var f = (g[a] = { i: a, l: !1, exports: {} });
      b[a].call(f.exports, f, f.exports, e);
      f.l = !0;
      return f.exports;
    }
    var g = {};
    ...
    e.c = g;
    e.d = function (a, f, b) {
      e.o(a, f) || Object.defineProperty(a, f, { enumerable: !0, get: b });
    };
    e.r = function (a) {
    ...
    e.t = function (a, f) {
      f & 1 && (a = e(a));
      if (f & 8 || (f & 4 && 'object' === typeof a && a && a.__esModule)) return a;
      var b = Object.create(null);
      e.r(b);
      Object.defineProperty(b, 'default', { enumerable: !0, value: a });
      if (f & 2 && 'string' != typeof a)
        for (var g in a)
          e.d(
            b,
            g,
    ...
    function (b, e, g) {
      ...
      var a = g(1),
        f = function (d, c) {
          Object(a.a)('disableLogs') || (c ? console.warn(d + ': ' + c) : console.warn(d));
        },
        h = function (a, c, b, e) {
          void 0 === e && (e = !1);
          var d = b.pop();
          b = b.length ? b.join(', ') + ' and ' + d : d;
          e
            ? f("'" + c + "' will be deprecated in version " + a + '. Please use ' + b + ' instead.')
            : f("'" + c + "' is deprecated since version " + a + '. Please use ' + b + ' instead.');
        },
        k = function (a, c) {};
    },
    function (b, e, g) {
    ...
    function (b, e, g) {
      ...
      var a = g(7),
        ...
        n = !1,
        u = function (a, b) {
          n || (c(d.basePath + 'decode.min.js'), (n = !0));
        ...
        v = function (c, d) {
          return Object(a.a)(void 0, void 0, Promise, function () {
            ...
            return Object(a.b)(this, function (a) {
              switch (a.label) {
                case 0:
                  return n ? [3, 2] : [4, Object(h.a)(self.Core.getWorkerPath() + 'external/decode.min.js', 'Failed to download decode.min.js', window)];
                case 1:
                  a.sent(), (n = !0), (a.label = 2);
                case 2:
                  return (b = self.BrotliDecode(Object(k.b)(c))), [2, d ? b : Object(k.a)(b)];
              }
            });
          });
        };
      (function () {
        ...
        a.prototype.End = function () {
          if (this.remainingDataArrays.length) {
            for (var a = this.arrays, c = 0, d = 0; d < a.length; ++d) c += a[d].length;
            c = new Uint8Array(c);
            var b = 0;
      ...
      var q = !1,
        r = function (a) {
          q || (c(d.basePath + 'pako_inflate.min.js'), (q = !0));
          var b = 10;
          if ('string' === typeof a) {
            if (a.charCodeAt(3) & 8) {
        ...
        l = function (a, c) {
          return c ? a : Object(k.a)(a);
        },
        p = function (a) {
          var d = !a.shouldOutputArray,
            b = new XMLHttpRequest();
          b.open('GET', a.url, a.isAsync);
          var e = d && b.overrideMimeType;
          b.responseType = e ? 'text' : 'arraybuffer';
          e && b.overrideMimeType('text/plain; charset=x-user-defined');
          b.send();
          var g = function () {
            var g = Date.now();
            var h = e ? b.responseText : new Uint8Array(b.response);
            Object(f.a)('worker', 'Result length is ' + h.length);
            h.length < a.compressedMaximum
              ? ((h = a.decompressFunction(h, a.shouldOutputArray)),
                ...
                c && Object(f.a)('worker', 'Decompressed length is ' + h.length))
              : d && (h = Object(k.a)(h));
            c && Object(f.a)('worker', a.url + ' Decompression took ' + (Date.now() - g));
            return h;
          };
          if (a.isAsync)
            var h = new Promise(function (c, d) {
              b.onload = function () {
                200 === this.status || 0 === this.status ? c(g()) : d('Download Failed ' + a.url);
              };
              b.onerror = function () {
                d('Network error occurred ' + a.url);
              };
            });
          else {
            if (200 === b.status || 0 === b.status) return g();
        ...
        w = function (a) {
          var d = a.lastIndexOf('/');
          -1 === d && (d = 0);
          var b = a.slice(d).replace('.', '.br.');
          c || (b.endsWith('.js.mem') ? (b = b.replace('.js.mem', '.mem')) : b.endsWith('.js') && (b = b.concat('.mem')));
          return a.slice(0, d) + b;
        },
        y = function (a, c) {
          var b = a.lastIndexOf('/');
          -1 === b && (b = 0);
          var d = a.slice(b).replace('.', '.gz.');
          c.url = a.slice(0, b) + d;
          c.decompressFunction = r;
          return p(c);
        },
        m = function (a, b) {
          b.url = w(a);
          b.decompressFunction = c ? u : v;
          return p(b);
        },
        t = function (a, c) {
          a.endsWith('.js.mem') ? (a = a.slice(0, -4)) : a.endsWith('.mem') && (a = a.slice(0, -4) + '.js.mem');
          c.url = a;
          c.decompressFunction = l;
          return p(c);
        },
        x = function (a, c, b, d) {
        ...
        A = function (a, c, b) {
          ...
          if (b.isAsync) {
            var e = c[0](a, b);
            for (d = 1; d < c.length; ++d) e = x(e, a, b, c[d]);
            return e;
          }
    ...
    function (b, e, g) {
      ...
      var a = function (a) {
        ...
        f = function (a) {
          if ('string' !== typeof a) {
            for (var b = '', d = 0, c = a.length, f; d < c; ) (f = a.subarray(d, d + 1024)), (d += 1024), (b += String.fromCharCode.apply(null, f));
            return b;
          }
          return a;
        };
    ...
    function (b, e, g) {
      function a(a, b, d) {
        return new Promise(function (c) {
          ...
          e.src = a;
          d.document.getElementsByTagName('head')[0].appendChild(e);
        });
      }
      g.d(e, 'a', function () {
        return a;
    ...
    function (b, e, g) {
      function a(a, c, b) {
        function d(n) {
          g = g || Date.now();
          return n
            ? (Object(f.a)('load', 'Try instantiateStreaming'),
              fetch(Object(h.a)(a))
                .then(function (a) {
                  return WebAssembly.instantiateStreaming(a, c);
                })
                .catch(function (b) {
                  Object(f.a)('load', 'instantiateStreaming Failed ' + a + ' message ' + b.message);
                  return d(!1);
                }))
            : Object(h.b)(a, b, !0, !0).then(function (a) {
                e = Date.now();
                Object(f.a)('load', 'Request took ' + (e - g) + ' ms');
                return WebAssembly.instantiate(a, c);
              });
        }
        var e, g;
        return d(!!WebAssembly.instantiateStreaming).then(function (a) {
          Object(f.a)('load', 'WASM compilation took ' + (Date.now() - (e || g)) + ' ms');
          return a;
        });
      }
      g.d(e, 'a', function () {
    ...
    function (b, e, g) {
      function a(a, b, d, c) {
        ...
        return new (d || (d = Promise))(function (d, e) {
          function g(a) {
            try {
              l(c.next(a));
            } catch (w) {
          ...
          function l(a) {
            a.done ? d(a.value) : f(a.value).then(g, h);
          }
      ...
      function f(a, b) {
        ...
        function c(c) {
          ...
          for (; f; )
            try {
              if (
                ((e = 1), g && (h = c[0] & 2 ? g['return'] : c[0] ? g['throw'] || ((h = g['return']) && h.call(g), 0) : g.next) && !(h = h.call(g, c[1])).done)
              )
                return h;
              ...
              switch (c[0]) {
                ...
                case 7:
                  ...
                  continue;
                default:
                  if (!((h = f.trys), (h = 0 < h.length && h[h.length - 1])) && (6 === c[0] || 2 === c[0])) {
                    f = 0;
                    continue;
                  }
                  if (3 === c[0] && (!h || (c[1] > h[0] && c[1] < h[3]))) f.label = c[1];
                  else if (6 === c[0] && f.label < h[1]) (f.label = h[1]), (h = c);
                  else if (h && f.label < h[2]) (f.label = h[2]), f.ops.push(c);
                  else {
                    h[2] && f.ops.pop();
                    f.trys.pop();
                    continue;
    ...
    function (b, e, g) {
      ...
      var a = g(2),
        ...
        d = function (b, d, e) {
          if (Object(h.a)() && !e) {
            self.Module.instantiateWasm = function (a, c) {
              return Object(f.a)(b + 'Wasm.wasm', a, d['Wasm.wasm']).then(function (a) {
                c(a.instance);
              });
            };
            if (d.disableObjectURLBlobs) {
              importScripts(b + 'Wasm.js');
              return;
            }
            e = Object(a.b)(b + 'Wasm.js.mem', d['Wasm.js.mem'], !1, !1);
          } else {
            if (d.disableObjectURLBlobs) {
              importScripts((self.Module.asmjsPrefix ? self.Module.asmjsPrefix : '') + b + '.js');
              return;
            }
            e = Object(a.b)((self.Module.asmjsPrefix ? self.Module.asmjsPrefix : '') + b + '.js.mem', d['.js.mem'], !1);
            var c = Object(a.c)((self.Module.memoryInitializerPrefixURL ? self.Module.memoryInitializerPrefixURL : '') + b + '.mem', d['.mem'], !0, !0);
            self.Module.memoryInitializerRequest = new k(c);
          }
    ...
    function (b, e, g) {
      ...
      var h = !!navigator.userAgent.match(/Edge/i) || (navigator.userAgent.match(/Edg\/(.*?)/) && a.navigator.userAgent.match(/Chrome\/(.*?) /));
      (function () {
        if (!h) return null;
      ...
      var k = (function () {
        ...
        d = /^((?!chrome|android).)*safari/i.test(a.navigator.userAgent) || (/^((?!chrome|android).)*$/.test(a.navigator.userAgent) && e),
      ...
      var n = /Mac OS X 10_13_6.*\(KHTML, like Gecko\)$/.test(a.navigator.userAgent),
        u = a.navigator.userAgent.match(/(iPad|iPhone).+\sOS\s((\d+)(_\d)*)/i)
          ? 14 <= parseInt(a.navigator.userAgent.match(/(iPad|iPhone).+\sOS\s((\d+)(_\d)*)/i)[3], 10)
          : !1,
        v = !(!self.WebAssembly || !self.WebAssembly.validate),
        q = -1 < a.navigator.userAgent.indexOf('Edge/16') || -1 < a.navigator.userAgent.indexOf('MSAppHost'),
        r = function () {
          return v && !q && !(!u && ((d && 14 > k) || n));
        };
    },
    function (b, e, g) {
      b.exports = g(14);
    ...
    function (b, e, g) {
      (function (a, b) {
        ...
        (function (a) {
          ...
          function r(a, b) {
            a.state_ === A && ((a.state_ = D), (a.data_ = b), c(w, a));
          }
          function l(a, b) {
            a.state_ === A && ((a.state_ = D), (a.data_ = b), c(y, a));
          }
          function p(a) {
            var b = a.then_;
            a.then_ = void 0;
          ...
          'undefined' !== typeof exports && exports
            ? ((exports.Promise = x ? t : m), (exports.Polyfill = m))
            : 'function' === typeof define && g(19)
            ? define(function () {
                return x ? t : m;
              })
            : x || (a.Promise = m);
          ...
          m.prototype = {
            ...
            then: function (a, b) {
              ...
              this.state_ === z || this.state_ === E ? c(h, a) : this.then_.push(a);
              return a.then;
            },
            catch: function (a) {
          ...
          m.all = function (a) {
            ...
            return new this(function (b, c) {
              ...
              for (var f = [], e = 0, g = 0, h; g < a.length; g++) (h = a[g]) && 'function' === typeof h.then ? h.then(d(g), c) : (f[g] = h);
              e || b(f);
            });
          };
          m.race = function (a) {
            ...
            return new this(function (b, c) {
              for (var d = 0, f; d < a.length; d++) (f = a[d]) && 'function' === typeof f.then ? f.then(b, c) : b(f);
            });
          };
        ...
        })('undefined' !== typeof window ? window : 'undefined' !== typeof a ? a : 'undefined' !== typeof self ? self : void 0);
      }).call(this, g(6), g(16).setImmediate);
    },
    function (b, e, g) {
      (function (a) {
        function b(a, b) {
        ...
        g(17);
        e.setImmediate = ('undefined' !== typeof self && self.setImmediate) || ('undefined' !== typeof a && a.setImmediate) || (this && this.setImmediate);
        e.clearImmediate =
          ('undefined' !== typeof self && self.clearImmediate) || ('undefined' !== typeof a && a.clearImmediate) || (this && this.clearImmediate);
      }).call(this, g(6));
    },
    function (b, e, g) {
      (function (a, b) {
        (function (a, f) {
          ...
          function h() {
            var b = 'setImmediate$' + Math.random() + '$',
              d = function (d) {
                d.source === a && 'string' === typeof d.data && 0 === d.data.indexOf(b) && c(+d.data.slice(b.length));
              };
            a.addEventListener ? a.addEventListener('message', d, !1) : a.attachEvent('onmessage', d);
            t = function (c) {
              a.postMessage(b + c, '*');
            };
          }
          ...
          if (!a.setImmediate) {
            ...
            x.setImmediate = function (a) {
              ...
              for (var b = Array(arguments.length - 1), c = 0; c < b.length; c++) b[c] = arguments[c + 1];
              w[p] = { callback: a, args: b };
              t(p);
              return p++;
            };
            x.clearImmediate = d;
    ...
    function (b, e) {
      ...
      function f(a) {
        ...
        if ((u === g || !u) && setTimeout) return (u = setTimeout), setTimeout(a, 0);
        try {
          return u(a, 0);
        } catch (y) {
          try {
      ...
      function k() {
        r && l && ((r = !1), l.length ? (q = l.concat(q)) : (p = -1), q.length && d());
      }
      function d() {
        if (!r) {
          var a = f(k);
      ...
      b = b.exports = {};
      try {
        var u = 'function' === typeof setTimeout ? setTimeout : g;
      } catch (w) {
        u = g;
      }
      try {
      ...
      b.nextTick = function (a) {
        ...
        if (1 < arguments.length) for (var e = 1; e < arguments.length; e++) b[e - 1] = arguments[e];
        q.push(new c(a, b));
        1 !== q.length || r || f(d);
      };
      ...
      (function (b) {
        ...
        var d,
          ...
          p = function () {
            ...
            function n(b) {
              ...
              return {
                ...
                msg: JSON.stringify(b.data, function (b, d) {
                  if ('object' === a(d) && ((b = null), d instanceof Uint8Array ? (b = d) : d instanceof ArrayBuffer && (b = new Uint8Array(d)), b)) {
                    d = g(b.length);
                    var e = q(d);
            ...
            b.ContinueFunc = function (a) {
              d('ContinueFunc called');
              setTimeout(function () {
                onmessage({ data: { action: 'continue' } });
              }, a);
            };
            if (b.pdfWorkerPath) var u = b.pdfWorkerPath;
            if (b.officeAsmPath) var v = b.officeAsmPath;
            b.Module = {
              memoryInitializerPrefixURL: u,
              asmjsPrefix: v,
              onRuntimeInitialized: function () {
                d || c();
                var a = Date.now() - k;
                Object(f.a)('load', 'time duration from start to ready: '.concat(JSON.stringify(a)));
                e = function (a) {
                  if (null !== a && void 0 !== a && 0 !== a && !r) {
                    var b = (a.length << 2) + 1,
                      c = Module._malloc(b);
                ...
                for (a = 0; a < l.length; ++a) onmessage(l[a]);
                l = null;
              },
              fetchSelf: function () {
                k = Date.now();
                Object(h.a)(
                  ''.concat(x, 'WebOfficeWorker'),
                  {
                    'Wasm.wasm': 5e6,
                    'Wasm.js.mem': 1e5,
                    '.js.mem': 5e6,
                    '.mem': 3e6,
                    disableObjectURLBlobs: b.disableObjectURLBlobs,
                  },
        ...
        b.onmessage = function (a) {
          'init' === a.data.action &&
            ...
            (b.disableObjectURLBlobs = a.data.disableObjectURLBlobs),
            (b.onmessage = c),
            p(),
            b.Module.fetchSelf());
        };
