!(function (e) {
      ...
      !(function (e) {
        ...
        (A.prototype = {
          ...
          then: function (e, t) {
            ...
            return 'fulfilled' === this.state_ || 'rejected' === this.state_ ? d(m, n) : this.then_.push(n), n.then;
          },
          catch: function (e) {
  ...
  function (e, t) {
    ...
    var u,
      ...
      l = -1;
    function d() {
      f && u && ((f = !1), u.length ? (c = u.concat(c)) : (l = -1), c.length && m());
    }
    function m() {
      if (!f) {
        var e = s(d);
    ...
    (o.nextTick = function (e) {
      ...
      c.push(new h(e, t)), 1 !== c.length || f || s(m);
    }),
  ...
  function (e, t, n) {
    ...
    var c = function (e) {
      ...
      f = function (e) {
        if ('string' != typeof e) {
          for (var t = '', n = 0, r = e.length, o = void 0; n < r; ) (o = e.subarray(n, n + 1024)), (n += 1024), (t += String.fromCharCode.apply(null, o));
          return t;
        }
        return e;
      },
      ...
      p = function (e, t) {
        return r(void 0, void 0, Promise, function () {
          ...
          return o(this, function (r) {
            switch (r.label) {
              case 0:
                return m ? [3, 2] : [4, u(self.Core.getWorkerPath() + 'external/decode.min.js', 'Failed to download decode.min.js', window)];
              case 1:
      ...
      w = function (e) {
        ...
        (n.responseType = r ? 'text' : 'arraybuffer'), r && n.overrideMimeType('text/plain; charset=x-user-defined'), n.send();
        var o = function () {
          var o;
          Date.now();
          return (
      ...
      b = function (e) {
        ...
        return d || (n.endsWith('.js.mem') ? (n = n.replace('.js.mem', '.mem')) : n.endsWith('.js') && (n = n.concat('.mem'))), e.slice(0, t) + n;
      },
      A = function (e, t) {
        var n = e.lastIndexOf('/');
        -1 === n && (n = 0);
      ...
      T = function (e, t) {
        return (
          e.endsWith('.js.mem') ? (e = e.slice(0, -4)) : e.endsWith('.mem') && (e = e.slice(0, -4) + '.js.mem'), (t.url = e), (t.decompressFunction = v), w(t)
        );
      },
      _ = function (e, t, n, r) {
    ...
    var O,
      ...
      k,
      L = 'undefined' == typeof window ? self : window,
      R = ((O = navigator.userAgent.toLowerCase()), (S = /(msie) ([\w.]+)/.exec(O) || /(trident)(?:.*? rv:([\w.]+)|)/.exec(O)) ? parseInt(S[2], 10) : S),
      W =
        ((I = L.navigator.userAgent.match(/OPR/)),
        (E = L.navigator.userAgent.match(/Maxthon/)),
        (k = L.navigator.userAgent.match(/Edge/)),
        L.navigator.userAgent.match(/Chrome\/(.*?) /) && !I && !E && !k),
      B =
        ((function () {
          if (!W) return null;
        ...
        !!navigator.userAgent.match(/Edge/i) || (navigator.userAgent.match(/Edg\/(.*?)/) && L.navigator.userAgent.match(/Chrome\/(.*?) /))),
      C =
        ((function () {
          if (!B) return null;
      ...
      U = /^((?!chrome|android).)*safari/i.test(L.navigator.userAgent) || (/^((?!chrome|android).)*$/.test(L.navigator.userAgent) && C),
      ...
      N =
        ...
        R || /Android|webOS|Touch|IEMobile|Silk/i.test(navigator.userAgent),
      ...
      Y = function (e, t, n) {
        ...
        if ($() && !n) {
          if (
            ...
            return void importScripts(e + 'Wasm.js');
          (r = j(e + 'Wasm.js.mem', t['Wasm.js.mem'], !1, !1)), (o = new Blob([r], { type: 'application/javascript' })), importScripts(URL.createObjectURL(o));
        } else {
          if (t.disableObjectURLBlobs) return void importScripts((self.Module.asmjsPrefix ? self.Module.asmjsPrefix : '') + e + '.js');
          r = j((self.Module.asmjsPrefix ? self.Module.asmjsPrefix : '') + e + '.js.mem', t['.js.mem'], !1);
          var s =
            ((i = (self.Module.memoryInitializerPrefixURL ? self.Module.memoryInitializerPrefixURL : '') + e + '.mem'),
            (a = t['.mem']),
            x(i, [A, P, T], {
              compressedMaximum: a,
              isAsync: !0,
          ...
          (self.Module.memoryInitializerRequest = new X(s)), (o = new Blob([r], { type: 'application/javascript' })), importScripts(URL.createObjectURL(o));
        }
      };
    function q(e) {
      return (q =
          ...
          var t = (function (e) {
            ...
            return {
              ...
              msg: JSON.stringify(e.data, function (e, n) {
                if ('object' === q(n)) {
                  var i = null;
                  if ((n instanceof Uint8Array ? (i = n) : n instanceof ArrayBuffer && (i = new Uint8Array(n)), i)) {
                    var a = r(i.length),
                      s = o(a);
                    if (s) new Uint8Array(Module.HEAPU8.buffer, s, i.length).set(i);
