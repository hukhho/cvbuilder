    ...
    1423: function (_, t, n) {
      _.exports = (function (_) {
        ...
        var t = (function (_) {
          ...
          s = 'січень_лютий_березень_квітень_травень_червень_липень_серпень_вересень_жовтень_листопад_грудень'.split('_'),
          e = /D[oD]?(\[[^[\]]*\]|\s)+MMMM?/;
        function M(_, t, n) {
          var s, e;
          return 'm' === n
            ...
            : _ +
              ...
              s % 10 == 1 && s % 100 != 11 ? e[0] : s % 10 >= 2 && s % 10 <= 4 && (s % 100 < 10 || s % 100 >= 20) ? e[1] : e[2]);
        }
        var o = function (_, t) {
