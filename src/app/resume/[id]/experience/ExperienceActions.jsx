    ...
    return (
        <div>
            <div className="experience-actions">
                <button className="experience-edit" onClick={() => onEditExperience(experience)}>EDIT</button>
                <button className="experience-delete" onClick={() => onDeleteExperience(experience.id)}>DELETE</button>
