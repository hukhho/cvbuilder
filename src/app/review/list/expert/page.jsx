                  ...
                  <Card key={expert.id} style={{ width: 297, borderRadius: '8px' }}>
                    ...
                    <div>
                      <div className="flex mt-2">
                        ...
                        <div className="ml-4">
                          {expert.rating} <StarFilled style={{ color: '#FFC107' }} />
                        </div>
                      </div>
                      <div style={{ textAlign: 'left' }}>
                        <div className="flex">
                          ...
                          <p className="ml-2">
                            {expert.jobTitle} at {expert.location}
                          </p>
                        </div>
                        <div className="flex">
                          <svg
                          ...
                          <p className="ml-2"> {expert.hourlyRate} </p>
                        </div>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div className="w-1/2">
                        ...
                        <div style={{ fontWeight: 'bold' }}>{expert.numberOfReviews}</div>
                      </div>
                    </div>
                  </Card>
                ))}
