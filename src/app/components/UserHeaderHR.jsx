...
const categories = [
  { name: 'APPLICATION LIST', link: 'review/list/expert' },
  { name: 'JOB POSTING', link: 'review/list/user' },
];

const UserHeaderHR = ({ initialEnabledCategories }) => {
