...
const UserLayout = ({
  ...
  const checkOnSelect = (item, key, keyPath, selectedKeys, domEvent) => {
  ...
  const items = [
    ...
    },
    {
      ...
      label: (
        <Link
          ...
          style={{
            pointerEvents: selected === '2' ? 'none' : 'auto',
          }}
        >
    ...
    },
    {
      ...
      label: (
        <Link
          href="/hr/list"
          style={{
            pointerEvents: selected === '3' ? 'none' : 'auto',
          }}
        >
          <span style={{ color: '#ffffff', fontSize: 11 }}>MY DASHBOARD</span>
        </Link>
    ...
    },
    {
      ...
      label: (
        <Link
          ...
          style={{
            pointerEvents: selected === '4' ? 'none' : 'auto',
          }}
        >
    ...
    },
    {
      ...
      label: (
        <Link
          href="/expert/config"
          style={{
            pointerEvents: selected === '5' ? 'none' : 'auto',
          }}
        >
    ...
    },
    {
      ...
      label: (
        <Link
          style={{
            pointerEvents: selected === '6' ? 'none' : 'auto',
          }}
          href="/hr/config"
        >
          <span style={{ color: '#ffffff', fontSize: 11 }}>MY PROFILE</span>
    ...
    },
    {
      ...
      label: (
        <Link
          href="/candidate/config"
          style={{
            pointerEvents: selected === '7' ? 'none' : 'auto',
          }}
        >
          <span style={{ color: '#ffffff', fontSize: 11 }}>MY PROFILE</span>
        </Link>
  ...
  //     {selected === item.key ? (
  //       <span style={{ color: '#ffffff', fontSize: 11 }}>{item.label}</span>
  //     ) : (
  //       <Link href={item.label.props.href} passHref>
      ...
      <Layout style={{ background: '#fbfbfb' }} hasSider>
        ...
        >
          ...
          {filteredItems && (
            ...
            //       {item?.icon}
            //       {selected === item?.key ? (
            //         <span style={{ color: '#4d70eb', fontSize: 11 }}>{item?.label}</span>
            //       ) : (
