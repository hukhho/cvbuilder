...
const categories = [
  { name: 'REVIEW REQUESTS', link: 'expert/requests' },
  { name: 'REVIEW HISTORY', link: 'expert/history' },
];

const UserHeaderExpert = ({ initialEnabledCategories }) => {
...
export default UserHeaderExpert;
